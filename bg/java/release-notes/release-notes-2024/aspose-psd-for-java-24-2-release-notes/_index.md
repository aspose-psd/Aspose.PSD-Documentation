---
title: Aspose.PSD за Java 24.2 - Бележки към изданието
type: docs
weight: 40
url: /bg/java/aspose-psd-for-java-24-2-release-notes/
---

{{% alert color="primary" %}} Тази страница съдържа бележки към изданието за [Aspose.PSD за Java 24.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.2/) {{% /alert %}}

| **Ключ**     | **Обобщение**                                                                   | **Категория** |
|:------------|:------------------------------------------------------------------------------|:-------------|
| PSDJAVA-584 | Обработка на свойството Angle за PatternFillSettings.                                | Функционалност      |
| PSDJAVA-585 | Поддръжка на вертикално и хоризонтално мащабиране за TextLayer.                       | Функционалност      |
| PSDJAVA-589 | [AI формат] Реализирате правилното визуализиране на фона в PDF-базиран AI формат. | Функционалност      |
| PSDJAVA-590 | Промяна на механизма на изкривяване в warp.                                             | Подобрение  |
| PSDJAVA-591 | Ускоряване на изкривяванията.                                                               | Подобрение  |
| PSDJAVA-592 | Грешка ""Image loading failed." exception когато се отвори документ.                         | Грешка          |
| PSDJAVA-593 | Оправяне на записването на psd файлове със Stroke Pattern.                                   | Грешка          |
| PSDJAVA-594 | Стилът на текста е некоректен в умния обект, когато използваме ReplaceContents.            | Грешка          |
| PSDJAVA-595 | [AI формат] Оправяне на Cubic Bezier визуализацията в AI файл.                        | Грешка          |
...
** PSDJAVA-584. Обработка на свойството Angle за PatternFillSettings**
...
{{< highlight java >}}
    ...
    static void assertAreEqual(Object expected, Object actual) {
        assertAreEqual(expected, actual, "Обектите не са еднакви.");
    }
...
** PSDJAVA-585. Поддръжка на вертикално и хоризонтално мащабиране за TextLayer**
...
** PSDJAVA-589. [AI формат] Реализирате правилното визуализиране на фона в PDF-базиран AI формат**
...
** PSDJAVA-590. Промяна на механизма на изкривяване в warp**
...
** PSDJAVA-591. Ускоряване на изкривяванията**
...
{{< highlight java >}}
        ...
        if (timeInSec > 100000) {
            throw new RuntimeException("Времето за обработка е твърде дълго");
        }

{{< /highlight >}}

** PSDJAVA-592. Грешка ""Image loading failed." exception когато се отвори документ**
...
** PSDJAVA-593. Оправяне на записването на psd файлове със Stroke Pattern**
...
** PSDJAVA-594. Некоректен стил на текста в умни обекти, когато използваме ReplaceContents**
...
** PSDJAVA-595. [AI формат] Оправяне на Cubic Bezier визуализацията в AI файл**
