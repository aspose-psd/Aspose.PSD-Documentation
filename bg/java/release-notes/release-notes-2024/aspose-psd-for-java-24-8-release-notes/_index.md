---
title: Aspose.PSD за Java 24.8 - Бележки за версията
type: docs
weight: 40
url: /bg/java/aspose-psd-za-java-24-8-belejki-za-versiyata/
---

{{% alert color="primary" %}} Тази страница съдържа бележки за версията на [Aspose.PSD за Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Ключ**    | **Резюме**                                                                                          | **Категория** |
|:-----------|:---------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [Формат AI] Добавяне на обработка за групи на XObject                                               | Подобрение   |
| PSDJAVA-645 | Подобряване на възможностите за трансформация на Warp, като се добавят WarpSettings за TextLayer и SmartObjectLayer | Функционалност |
| PSDJAVA-646 | [Формат AI] Обработка на слоевете в операторите на потоците със съдържание                           | Функционалност |
| PSDJAVA-647 | Рендирането на резултата от AI файл е много различно в сравнение с резултатите от Illustrator        | Грешка      |
| PSDJAVA-648 | Преподреждането на умния обект не се прилага за всички умни обекти в PSD файлa                      | Грешка      |
...
**PSDJAVA-645. Подобряване на възможностите за трансформация на Warp, като се добавят WarpSettings за TextLayer и SmartObjectLayer**
...
**PSDJAVA-646. [Формат AI] Обработка на слоеве в операторите на потоците със съдържание**
...
**PSDJAVA-647. Рендирането на резултата от AI файл е много различно в сравнение с резултатите от Illustrator**
...
**PSDJAVA-648. Преподреждането на умния обект не се прилага за всички умни обекти в PSD файлa**
