---
title: Aspose.PSD за .NET 24.8 - Бележки за изданието
type: docs
weight: 50
url: /bg/net/aspose-psd-za-net-24-8-belejki-za-izdanieto/
---

{{% alert color="primary" %}}

Тази страница съдържа бележки за изданието на [Aspose.PSD за .NET 24,8](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Ключ**    | **Обобщение**                                                                                     | **Категория** |
|:------------|:---------------------------------------------------------------------------------------------------|:-------------|
| PSDNET-2091 | [AI Format] Добавяне на обработка за групи на XObject                                              | Подобрение   |
| PSDNET-1754 | Подобряване на възможностите за преобразяване на Warp чрез добавяне на WarpSettings за TextLayer и SmartObjectLayer | Функционалност      |
| PSDNET-1836 | [AI Format] Обработване на слоеве в операторите за потоци на съдържанието                              | Функционалност      |
| PSDNET-2015 | Резултатът от рендерирането на AI файл е много различен в сравнение с резултатите от Illustrator   | Грешка       |
| PSDNET-2093 | Препрепоръчване на Smart Object не се прилага за всички Smart Object в PSD файл                   | Грешка       |
...
**PSDNET-1754. Подобряване на възможностите за преобразяване на Warp чрез добавяне на WarpSettings за TextLayer и SmartObjectLayer**
...
**PSDNET-1836. [AI Format] Управляване на слоеве в операторите за потоци на съдържанието**
...
//// Кривите от слоето наречено "Pen" трябва да бъдат скрити
{{< /highlight >}}

**PSDNET-2015. Резултатът от рендерирането на AI файл е много различен в сравнение с резултатите от Illustrator**
...
**PSDNET-2093. Препрепоръчване на Smart Object не се прилага за всички Smart Object в PSD файл**
    ...
    using (var image = (PsdImage)Image.Load(sourceFile[i]))
    {
        foreach (Layer layer in image.Layers)
        {
            if (layer is SmartObjectLayer)
            {
                ...
                // За втория умнен слой тук беше грешка
