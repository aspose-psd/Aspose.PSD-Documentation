---
title: Aspose.PSD за .NET 19.5 - Бележки за изданието
type: docs
weight: 80
url: /bg/net/aspose-psd-za-net-19-5-release-notes/
---

{{% alert color="primary" %}} 

Тази страница съдържа бележки за изданието на Aspose.PSD за .NET 19.5

{{% /alert %}} 

|**Ключ**|**Резюме**|**Категория**|
| :- | :- | :- |
|PSDNET-133|Добавяне на поддръжка на слоевете за попълване: Шаблон|Функция|
|PSDNET-138|Поддръжка на PtFlResource|Функция|
|PSDNET-129|Изпълнение на коректен Crop метод за PSD файлове|Функция|
|PSDNET-140|Поддръжка на VsmsResource|Функция|
|PSDNET-121|Видимите слоеве в видимата подпапка в невидимата папка се изобразяват, но не трябва да|Проблем|
|PSDNET-119|PSD (режим RGB 16 бита на канал) не се конвертира правилно в JPG|Проблем|
...
**PSDNET-133. Добавяне на поддръжка на слоевете за попълване: Шаблон**

{{< highlight java >}}

 // Добавяне на поддръжка на слоевете за попълване: Шаблон
...
**PSDNET-138. Поддръжка на PtFlResource**
...

             {
...

                {
...

                    {
                        ...
                        // Нямаме данни за шаблона в PattResource, затова можем да ги добавим.
...
**PSDNET-129. Изпълнение на коректен Crop метод за PSD файлове**

{{< highlight java >}}

             // Изпълнение на коректен Crop метод за PSD файлове.
...
**PSDNET-140. Поддръжка на VsmsResource**
  ...
  // Поддръжка на VsmsResource
...

        {
...

            {
                ...
                // Правилото за попълване на пътечката не съдържа допълнителна информация
...
**PSDNET-121: Видимите слоеве в видимата подпапка в невидимата папка се изобразяват, но не трябва да**

{{< highlight java >}}

 // Видимите слоеве в видимата подпапка в невидимата папка се изобразяват, но не трябва
...
**PSDNET-119. PSD (режим RGB 16 бита на канал) не се конвертира правилно в JPG**

{{< highlight java >}}

  // Psd не се конвертира правилно в jpg
