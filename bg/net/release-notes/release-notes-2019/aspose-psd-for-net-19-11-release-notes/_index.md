---
title: Aspose.PSD за .NET 19.11 - Бележки за Изданието
type: docs
weight: 20
url: /bg/net/aspose-psd-za-net-19-11-release-notes/
---

{{% alert color="primary" %}} 

Тази страница съдържа бележки за изданието на [Aspose.PSD за .NET 19.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Ключ**|**Резюме**|**Категория**|
| :- | :- | :- |
|PSDNET-151|[Поддръжка на Ефект на Вътрешна Сянка при Слоя](/psd/bg/net/shadow-effects-in-photoshop/#shadoweffectsinphotoshop-innershadoweffect)|Функционалност|
|PSDNET-135|[Имплементиране на Рендиране на Слой за Попълване: Мотив](/psd/bg/net/support-of-fill-layers/#supportoffilllayers-filllayerswithpatternfill)|Функционалност|
|PSDNET-187|[Поддръжка на Растерни Изображения в Файлове със Съдържание във Формат AI](/psd/bg/net/manipulating-adobe-illustrator-formats/#manipulatingadobeillustratorformats-rasterimagesinillustrator)|Функционалност|
|PSDNET-225|[Получаване на Свойствата на Вграденото Форматиране на Текстов Слой](/psd/bg/net/working-with-text-layers/#workingwithtextlayers-gettextpropertiesfromatextlayer)|Функционалност|
|PSDNET-214|Неправилно Експортиране на PSD към Други Формати, ако Съдържа Ефекти на Слоеве и Регулиращи Слоеве|Проблем|
...
## **Примери за Употреба:**
**PSDNET-151. Поддръжка на Ефект на Вътрешна Сянка при Слоя**
...
**PSDNET-135. Имплементиране на Рендиране на Слой за Попълване: Мотив**
...
**PSDNET-187. Поддръжка на Растерни Изображения в Файлове със Съдържание във Формат AI**
...
**PSDNET-225. Получаване на Свойствата на Вграденото Форматиране на Текстов Слой**
...
**PSDNET-214. Неправилно Експортиране на PSD към Други Формати, ако Съдържа Ефекти на Слоеве и Регулиращи Слоеве**
