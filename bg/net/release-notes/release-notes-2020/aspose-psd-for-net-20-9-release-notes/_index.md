---
title: Aspose.PSD за .NET 20.9 - Бележки за изданието
type: docs
weight: 40
url: /bg/net/aspose-psd-for-net-20-9-release-notes/
---

{{% alert color="primary" %}} 

Тази страница съдържа бележки за изданието на [Aspose.PSD за .NET 20.9](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Ключ**|**Резюме**|**Категория**|
| :- | :- | :- |
|PSDNET-408|Поддържане на SoLEResource (Умно обектно слойно външно ресурс)|Функционалност|
|PSDNET-614|Поддържане на свързани умни обекти|Функционалност|
|PSDNET-615|Поддържане на вградени умни обекти|Функционалност|
|PSDNET-690|Актуализиране на текст в даден файл PSD и запазване на промените на някои слойове и много текстови параметри|Проблем|
|PSDNET-696|FillLayer не се актуализира след създаването си и не може да бъде визуализиран правилно|Проблем|
|PSDNET-712|Регресия: Aspose.PSD 20.8.0 не може да отвори файла|Проблем|
|PSDNET-714|В специфичен файл PSD преоразмеряването на TextLayer нарушава стойността за местоположение|Проблем|
...
**PSDNET-408. Поддръжка на SoLEResource (Умно обектно слойно външно ресурс)**
{{< highlight csharp >}}
            void AssertIsTrue(bool condition)
            {
                if (!condition)
                {
                    throw new FormatException(string.Format("Очаквано е истина"));
                }
            }
