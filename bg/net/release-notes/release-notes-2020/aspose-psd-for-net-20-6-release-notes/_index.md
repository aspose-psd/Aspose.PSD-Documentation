---
title: Aspose.PSD за .NET 20.6 - Бележки за изданието
type: docs
weight: 70
...
| :- | :- | :- |
|PSDNET-606 |Поддръжка на Линк Е ресурс|Функционалност|
|PSDNET-386 |Поддръжка на britResource (Ресурс на слой за яркост/контраст)|Функционалност|
|PSDNET-219|Преместване на настройката DefaultReplacementFont в класа ImageOptionsBase|Подобрение|
|PSDNET-596|Група на слой с режим на смесване, различен от PassThrough, не се визуализира|Грешка|
|PSDNET-610|NullReference изключение при опит да се конвертира определен файл Psd в изображение|Грешка|
|PSDNET-636|Преоразмеряването на PSD файлове работи некоректно, ако има маска в слоя за корекция, която има празни граници|Грешка|
|PSDNET-611|OverflowException при опит за отваряне на определен файл Psd|Грешка|
|PSDNET-565|Psd изображение с RGB режим 16 бита/канал обновява само слоевете на прегледа|Грешка|
|PSDNET-652|Изключение при зареждане на конкретен файл PSD със съставен Линк Е ресурс и свойство adobeStockLicenseState|Грешка|
|PSDNET-640|Промените в PSD слой маска се отхвърлят при запазване|Грешка|
|PSDNET-593|Запазването на AI файл в Jpeg2000 формат не работи|Грешка|
|PSDNET-638|Грешен ред на слоя след добавяне на група от слоеве в празна група от слоеве|Грешка|
...
**PSDNET-606. Поддръжка на Линк Е ресурс**
...
// Този пример показва как да получите и зададете свойства на Photoshop Psd Линк Е ресурс, който съдържа информация за външен свързан файл.
...
// Този пример показва как да получите и зададете свойства на Psd Линк Е ресурс, който съдържа информация за външен свързан JPEG файл.
...
// Този пример показва как да получите и зададете свойства на PSD Линк Е ресурс, който съдържа информация за външен свързан PNG файл.
...
// Този пример показва как да получите и зададете свойства на Photoshop Psd Линк Е ресурс, който съдържа информация за външен свързан CC Libraries Asset.
...
this.ExampleOfLnkEResourceSupport(
    ...
    @"CC Libraries Asset “rgb8_2x2_linked/rgb8_2x2” (Функцията е достъпна в Photoshop CC 2015)",
...
**PSDNET-201. Поддръжка за прогреса на конвертирането на документа**
...

{
      ...
      Console.WriteLine("---------- Запазване на Apple.psd във формат PNG ----------");
      ...
      Console.WriteLine("---------- Запазване на Apple.psd във формат PSD ----------");
...
**PSDNET-386. Поддръжка на britResource (Ресурс на слой за яркост/контраст)**

{{< highlight java >}}

 /* Този пример показва как можете програмно да промените ресурса за яркост/контраст на PSD изображение - BritResource
   Това е ниско ниво API на Aspose.PSD. Можете да използвате Слой за яркост/контраст през неговото API, което ще бъде много по-лесно, 
   но директното редактиране на ресурсите на PhotoShop ви дава по-голям контрол върху съдържанието на PSD файла.  */
...

            {
...

                {
...

                    {
                        ...
                        throw new Exception("BritResource was read wrong                    // Test editing and saving
...
**PSDNET-596. Група на слой с режим на смесване, различен от PassThrough, не се визуализира**
...
**PSDNET-610. NullReference изключение при опит да се конвертира определен файл Psd в изображение**
...
` `**PSDNET-636. Преоразмеряването на PSD файлове работи некоректно, ако има маска в слоя за корекция, която има празни граници**
...
**PSDNET-611. OverflowException при опит за отваряне на определен файл Psd**
...
// Заредено и запазено без хвърляне на изключения.

{{< /highlight >}}

**PSDNET-565. Psd изображение с RGB режим 16 бита/канал обновява само слоевете на прегледа**
...
**PSDNET-652. Изключение при зареждане на конкретен файл PSD със съставен Линк Е ресурс и свойство adobeStockLicenseState**
...

{
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/or hdr btns” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/cs Id icon” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/pointer cursor” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/x” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/modal btns” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/cs ppt icon” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/cs AI icon” (Функцията е достъпна в Photoshop CC 2015)",
...

    {
        ...
        @"CC Libraries Asset “OneReview-InDesign-InContextTranslation/cs PSD icon” (Функцията е достъпна в Photoshop CC 2015)",
...
**PSDNET-638. Грешен ред на слоя след добавяне на група от слоеве в празна група от слоеве**
...

{
...

    {
...

        {
            ...
            throw new Exception("Група 1 трябва да съдържа два слоя на Група 2.");
...
{{< highlight java >}}
 ...
 // Моля, не инсталирайте Шрифтът Константин, защото този тест трябва да замени шрифта, който не е инсталиран
...

{
    ...
    // По този начин можете да използвате различни шрифтове за различните изходи 
...
{{< /highlight >}}**PSDNET-640. Промените в PSD слой маска се отхвърлят при запазване**
...
**PSDNET-593. Запазването на AI файл в Jpeg2000 формат не работи**
