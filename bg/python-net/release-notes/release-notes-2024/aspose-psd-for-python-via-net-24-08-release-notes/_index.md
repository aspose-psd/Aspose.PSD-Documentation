---
title: Aspose.PSD за Python via .NET 24.8 - Бележки за версията
type: docs
weight: 10
url: /bg/python-net/aspose-psd-for-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

Тази страница съдържа бележки за версията на [Aspose.PSD за Python via .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Ключ**      | **Резюме**                                                                                                       | **Категория** |
|:-------------|:------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [AI Формат] Добавяне на обработка за XObject Groups                                                        | Подобрение  |
| PSDPYTHON-82 | Подобряване на възможностите за трансформация на Warp чрез добавяне на WarpSettings за TextLayer и SmartObjectLayer | Функционалност      |
| PSDPYTHON-83 | [AI Формат] Обработка на слоевете в операторите на потоците съдържание                                             | Функционалност      |
| PSDPYTHON-84 | Резултатът от визуализацията на AI файл е много различен в сравнение с резултатите от Illustrator                 | Проблем          |
| PSDPYTHON-85 | Пренасочването на Смарт обект не се прилага за всички Смарт обекти в PSD файл                                  | Проблем          |
...
**PSDPYTHON-81. [AI Формат] Добавяне на обработка за XObject Groups**
{{< highlight python >}}
# Няма пример. Това е вътрешно подобрение
{{< /highlight >}}

**PSDPYTHON-82. Подобряване на възможностите за трансформация на Warp чрез добавяне на WarpSettings за TextLayer и SmartObjectLayer**
{{< highlight python >}}
...
**PSDPYTHON-83. [AI Формат] Обработка на слоевете в операторите на потоците съдържание**
{{< highlight python >}}
...
**PSDPYTHON-84. Резултатът от визуализацията на AI файл е много различен в сравнение с резултатите от Illustrator**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. Пренасочването на Смарт обект не се прилага за всички Смарт обекти в PSD файл**
{{< highlight python >}}
