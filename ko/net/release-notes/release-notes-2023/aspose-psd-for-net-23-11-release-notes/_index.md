---
title: Aspose.PSD for .NET 23.11 - 릴리스 노트
type: docs
weight: 20
url: /ko/net/aspose-psd-for-net-23-11-release-notes/
---

{{% alert color="primary" %}}

이 페이지에는 [Aspose.PSD for .NET 23.11](https://www.nuget.org/packages/Aspose.PSD/)에 대한 릴리스 노트가 포함되어 있습니다.

{{% /alert %}}

| **Key**     | **Summary**                                                                                               | **Category** |
|:------------|:----------------------------------------------------------------------------------------------------------|:--------|
| PSDNET-412  | LMskResource 지원                                                                                   | 기능 |
| PSDNET-1669 | [AI 포맷] Aspose.PSD로 PDF 기반 AI 파일 렌더링 가능 추가                                       | 기능 |
| PSDNET-1702 | [AI 포맷] "cm" PostScript 연산자 지원 추가                                                      | 기능 |
| PSDNET-1752 | 새로운 종류의 와프 추가: Wave, 쉘 상승, 쉘 하락                                                         | 기능 |
| PSDNET-1797 | 수직 와프 지원 추가                                                                                | 기능 |
| PSDNET-1756 | TextLayer.GetFonts() 호출 시 'Value cannot be null. (Parameter 'key')' 시스템.인수NullException 발생 | 버그 |
...
**PSDNET-1669. [AI 포맷] Aspose.PSD로 PDF 기반 AI 파일 렌더링 가능 추가**
...
**PSDNET-1702. [AI 포맷] "cm" PostScript 연산자 지원 추가**
...
**PSDNET-1752. 새로운 종류의 와프 추가: Wave, 쉘 상승, 쉘 하락**
...
**PSDNET-1756. TextLayer.GetFonts() 호출 시 'Value cannot be null. (Parameter 'key')' 에러 발생**
