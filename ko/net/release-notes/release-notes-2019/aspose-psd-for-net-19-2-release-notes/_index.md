---
title: Aspose.PSD for .NET 19.2 - 릴리스 노트
type: docs
weight: 110
url: /ko/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

이 페이지에는 Aspose.PSD for .NET 19.2의 릴리스 노트가 포함되어 있습니다.

{{% /alert %}} 

|**키**|**요약**|**카테고리**|
| :- | :- | :- |
|PSDNET-97|색상 채우기: 색상 채우기를 지원합니다|기능|
|PSDNET-98|색상 채우기: 그라데이션 채우기를 지원합니다|기능|
|PSDNET-105|GdFlResource 지원|기능|
|PSDNET-106|VmskResource 지원|기능|
|PSDNET-109|실제 Aspose.Imaging 소스의 Aspose.PSD로의 이관|개선|
|PSDNET-92|일부 메소드의 부분적 로딩 지원 추가|개선|
|PSDNET-110|PSD 성능이 여러 번 하락함|버그|
...
- M:Aspose.PSD.FileFormats.Psd.Layers```
.FillSettings.PatternFillSettings.GenerateLfx2ResourceNodes(System.String,Aspose.PSD.Color,System.String,System.String,System.Double,System.Boolean,Aspose.PSD.PointF)
