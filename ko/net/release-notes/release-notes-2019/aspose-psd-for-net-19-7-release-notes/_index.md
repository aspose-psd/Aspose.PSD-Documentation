---
title: Aspose.PSD for .NET 19.7 - 릴리스 노트
type: docs
weight: 60
url: /ko/net/aspose-psd-for-net-19-7-release-notes/
---

{{% alert color="primary" %}} 

이 페이지에는 [Aspose.PSD for .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)의 릴리스 노트가 포함되어 있습니다.

{{% /alert %}} 

|**키**|**요약**|**카테고리**|
| :- | :- | :- |
|PSDNET-126|레이어 벡터 마스크 처리 지원|기능|
|PSDNET-130|PSD 파일용 올바른 크기 조정 메서드 구현|기능|
|PSDNET-165|PSD를 PDF로 내보내는 지원 추가|기능|
|PSDNET-186|AI 형식(버전 2 및 3)을 다른 형식으로 내보내는 지원 추가|기능|
...
**PSDNET-130. PSD 파일용 올바른 크기 조정 메서드 구현**
...
**PSDNET-165. PSD를 PDF로 내보내는 지원 추가**
...
**PSDNET-186. AI 형식(버전 2 및 3)을 다른 형식으로 내보내는 지원 추가**
