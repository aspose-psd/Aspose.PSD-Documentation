---
title: Aspose.PSD for .NET 22.1 - 릴리스 노트
type: docs
weight: 120
url: /ko/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}} 

이 페이지에는 [Aspose.PSD for .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)에 대한 릴리스 노트가 포함되어 있습니다.

{{% /alert %}} 

|**키**|**요약**|**카테고리**|
| :- | :- | :- |
|PSDNET-1017|PatternOverlay를 한 번만 적용할 수 있습니다|버그|
|PSDNET-1056|스트림에서 파일을 열 때 임시 파일이 오버플로됩니다|버그|
|PSDNET-991|가우시안 블러 스마트 필터의 렌더링 최적화|기능|
|PSDNET-1044|PattResource에서 다양한 패턴 데이터 지원|기능|
...
## **사용 예시:**
**PSDNET-1017. PatternOverlay를 한 번만 적용할 수 있습니다**
{{< highlight csharp >}}
...
**PSDNET-1056. 스트림에서 파일을 열 때 임시 파일이 오버플로됩니다**
{{< highlight csharp >}}
            ...
            using (var memStream = new MemoryStream())
            {
                ...
                // 예외 확인
                string typeName = exception.GetType().Name; // 디버깅용
...
**PSDNET-991. 가우시안 블러 스마트 필터의 렌더링 최적화**
{{< highlight csharp >}}
...
**PSDNET-1044. PattResource에서 다양한 패턴 데이터 지원**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("PattResourceData 항목의 올바른 읽기.");
                }
