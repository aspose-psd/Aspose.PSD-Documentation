---
title: Notas de Lançamento Aspose.PSD para Java 24.8
type: docs
weight: 40
url: /pt/java/aspose-psd-para-java-24-8-notas-de-lancamento/
---

{{% alert color="primary" %}} Esta página contém notas de lançamento para [Aspose.PSD para Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}
