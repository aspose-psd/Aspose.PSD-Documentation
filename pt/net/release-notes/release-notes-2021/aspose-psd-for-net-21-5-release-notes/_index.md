---
title: Notas de Lançamento do Aspose.PSD para .NET 21.5
type: docs
weight: 80
url: /pt/net/aspose-psd-for-net-21-5-release-notes/
---

{{% alert color="primary" %}} 

Esta página contém notas de lançamento para o [Aspose.PSD para .NET 21.5](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Chave**|**Resumo**|**Categoria**|
| :- | :- | :- |
|PSDNET-758|Suporte para redimensionamento de camadas de formas com caminhos vetoriais|Recurso|
|PSDNET-862|Suporte para redimensionamento de camadas de formas com caminhos vetoriais quando apenas uma camada é redimensionada|Recurso|
|PSDNET-578|String de texto truncada|Erro|
...
**PSDNET-758. Suporte para redimensionamento de camadas de formas com caminhos vetoriais**
...
**PSDNET-862. Suporte para redimensionamento de camadas de formas com caminhos vetoriais quando apenas uma camada é redimensionada**

{{< highlight csharp >}}
            // Este exemplo mostra como redimensionar camadas com um Vogk e recurso de caminho vetorial na imagem PSD
            float scaleX = 0.45f;
            float scaleY = 1.60f;
