---
title: Notas da Versão Aspose.PSD para .NET 20.8
type: docs
weight: 50
url: /pt/net/aspose-psd-for-net-20-8-notas-da-versao/
---

{{% alert color="primary" %}} 

Esta página contém notas de lançamento para [Aspose.PSD para .NET 20.8](https://www.nuget.org/packages/Aspose.PSD/)
