---
title: Notas de Lançamento do Aspose.PSD para .NET 22.1
type: docs
weight: 120
url: /pt/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}}

Esta página contém as notas de lançamento para [Aspose.PSD para .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Chave**|**Resumo**|**Categoria**|
| :- | :- | :- |
|PSDNET-1017|A Camada PatternOverlay só pode ser aplicada uma vez|Bug|
|PSDNET-1056|Estouro de arquivos temporários ao abrir um arquivo a partir de stream|Bug|
|PSDNET-991|Otimização de renderização para filtro inteligente de desfoque gaussiano|Recurso|
|PSDNET-1044|Suporte a muitos dados de padrões em PattResource|Recurso|
...
## **Exemplos de Uso**
**PSDNET-1017. A Camada PatternOverlay só pode ser aplicada uma vez**
{{< highlight csharp >}}
...
**PSDNET-1056. Estouro de arquivos temporários ao abrir um arquivo a partir de stream**
{{< highlight csharp >}}
            ...
            using (var memStream = new MemoryStream())
            {
                ...
                {
                    // procurar exceção de nível mais baixo
                    exception = mainEx;
                ...
                // verificar exceção
                string typeName = exception.GetType().Name; // para depurar
...
**PSDNET-991. Otimização de renderização para filtro inteligente de desfoque gaussiano**
{{< highlight csharp >}}
          string sourceFilte = "psdnet991_layers.psd";
            ...
            using (var image = (PsdImage)Image.Load(sourceFilte))
            {
                ...
                // Aplicar filtro à máscara da camada
...
**PSDNET-1044. Suporte a muitos dados de padrões em PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("Leitura correta dos itens de PattResourceData.");
                }
