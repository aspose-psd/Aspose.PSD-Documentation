---
title: Aspose.PSD for Java 24.4 - Sürüm Notları
type: docs
weight: 40
url: /tr/java/aspose-psd-for-java-24-4-release-notes/
---

{{% alert color="primary" %}} Bu sayfa [Aspose.PSD for Java 24.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.4/) için sürüm notlarını içermektedir. {{% /alert %}}

| **Anahtar**  | **Özet**                                                 | **Kategori** |
|:------------|:------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-610 | Aspose.PSD için Lisans Ayarlama Java için birden fazla kez yapıldığında istisna fırlatıyor       | Hata         |
| PSDJAVA-611 | [AI Format] XObjectForm kaynağı işleme ekleme                                                    | Özellik      |
| PSDJAVA-612 | ShapeLayer için Kurucu Ekleme                                                                  | Özellik      |
| PSDJAVA-613 | RGB'den CMYK'ya Psd dosyasının dönüşümünü düzeltme                                            | Hata         |
| PSDJAVA-614 | Belirli PSD dosyası Aspose.PSD kullanılarak ihraç edilemiyor                                    | Hata         |
...
**PSDJAVA-610. Aspose.PSD için Lisans Ayarlama Java için birden fazla kez yapıldığında istisna fırlatıyor**
...
**PSDJAVA-611. [AI Format] XObjectForm kaynağı işleme ekleme**
...
**PSDJAVA-612. ShapeLayer için Kurucu Ekleme**
...
**PSDJAVA-613. RGB'den CMYK'ya Psd dosyasının dönüşümünü düzeltme**

{{< highlight java >}}

    public static void main(String[] args) {
        // RGB + RLE 4 kanallı psd dosyasından CMYK + RLE 4 kanallı psd dosyasına dönüştürüldüğünde,
        // gerçekten 4 kanalı ve HasTransparencyData == false olan dosyaların kontrol edilmesi.
...
**PSDJAVA-614. Belirli PSD dosyası Aspose.PSD kullanılarak ihraç edilemiyor**
