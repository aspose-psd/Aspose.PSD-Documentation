---
title: Aspose.PSD for Java 24.8 - Sürüm Notları
type: docs
weight: 40
url: /tr/java/aspose-psd-for-java-24-8-release-notes/
---

{{% alert color="primary" %}} Bu sayfa, [Aspose.PSD for Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) için sürüm notlarını içerir. {{% /alert %}}

| **Anahtar** | **Özet** | **Kategori** |
|:------------|:---------|:-------------|
| PSDJAVA-642 | [AI Format] XObject Grupları için işleme ekle | Geliştirme |
| PSDJAVA-645 | Metin Katmanı ve Akıllı Nesne Katmanı için Warp dönüşüm yeteneklerini geliştirme | Özellik |
| PSDJAVA-646 | [AI Format] İçerik akışı işleçlerinde katmanları ele al | Özellik |
| PSDJAVA-647 | AI dosyasının oluşturduğu sonuç Illustrator sonuçlarıyla çok farklı | Hata |
| PSDJAVA-648 | Yeniden Bağlantı Akıllı Nesne, PSD dosyasındaki tüm Akıllı Nesnelere uygulanmıyor | Hata |
...
**PSDJAVA-645. Metin Katmanı ve Akıllı Nesne Katmanı için Warp dönüşüm yeteneklerini geliştirme**
...
**PSDJAVA-646. [AI Format] İçerik akışı işleçlerinde katmanları ele al**
...
**PSDJAVA-647. AI dosyasının oluşturduğu sonuç Illustrator sonuçlarıyla çok farklı**
...
**PSDJAVA-648. Yeniden Bağlantı Akıllı Nesne, PSD dosyasındaki tüm Akıllı Nesnelere uygulanmıyor**
        ...
        try (var image = (PsdImage) Image.load(sourceFile[i])) {
            for (Layer layer : image.getLayers()) {
                if (layer instanceof SmartObjectLayer) {
                    ...
                    // İkinci akıllı katman için burada hata vardı
