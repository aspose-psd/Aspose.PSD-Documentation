---
title: Aspose.PSD for Java 23.4 - Sürüm Notları
type: docs
weight: 40
url: /tr/java/aspose-psd-for-java-23-4-release-notes/
---

{{% alert color="primary" %}} Bu sayfa, [Aspose.PSD for Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) için sürüm notlarını içerir. {{% /alert %}}

|**Anahtar**|**Özet**|**Kategori**|
| :- | :- | :- |
|PSDJAVA-446|Aspose.PSD for .Net'den Aspose.PSD for Java'ya kaçırılan işlevselliği taşı|Geliştirme|
|PSDJAVA-441|Halka açık API için RawColor sınıfını tasarla ve eski Color yapısının yerine kullan|Geliştirme|
|PSDJAVA-418|Aspose.PSD için Modern Aspose Lisansını entegre et|Geliştirme|
|PSDJAVA-445|Photoshop'ta düzenleme yapılırken biçimlendirme hareket eder|Hata|
|PSDJAVA-443|Metni Text Portions kullanarak düzenlemek doğru sonucu kaydetmez|Hata|
|PSDJAVA-444|ITextPortion tarafından Metin Katmanı düzenlerken stillerin veya paragrafların başlangıcı ve sonu yanlış yerde görünür|Hata|
