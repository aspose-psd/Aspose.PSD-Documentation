---
title: Aspose.PSD for .NET 19.6 - Sürüm Notları
type: docs
weight: 70
url: /tr/net/aspose-psd-for-net-19-6-release-notes/
---

{{% alert color="primary" %}}

Bu sayfa, [Aspose.PSD for .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/) için sürüm notlarını içerir.

{{% /alert %}}

|**Anahtar**|**Özet**|**Kategori**|
| :- | :- | :- |
|PSDNET-127|PSD dosyasını PSB ve tersine dönüştürme yeteneği|Özellik|
|PSDNET-154|Aspose.Imaging 19.5 kaynaklarının Aspose.PSD'ye taşınması|Geliştirme|
|PSDNET-155|Aspose.PSD ile ilgili genel API temizliği|Geliştirme|
|PSDNET-159|IsLicensed özelliğinin kaldırılması|Geliştirme|
|PSDNET-102|PSB'yi JPG'ye dönüştürme işlemi asılır|Hata|
|PSDNET-150|Yeni eklenen metin katmanının konumu Photoshop'ta düzenleme sırasında kaydırılıyor|Hata|
...
- F:Aspose.PSD.FileFormats.Bmp.BitmapInfoHeaderSize
...
- F:Aspose.PSD.FileFormats.Gif.Disposal