---
title: Aspose.PSD for .NET 20.11 - Sürüm Notları
type: docs
weight: 20
url: /tr/net/aspose-psd-for-net-20-11-release-notes/
---

{{% alert color="primary" %}} 

Bu sayfa [Aspose.PSD for .NET 20.11](https://www.nuget.org/packages/Aspose.PSD/) için sürüm notlarını içerir.

{{% /alert %}} 

|**Anahtar**|**Özet**|**Kategori**|
| :- | :- | :- |
|PSDNET-713|Aspose.PSD diğer Renk Modları/Bit Derinliğine kaydetmeden PSD'yi dönüştüremiyor|Özellik|
|PSDNET-754|PSD görüntüsünde Akıllı Nesne Katmanını kopyalama yeteneği eklendi|Özellik|
|PSDNET-267|Katman Efektleri içeren PSD dosyasını yükleme ve kaydetme işlemi sırasında istisna oluşur|Hata|
|PSDNET-579|"Image.LoadRawData" yöntemi NullPointer istisnası fırlatıyor|Hata|
|PSDNET-741|Dosyayı açmaya çalışırken ImageLoadException istisnası fırlatılır|Hata|
|PSDNET-744|Aspose.PSD 20.10: Psd yüklenemiyor|Hata|
...
## **Kullanım örnekleri:**
**PSDNET-267. Katman Efektleri içeren PSD dosyasını yükleme ve kaydetme işlemi sırasında istisna oluşur**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-579. "Image.LoadRawData" yöntemi NullPointer istisnası fırlatıyor**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-713. Aspose.PSD diğer Renk Modları/Bit Derinliğine kaydetmeden PSD'yi dönüştüremiyor**
{{< highlight csharp >}}
            ...
            // PSD'yi kaydeder ve kaydedilen dosyayı yükler ve PNG olarak kaydeder.
...
{{< /highlight >}}
**PSDNET-741. Dosyayı açmaya çalışırken ImageLoadException istisnası fırlatılır**
{{< highlight csharp >}}
            ...
            {
                // Burada istisna oluşmaz...
            }
{{< /highlight >}}
**PSDNET-744. Aspose.PSD 20.10: Psd yüklenemiyor**
{{< highlight csharp >}}         
...
{{< /highlight >}}
**PSDNET-754. PSD görüntüsünde Akıllı Nesne Katmanını kopyalama yeteneği eklendi**
{{< highlight csharp >}}
            string dataDir = "PSDNET754_1\\";
            string outputDir = dataDir + "output\\";

            // Bu örnekler PSD görüntüsünde akıllı nesne katmanlarını kopyalamanın nasıl yapıldığını gösterir.
            ...
            {
                int layerNumber = 0; // Kopyalanacak katmanın numarası
                ...
                using (PsdImage image = (PsdImage)Image.Load(filePath))
                {
                    ...
                    duplicatedLayer.DisplayName = smartObjectLayer.DisplayName + " paylaşılan görüntü";
                    ...
                    {
                        // Gömülü akıllı nesne görüntüsünü tersine çevirelim (içsel bir PSD görüntüsü için yalnızca ilk katmanını tersine çeviririz)
                    ...
                    // Kopyalanan katman orijinal akıllı nesneyle görüntüsünü paylaşır 
                    // ve bu açıkça güncellenmeli aksi takdirde render önbelleği değişmez.
                    // Yeni bir katman oluşturan NewSmartObjectViaCopy ile oluşturulan yeni katmanın gömülü görüntüsünü diğerleriyle paylaşmadığından emin olmak için tüm akıllı nesneleri güncelliyoruz.
            ...
            // İçerisinde PSD görüntüsü de bulunan raster görüntüyü tersine çevirir.
            ...
            // Raster görüntüsünü tersine çevirir.
