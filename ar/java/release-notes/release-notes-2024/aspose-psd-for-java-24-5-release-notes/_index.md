---
title: تحديثات Aspose.PSD for Java 24.5
type: docs
weight: 40
url: /ar/java/aspose-psd-for-java-24-5-release-notes/
---

{{% alert color="primary" %}} هذه الصفحة تحتوي على تحديثات [Aspose.PSD for Java 24.5](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.5/) {{% /alert %}}

| **المفتاح** | **الملخص**                                                                                                             | **التصنيف**  |
|:------------|:------------------------------------------------------------------------------------------------------------------------|:--------------|
| PSDJAVA-617 | [تنسيق AI] إضافة دعم للتعامل مع ملفات AI ذات رأس EPSF                                                           | ميزة       |
| PSDJAVA-620 | يتم معالجة شفافية نصف االتجانب بشكل خاطئ في معاينة ملف psd                                                          | خلل           |
| PSDJAVA-621 | تقديم طبقة الشكل جزئيا بشكل غير صحيح                                                                        | خلل           |
| PSDJAVA-622 | استثناء عند حفظ ملفات PSD بحجم أكبر من 200 ميغابايت وأبعاد كبيرة (هناك مشكلة في استخدام الذاكرة) | خلل           |
| PSDJAVA-623 | فشل حفظ الصورة باستثناء عند الحفظ إلى PDF بعد التحديث من الإصدار 23.7 إلى 24.3                                         | خلل           |
| PSDJAVA-624 | إصلاح المشكلة في طريقة GetFontInfoRecords للخطوط الصينية                                                        | خلل           |

## **تغييرات واجهة المبرمج العامة**
...
**PSDJAVA-617. [تنسيق AI] إضافة دعم للتعامل مع ملفات AI ذات رأس EPSF**
...
**PSDJAVA-620. يتم معالجة الشفافية بشكل خاطئ في معاينة ملف psd**
...
**PSDJAVA-621. تقديم طبقة الشكل جزئيا بشكل غير صحيح**
    ...
    public static void main(String[] args) {
        ...
        try (PsdImage im = (PsdImage) Image.load(sourceFile)) {
            ...
            secondBezierKnotRecord.setPoints(new Point[]{
                    ...
                    pointFToResourcePoint(
                            new PointF(100, 490),
                            shapeLayer.getContainer().getSize()), // نقطة التثبيت
                    pointFToResourcePoint(
                            new PointF(150, 490),
                            shapeLayer.getContainer().getSize())
            });
...
**PSDJAVA-622. استثناء عند حفظ ملفات PSD بحجم أكبر من 200 ميغابايت وأبعاد كبيرة (هناك مشكلة في استخدام الذاكرة)**
