---
title: أسوز بي إس دي لجافا 24.1 - ملاحظات الإصدار
type: docs
weight: 40
url: /ar/java/aspose-psd-for-java-24-1-release-notes/
---

{{% alert color="primary" %}} هذه الصفحة تحتوي على ملاحظات الإصدار لـ [أسوز بي إس دي لجافا 24.1](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.1/) {{% /alert %}}

| **المفتاح** | **الملخص** | **الفئة** |
|:------------|:------------|:------------|
| PSDJAVA-576 | [تنسيق AI] إضافة معالجة أساسية لصور AI متعددة الصفحات. | ميزة |
| PSDJAVA-579 | تأثير تحويل نص لا ينطبق على النص. | خلل |
| PSDJAVA-580 | عرض غير صحيح للقناع في الملف المحدد. | خلل |
| PSDJAVA-581 | استثناء الإشارة المفقودة في Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor. | خلل |
| PSDJAVA-582 | [تنسيق AI] إصلاح استخدام الذاكرة في AiExporterUtils. | خلل |

## **تغييرات واجهة برمجة التطبيقات العامة**

# **إضافة واجهات برمجة API:**
...
**PSDJAVA-576. [تنسيق AI] إضافة معالجة أساسية لصور AI متعددة الصفحات**
...
{{< highlight java >}}
        ...
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            ...
            // لذا إذا قمت بحفظ صورة AI دون تغيير هذه الخاصية، سيتم عرض الصفحة الأولى وحفظها.
            image.save(firstPageOutputPng, new PngOptions());

            // تغيير فهرس الصفحة النشطة إلى الصفحة الثانية.
            image.setActivePageIndex(1);

            // حفظ الصفحة الثانية من صورة AI كصورة PNG.
            image.save(secondPageOutputPng, new PngOptions());

            // تغيير فهرس الصفحة النشطة إلى الصفحة الثالثة.
            image.setActivePageIndex(2);

            // حفظ الصفحة الثالثة من صورة AI كصورة PNG.
            image.save(thirdPageOutputPng, new PngOptions());
        }

{{< /highlight >}}

**PSDJAVA-579. تأثير تحويل نص لا ينطبق على النص**
...
**PSDJAVA-580. عرض غير صحيح للقناع في الملف المحدد**
...
**PSDJAVA-581. استثناء الإشارة المفقودة في Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor**
...
**PSDJAVA-582. [تنسيق AI] إصلاح استخدام الذاكرة في AiExporterUtils**
...
{{< highlight java >}}
        ...
        // تحميل صورة AI.
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // حفظ الصفحة الأولى من صورة AI كصورة PNG.
            image.save(firstPageOutputPng, new PngOptions());

            // تغيير فهرس الصفحة ال