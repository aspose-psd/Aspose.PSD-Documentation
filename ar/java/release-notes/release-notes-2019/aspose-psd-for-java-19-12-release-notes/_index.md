...
type: docs
weight: 10
url: /java/aspose-psd-for-java-19-12-release-notes/
---

{{% alert color="primary" %}} This page contains release notes for [Aspose.PSD for Java 19.12](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-19.12/) {{% /alert %}} 

|**Key**|**Summary**|**Category**|
| :- | :- | :- |
|PSDJAVA-75|[Add support of Linked Layer](/psd/java/working-with-layers/#workingwithlayers-supportoflinkedlayers)|Feature|
|PSDJAVA-72|[Support of SoCoResource](/psd/java/supported-resources/#supportedresources-supportofsocoresource)|Feature|
