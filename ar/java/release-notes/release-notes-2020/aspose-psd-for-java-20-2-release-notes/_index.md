---
title: أسبوز.پي‌اي.اس.دي لجافا 20.2 - ملاحظات الإصدار
type: docs
weight: 20
url: /ar/java/aspose-psd-for-java-20-2-release-notes/
---

{{% alert color="primary" %}} تحتوي هذه الصفحة على ملاحظات الإصدار لـ [أسبوز.پي‌اي.اس.دي لجافا 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) {{% /alert %}} 

|**المفتاح**|**الملخص**|**الفئة**|
| :- | :- | :- |
|PSDJAVA-96|تحسين القدرة على عرض نصوص ملونة مختلفة في طبقة النص|ميزة|
|PSDJAVA-97|دعم لمورد clbl (المورد الذي تحتوي عليه الطبقة على معلومات حول العناصر المقصوصة التي تمزج)|ميزة|
|PSDJAVA-100|دعم لمورد blwh (المورد الذي يحتوي على بيانات طبقة تعديل الأبيض والأسود)|ميزة|
|PSDJAVA-101|القدرة على تصدير مجموعة الطبقات إلى Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf|ميزة|
|PSDJAVA-105|دعم لمورد lspf (يحتوي على إعدادات حول ضبط الطبقة المحمية)|ميزة|
|PSDJAVA-106|دعم لمورد infx (يحتوي على بيانات حول دمج العناصر الداخلية)|ميزة|
|PSDJAVA-99|إعادة تشكيل لـ PsdImage والطبقة لتغيير سلوك التحويل (تغيير تحجيم/تدوير/قص الأقنعة إذا قمنا بتحويل طبقة واحدة بشكل منفصل)|تحسين|
|PSDJAVA-98|في بعض الإعدادات العالمية للنظام لا يمكن فتح صورة نقطية لصورة ذات الذاكرة العشوائية البصرية للذكاء الاصطناعي|خطأ|
|PSDJAVA-102|بعد تنفيذ عملية الدوران/الانعكاس على الطبقة، تصبح صورة PSD غير قابلة للقراءة|خطأ|
|PSDJAVA-103|System.ArgumentException أثناء تحميل ملف PSD|خطأ|
|PSDJAVA-104|بعد استخدام طريقة التحويل للطبقة فقط، تكون الطبقة المحفوظة لها حدود غير صحيحة أو قناع|خطأ|

# **تغييرات واجهة برمجة التطبيق العامة**
# **تم تعطيل هذه الواجهة مؤقتًا وستُفعل في الإصدار القادم:**
...
` `**يرجى في هذه الاثناء استخدام الإصدار 19.4 إذا كان لديك تبعية مناسبة.**
# **واجهات برمجة التطبيق الجديدة:**
