---
title: أسبوز.PSD لجافا 23.11 - ملاحظات الإصدار
type: docs
weight: 40
url: /ar/java/aspose-psd-for-java-23-11-release-notes/
---

{{% alert color="primary" %}} هذه الصفحة تحتوي على ملاحظات الإصدار لـ [أسبوز.PSD لجافا 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) {{% /alert %}}

| **المفتاح**   | **الملخص**                                                                                                | **الفئة**   |
|:---------------|:-----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | دعم LMskResource                                                                                         |   ميزة     |
| PSDJAVA-552    | [تنسيق AI] إضافة القدرة على تقديم ملف AI القائم على PDF مع Aspose.PSD                                   |   ميزة     |
| PSDJAVA-553    | [تنسيق AI] إضافة دعم لعامل PostScript "سم"                                                       |   ميزة     |
| PSDJAVA-554    | إضافة أنواع جديدة من التشويه: أمواج، صدفة أعلى، صدفة أسفل                                                          |   ميزة     |
| PSDJAVA-555    | إضافة دعم التشويه الرأسي                                                                                  |   ميزة     |
| PSDJAVA-556    | استثناء الوسيطة: 'لا يمكن أن تكون القيمة معدومة. (المعلمة 'المفتاح')' عند استدعاء TextLayer.GetFonts()  |   خطأ      |
...
{{< highlight java >}}
    ...
    static void assertAreEqual(Object expected, Object actual) {
        assertAreEqual(expected, actual, "الكائنات ليست متساوية.");
    }
...
** PSDJAVA-552. [تنسيق AI] إضافة القدرة على تقديم ملف AI القائم على PDF مع Aspose.PSD**
...
** PSDJAVA-553. [تنسيق AI] إضافة دعم لعامل PostScript "سم"**
...
** PSDJAVA-554. إضافة أنواع جديدة من التشويه: أمواج، صدفة أعلى، صدفة أسفل**
...
** PSDJAVA-555. إضافة دعم التشويه الرأسي**
...
** PSDJAVA-556. استثناء الوسيطة: 'لا يمكن أن تكون القيمة معدومة. (المعلمة 'المفتاح')' عند استدعاء TextLayer.GetFonts()**
