---
title: Aspose.PSD لـ Python via .NET 24.8 - ملاحظات الإصدار
type: docs
weight: 10
url: /ar/python-net/aspose-psd-for-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

تحتوي هذه الصفحة على ملاحظات الإصدار لـ [Aspose.PSD لـ Python via .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **المفتاح** | **الملخص** | **الفئة** |
|:-------------|:------------|:-----------|
| PSDPYTHON-81 | [تنسيق AI] إضافة المعالجة لمجموعات XObject | تحسين  |
| PSDPYTHON-82 | تحسين إمكانيات تحويل التشويه عن طريق إضافة إعدادات التشويه لطبقة النص وطبقة الكائن الذكي | ميزة      |
| PSDPYTHON-83 | [تنسيق AI] التعامل مع الطبقات في عوامل تيارات المحتوى     | ميزة      |
| PSDPYTHON-84 | نتيجة التقديم لملف AI مختلفة تمامًا في مقارنة مع نتائج Illustrator | علة     |
| PSDPYTHON-85 | إعادة ربط الكائن الذكي لا تطبق على جميع الكائنات الذكية في ملف PSD | علة     |
...
**PSDPYTHON-81. [تنسيق AI] إضافة التعامل لمجموعات XObject**
{{< highlight python >}}
# لا يوجد مثال. إنها تحسين داخلي
{{< /highlight >}}

**PSDPYTHON-82. تعزيز إمكانيات تحويل التشويه عن طريق إضافة إعدادات التشويه لطبقة النص وطبقة الكائن الذكي**
{{< highlight python >}}
...
**PSDPYTHON-83. [تنسيق AI] التعامل مع الطبقات في عوامل تيارات المحتوى**
{{< highlight python >}}
...
**PSDPYTHON-84. نتيجة التقديم لملف AI مختلفة تمامًا في مقارنة مع نتائج Illustrator**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. إعادة ربط الكائن الذكي لا تطبق على جميع الكائنات الذكية في ملف PSD**
{{< highlight python >}}
