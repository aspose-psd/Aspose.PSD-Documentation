---
title: تحديثات إصدار Aspose.PSD لـ .NET 22.1
type: docs
weight: 120
url: /ar/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}} 

يحتوي هذا الصفحة على تحديثات الإصدار لـ [Aspose.PSD لـ .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**المفتاح**|**الملخص**|**الفئة**|
| :- | :- | :- |
|PSDNET-1017|لا يمكن تطبيق PatternOverlay إلا مرة واحدة|خلل|
|PSDNET-1056|تجاوز الملفات المؤقتة عند فتح ملف من التيار|خلل|
|PSDNET-991|تحسين التقديم لتصفية Gaussian blur smart|ميزة|
|PSDNET-1044|دعم العديد من بيانات الأنماط في PattResource|ميزة|
...
## **أمثلة الاستخدام:**
**PSDNET-1017. لا يمكن تطبيق PatternOverlay إلا مرة واحدة**
{{< highlight csharp >}}
...
**PSDNET-1056. تجاوز الملفات المؤقتة عند فتح ملف من التيار**
{{< highlight csharp >}}
...
**PSDNET-991. تحسين التقديم لتصفية Gaussian blur smart**
{{< highlight csharp >}}
...
**PSDNET-1044. دعم العديد من بيانات الأنماط في PattResource**
{{< highlight csharp >}}
