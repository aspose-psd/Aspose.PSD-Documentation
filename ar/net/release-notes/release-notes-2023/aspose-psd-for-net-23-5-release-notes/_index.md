---
title: ملاحظات الإصدار لـ Aspose.PSD for .NET 23.5
type: docs
weight: 80
url: /ar/net/aspose-psd-for-net-23-5-release-notes/
---

{{% alert color="primary" %}}

تحتوي هذه الصفحة على ملاحظات الإصدار لـ [Aspose.PSD for .NET 23.5](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **الرقم**  | **الملخص**                                                                | **الفئة** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDNET-343  | دعم فلتر: تحسين -> تحسين                                        | ميزة      |
| PSDNET-1179 | حفظ ملف PSD (RGB/8 بت أو RGB/16 بت) بدون طبقات إلى 32 بت           | ميزة      |
| PSDNET-1408 | تنفيذ التعامل مع كائنات المسار من موارد vsms أو vmsk لطبقة الشكل | ميزة      |
| PSDNET-1508 | إضافة تأثير نقاط الشبكة على بعضها البعض                            | ميزة      |
...
**PSDNET-343. دعم فلتر: تحسين -> تحسين**
...
**PSDNET-1179. حفظ ملف PSD (RGB/8 بت أو RGB/16 بت) بدون طبقات إلى 32 بت**
...
**PSDNET-1408. تنفيذ التعامل مع كائنات المسار من موارد vsms أو vmsk لطبقة الشكل**
...
using (PsdImage image = (PsdImage)Image.Load(srcFile, new PsdLoadOptions { LoadEffectsResource = true }))
{
    ...
    // حفظ البيانات المعدلة إلى المورد
...
// التحقق من القيم المعدلة في الملف المحفوظ
...
**PSDNET-1508. إضافة تأثير نقاط الشبكة على بعضها البعض**
