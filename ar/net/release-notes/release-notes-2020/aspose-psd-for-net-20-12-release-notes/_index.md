...
type: docs
weight: 10
url: /ar/net/aspose-psd-for-net-20-12-release-notes/
---

{{% alert color="primary" %}} 

هذه الصفحة تحتوي على ملاحظات الإصدار لـ [Aspose.PSD for .NET 20.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**المفتاح**|**الملخص**|**الفئة**|
| :- | :- | :- |
|PSDNET-757|دعم تحويل الطبقات إلى طبقة كائن ذكي|ميزة|
|PSDNET-764|تطلق طريقة ReplaceContents في طبقة SmartObjectLayer NullReferenceException إذا حاولنا إضافة ملف PSB|خلل|
|PSDNET-773|عرض غير صحيح للصور CMYK 8 بت و CMYK 16 بت، إذا كانت الطبقة أكبر من لوح الرسم|خلل|
|PSDNET-782|يمكن فتح ملف PSB المحفوظ بواسطتنا بواسطة واجهة برمجة التطبيقات، ولكن لا يمكن ذلك بواسطة Photoshop|خلل|
|PSDNET-783|إذا حاولنا تغيير Smart Layer في PSD محدد بمصدر بيانات مشترك نحصل على استثناء|خلل|
|PSDNET-172|إعادة تسمية FileFormatVersion إلى PsdVersion لتجنب الالتباس|تعزيز|
|PSDNET-620|إزالة إعدادات إطار Compact framework من Aspose.PSD .NET|تعزيز|
|PSDNET-765|PsdImageException: رأس مورد غير معروف عند محاولة فتح ملف PSB مع SmartObjectLayers|تعزيز|
|PSDNET-798|تحريك تسلسل فئات قناع الرسوم البيانية إلى Core Namespace لضمان اتساق منتجات Aspose.PSD و Aspose.Imaging|تعزيز|
