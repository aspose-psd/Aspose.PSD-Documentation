---
title: Выпускные заметки Aspose.PSD для .NET 20.9
type: документация
weight: 40
url: /ru/net/aspose-psd-for-net-20-9-release-notes/
---

{{% alert color="primary" %}}

Эта страница содержит заметки о выпуске [Aspose.PSD для .NET 20.9](https://www.nuget.org/packages/Aspose.PSD/).

{{% /alert %}}

|**Ключ**|**Описание**|**Категория**|
| :- | :- | :- |
|PSDNET-408|Поддержка SoLEResource (Внешний ресурс умного объекта слоя)|Функция|
|PSDNET-614|Поддержка Связанных умных объектов|Функция|
|PSDNET-615|Поддержка Встроенных умных объектов|Функция|
|PSDNET-690|Обновление текста в данном файле PSD и сохранение его изменений некоторых слоев и многих параметров текста|Ошибка|
|PSDNET-696|FillLayer не обновляются после создания и не могут быть корректно отображены|Ошибка|
|PSDNET-712|Регрессия: Aspose.PSD 20.8.0 не может открыть файл|Ошибка|
|PSDNET-714|В конкретном файле PSD изменение размера TextLayer нарушает значение положения|Ошибка|
...
- P:Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource.DurationNumerator- P:Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource.DurationDenominator
- M:Aspose.PSD.FileFormats.Psd.Layers.LayerResources.SoLdResource.Save(Aspose.PSD.StreamContainer,System.Int32)

## **Примеры использования:**
**PSDNET-408. Поддержка SoLEResource (Внешний ресурс умного объекта слоя)**
{{< highlight csharp >}}
// Вставьте свой код здесь
{{< /highlight >}}

**PSDNET-614. Поддержка Связанных умных объектов**
{{< highlight csharp >}}
// Вставьте свой код здесь
{{< /highlight >}}

**PSDNET-615. Поддержка Встроенных умных объектов**
{{< highlight csharp >}}
// Вставьте свой код здесь
{{< /highlight >}}

**PSDNET-690. Обновление текста в данном файле PSD и сохранение его изменений некоторых слоев и многих параметров текста**
{{< highlight csharp >}}
// Вставьте св