---
title: Примечания к выпуску Aspose.PSD для .NET 22.1
type: docs
weight: 120
url: /ru/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}}

Эта страница содержит примечания к выпуску [Aspose.PSD для .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Ключ**|**Описание**|**Категория**|
| :- | :- | :- |
|PSDNET-1017|Наложение узора может быть применено только один раз|Ошибка|
|PSDNET-1056|Переполнение временных файлов при открытии файла из потока|Ошибка|
|PSDNET-991|Оптимизация рендеринга для размытия Гаусса умного фильтра|Функциональность|
|PSDNET-1044|Поддержка множества данных шаблонов в PattResource|Функциональность|
...
**PSDNET-1017. Наложение узора может быть применено только один раз**
{{< highlight csharp >}}
...
**PSDNET-1056. Переполнение временных файлов при открытии файла из потока**
{{< highlight csharp >}}
...
**PSDNET-991. Оптимизация рендеринга для размытия Гаусса умного фильтра**
{{< highlight csharp >}}
...
**PSDNET-1044. Поддержка множества данных шаблонов в PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("Корректное чтение элементов PattResourceData.");
                }
