---
title: Aspose.PSD для .NET 19.2 - Примечания к выпуску
type: docs
weight: 110
url: /ru/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.PSD для .NET 19.2

{{% /alert %}} 

|**Ключ**|**Краткое описание**|**Категория**|
| :- | :- | :- |
|PSDNET-97|Добавлена поддержка слоев заливки: заливка цветом|Функция|
|PSDNET-98|Добавлена поддержка слоев заливки: градиентная заливка|Функция|
|PSDNET-105|Поддержка GdFlResource|Функция|
|PSDNET-106|Поддержка VmskResource|Функция|
|PSDNET-109|Перенос фактических исходных кодов Aspose.Imaging в Aspose.PSD|Улучшения|
|PSDNET-92|Добавлена поддержка частичной загрузки для некоторых методов|Улучшения|
|PSDNET-110|Производительность PSD ухудшилась несколько раз|Ошибка|
