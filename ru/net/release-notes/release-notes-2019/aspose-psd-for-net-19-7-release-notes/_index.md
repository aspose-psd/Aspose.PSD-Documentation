---
title: Выпуск Aspose.PSD для .NET 19.7 - Примечания к выпуску
type: docs
weight: 60
url: /ru/net/aspose-psd-for-net-19-7-release-notes/
---

{{% alert color="primary" %}}

Эта страница содержит примечания к выпуску [Aspose.PSD для .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Ключ**|**Описание**|**Категория**|
| :- | :- | :- |
|PSDNET-126|Поддержка обработки векторных масок слоев|Функция|
|PSDNET-130|Реализация правильного метода изменения размера для файлов PSD|Функция|
|PSDNET-165|Добавить поддержку экспорта PSD в PDF|Функция|
|PSDNET-186|Добавить поддержку экспорта формата AI (версии 2 и 3) в другие форматы|Функция|
...
**PSDNET-126. Поддержка обработки векторных масок слоев**
...
{{< highlight java >}}
...

            {
                ...
                // внесение изменений в точки векторного пути
...
**PSDNET-130. Реализация правильного метода изменения размера для файлов PSD**

{{< highlight java >}}

              // Реализация правильного метода изменения размера для файлов PSD.
...
**PSDNET-165. Добавление поддержки экспорта PSD в PDF**

{{< highlight java >}}

   // Добавление поддержки экспорта PSD в PDF
...
**PSDNET-186. Добавление поддержки экспорта формата AI (версии 2 и 3) в другие форматы**

{{< highlight java >}}

 // Добавить поддержку экспорта формата AI (версии 2 и 3) в другие форматы
