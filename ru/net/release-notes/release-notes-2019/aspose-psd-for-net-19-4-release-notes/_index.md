---
title: Примечания к выпуску Aspose.PSD для .NET 19.4
type: docs
weight: 90
url: /ru/net/aspose-psd-for-net-19-4-release-notes/
---

{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску Aspose.PSD для .NET 19.4

{{% /alert %}} 

|**Ключ**|**Описание**|**Категория**|
| :- | :- | :- |
|PSDNET-87|Создание возможности загрузки изображений JPEG/PNG и т.д. в PsdImage без прямой загрузки (что не поддерживается в Aspose.PSD)|Возможность|
|PSDNET-120|Поддержка цветового режима RGB с 16 битами на канал (64 бита на цвет)|Возможность|
|PSDNET-108|Поддержка векторных масок слоя и пользовательского поворота/отражения текстового слоя|Возможность|
|PSDNET-99|Все азиатские символы некорректно отображаются|Ошибка|
|PSDNET-116|Символы \r\n интерпретируются как двойной разрыв строки, что неверно|Ошибка|
|PSDNET-117|Если TextLayer обновляется строкой, содержащей разрывы строк, то файл PSD становится неразборчивым|Ошибка|
|PSDNET-118|Если TextLayer обновляется строкой, содержащей символы табуляции, обработка завершается с исключением|Ошибка|
...
**PSDNET-87. Создание возможности загрузки файлов изображений JPEG/PNG и т.д. в PsdImage без прямой загрузки(Что не поддерживается в Aspose.PSD)**
...
**PSDNET-120. Поддержка цветового режима RGB с 16 битами на канал (64 бита на цвет)**

{{< highlight java >}}

  // Поддержка цветового режима RGB с 16 битами на канал (64 бита на цвет)
...
// Файлы должны быть открыты без исключений и должны быть читаемыми для Photoshop    

using(Image image = Image.Load(outputFilePathPsd)) {}  

{{< /highlight >}}

**PSDNET-108. Поддержка векторных масок слоя и пользовательского поворота/отражения текстового слоя**

{{< highlight java >}}

 // Операция RotateFlip не работает должным образом с PSD
...
**PSDNET-99. Все азиатские символы некорректно отображаются**

[**Пожалуйста, проверьте прикрепленный пример**](attachments/86278147/86343681.cs)

**PSDNET-116. Символы \r\n интерпретируются как двойной разрыв строки, что неверно**
...
// Файл должен быть открыт без исключений и должен быть читаемым для Photoshop. Должен содержать 3 перевода строки, по одному между каждой строкой
...
**PSDNET-117. Если TextLayer обновляется строкой, содержащей разрывы строк, то файл PSD становится неразборчивым**

{{< highlight java >}}

 // Если TextLayer обновляется строкой, содержащей разрывы строк, то файл PSD становится неразборчивым.
...
// Файл должен быть открыт без исключений и должен быть читаемым для Photoshop
...
**PSDNET-118. Если TextLayer обновляется строкой, содержащей символы табуляции, обработка завершается с исключением**
