---
title: Aspose.PSD для .NET 19.6 - Примечания к выпуску
type: docs
weight: 70
url: /ru/net/aspose-psd-for-net-19-6-release-notes/
---

{{% alert color="primary" %}} 

Эта страница содержит примечания к выпуску [Aspose.PSD для .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Ключ**|**Сводка**|**Категория**|
| :- | :- | :- |
|PSDNET-127|Возможность конвертации PSD-файла в PSB и обратно|Функция|
|PSDNET-154|Перенос исходных кодов Aspose.Imaging 19.5 в Aspose.PSD|Улучшение|
|PSDNET-155|Очистка общего API, относящегося к Aspose.PSD|Улучшение|
|PSDNET-159|Удаление свойства IsLicensed|Улучшение|
|PSDNET-102|Зависание при конвертации PSB в JPG|Ошибка|
|PSDNET-150|Новым добавленный текстовый слой сдвигается при редактировании в Photoshop|Ошибка|
