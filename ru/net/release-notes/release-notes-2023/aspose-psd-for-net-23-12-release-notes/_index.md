---
title: Релизные заметки Aspose.PSD для .NET 23.12
type: документация
weight: 10
url: /ru/net/aspose-psd-for-net-23-12-release-notes/
---

{{% alert color="primary" %}}

На этой странице содержатся релизные заметки для [Aspose.PSD для .NET 23.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Ключ**    | **Описание**                                                                                               | **Категория** |
|:------------|:----------------------------------------------------------------------------------------------------------|:------------|
| PSDNET-1679 | [Формат AI] Добавлена поддержка отображения растрового изображения в новой версии AI                      |   Функционал  |
| PSDNET-1454 | Обработка типа градиента "Шум" в GdflResrource                                                          |   Функционал  |
| PSDNET-1827 | Ошибка "Ссылка на объект не указывает на экземпляр объекта." при сохранении текстового слоя после обновления |     Ошибка    |
| PSDNET-1776 | Исправление ручной загрузки шрифтов на MacOS с использованием System.Drawing.Common и Aspose.Drawing.       |     Ошибка    |
| PSDNET-1536 | AllowWarpRepaint в PsdLoadOptions приводит к исключению                                                  |     Ошибка    |
| PSDNET-1714 | [Формат AI] Реализовать обработку потоков кросс-ссылок                                                    | Улучшение    |
| PSDNET-1834 | Лицензионное управление для VectorPathDataResource работает некорректно                                  | Улучшение    |
| PSDNET-770  | Открытие любого изображения в качестве встроенного умного объекта в PSD изображении                       | Улучшение    |
| PSDNET-1864 | Система лицензирования плагинов для Aspose.PSD                                                          | Улучшение    |
...
**PSDNET-1679. [Формат AI] Добавление поддержки отображения растрового изображения в новой версии AI**
...
**PSDNET-1454. Обработка типа градиента "Шум" в GdflResrource**
...
**PSDNET-1827. Ошибка "Ссылка на объект не указывает на экземпляр объекта." при сохранении текстового слоя после обновления**
...
**PSDNET-1536. AllowWarpRepaint в PsdLoadOptions приводит к исключению**
...
**PSDNET-1834. Лицензионное управление для VectorPathDataResource работает некорректно**
...
**PSDNET-770. Открытие любого изображения в качестве встроенного умного объекта в PSD изображении**
...
**PSDNET-1864. Система лицензирования плагинов для Aspose.PSD**

{{< highlight csharp >}}            
    var metered = new Metered();
    metered.SetMeteredKey(pluginPublic, pluginPrivate);
			
	// Специфический для плагина код
{{< /highlight >}}