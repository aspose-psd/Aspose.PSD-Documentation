---
title: Aspose.PSD для Java 24.8 - Примечания к выпуску
type: docs
weight: 40
url: /ru/java/aspose-psd-dlya-java-24-8-primechaniya-k-vypusku/
---

{{% alert color="primary" %}} На этой странице содержатся примечания к выпуску для [Aspose.PSD для Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Ключ**    | **Описание**                                                                                       | **Категория** |
|:------------|:---------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [Формат AI] Добавить обработку групп XObject                                                       | Улучшение    |
| PSDJAVA-645 | Улучшить возможности трансформации Warp, добавив WarpSettings для TextLayer и SmartObjectLayer    | Функционал   |
| PSDJAVA-646 | [Формат AI] Обработка операторов слоев в потоках содержимого                                      | Функционал   |
| PSDJAVA-647 | Рендеринг результата файла AI значительно отличается от результатов в Illustrator                  | Ошибка       |
| PSDJAVA-648 | Переподключение Smart Object не применяется ко всем Smart Object в файле PSD                     | Ошибка       |
...
**PSDJAVA-645. Улучшить возможности трансформации Warp, добавив WarpSettings для TextLayer и SmartObjectLayer**
...
**PSDJAVA-646. [Формат AI] Обработка операторов слоев в потоках содержимого**
...
**PSDJAVA-647. Рендеринг результата файла AI значительно отличается от результатов в Illustrator**
...
**PSDJAVA-648. Переподключение Smart Object не применяется ко всем Smart Object в файле PSD**
