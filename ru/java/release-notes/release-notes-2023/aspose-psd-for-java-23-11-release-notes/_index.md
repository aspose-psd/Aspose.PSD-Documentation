---
title: Aspose.PSD для Java 23.11 - Примечания к выпуску
type: docs
weight: 40
url: /ru/java/aspose-psd-для-java-23-11-примечания-к-выпуску/
---

{{% alert color="primary" %}} На этой странице содержатся примечания к выпуску для [Aspose.PSD для Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) {{% /alert %}}

| **Ключ**       | **Краткое описание**                                                                                       | **Категория** |
|:---------------|:-----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | Поддержка LMskResource                                                                                    |    Функция   |
| PSDJAVA-552    | [Формат AI] Добавление возможности отображения файлов AI на основе PDF с помощью Aspose.PSD                |    Функция   |
| PSDJAVA-553    | [Формат AI] Добавлена поддержка оператора PostScript "см"                                                   |    Функция   |
| PSDJAVA-554    | Добавление новых типов искажений: Волна, раковина вверх, раковина вниз                                   |    Функция   |
| PSDJAVA-555    | Добавлена поддержка вертикального искажения                                                               |    Функция   |
| PSDJAVA-556    | System.ArgumentNullException: 'Значение не может быть пустым. (Параметр 'key')' при вызове TextLayer.GetFonts()  |      Ошибка    |
...
** PSDJAVA-551. Поддержка LMskResource**
...
** PSDJAVA-552. [Формат AI] Добавление возможности отображения файлов AI на основе PDF с помощью Aspose.PSD **
...
** PSDJAVA-553. [Формат AI] Добавлена поддержка оператора "cm" PostScript **
...
** PSDJAVA-554. Добавление новых типов искажений: Волна, раковина вверх, раковина вниз **
...
** PSDJAVA-555. Добавлена поддержка вертикального искажения **
...
** PSDJAVA-556. System.ArgumentNullException: 'Значение не может быть пустым. (Параметр 'key')' при вызове TextLayer.GetFonts()**
