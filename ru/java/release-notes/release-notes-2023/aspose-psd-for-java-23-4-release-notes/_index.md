```ru
---
title: Aspose.PSD для Java 23.4 - Примечания к выпуску
type: docs
weight: 40
url: /ru/java/aspose-psd-for-java-23-4-release-notes/
---

{{% alert color="primary" %}} На этой странице содержатся примечания к [Aspose.PSD для Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) {{% /alert %}}

|**Ключ**|**Сводка**|**Категория**|
| :- | :- | :- |
|PSDJAVA-446|Перенос пропущенного функционала из Aspose.PSD для .Net в Aspose.PSD для Java|Улучшение|
|PSDJAVA-441|Создание класса RawColor для общественного API для использования его в PSD API вместо устаревшей структуры Color|Улучшение|
|PSDJAVA-418|Интеграция современной Aspose License для Aspose.PSD|Улучшение|
|PSDJAVA-445|Изменение форматирования во время редактирования в Photoshop|Ошибка|
|PSDJAVA-443|Редактирование текста с использованием порций текста не сохраняет правильный результат|Ошибка|
|PSDJAVA-444|Начало и конец стилей или абзацев появляется в неправильном месте при редактировании слоя текста с помощью ITextPortion|Ошибка|
|PSDJAVA-445|Изменение форматирования во время редактирования в Photoshop|Ошибка|
