---
title: Заметки по выпуску Aspose.PSD для Python via .NET 23.12
type: док
weight: 10
url: /ru/net/aspose-psd-for-python-via-net-23-12-release-notes/
---

{{% alert color="primary" %}}

На этой странице содержатся заметки о выпуске [Aspose.PSD для Python via .NET 23.12](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Ключ**     | **Краткое содержание**                                                                                       | **Категория** |
|:--------------|:-------------------------------------------------------------------------------------------------------------|:------------|
|  PSDPYTHON-7  | [Формат AI] Добавлена поддержка рендеринга растрового изображения в новой версии AI                          |   Функция    |
|  PSDPYTHON-8  | Обработка шума типа градиента в ресурсе GdflResrource                                                         |   Функция    |
|  PSDPYTHON-9  | Ошибка "Ссылка на объект не указывает на экземпляр объекта" при сохранении текстового слоя после обновления  |   Ошибка     |
|  PSDPYTHON-10 | Исправление ручной загрузки шрифтов на MacOS с использованием System.Drawing.Common и Aspose.Drawing.         |   Ошибка     |
|  PSDPYTHON-11 | AllowWarpRepaint в параметрах загрузки PsdLoadOptions приводит к исключению                                  |   Ошибка     |
|  PSDPYTHON-12 | [Формат AI] Реализация обработки потоков перекрестных ссылок                                                   | Улучшение    |
|  PSDPYTHON-13 | Контроль лицензии для VectorPathDataResource работает некорректно                                             | Улучшение    |
...
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.GradientType
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.GradientName
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.FillType
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.Color
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.AlignWithLayer
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.Dither
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.Reverse
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.Angle
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.HorizontalOffset
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.VerticalOffset
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.ColorPoints
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.TransparencyPoints
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.Scale
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.BaseGradientFillSettings.GradientMode
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.GradientFillSettings.Interpolation
- П:Aspose.PSD.FileFormats.Psd.Layers.FillSettings.IGradientFillSettings.GradientMode
...
**PSDPYTHON-7. [Формат AI] Добавление поддержки рендеринга растрового изображения в новой версии AI**
...
**PSDPYTHON-8. Обработка шума типа градиента в ресурсе GdflResrource**

{{< highlight python >}}
        # Пример работы с этим GdFlResource с использованием базового API   
		...
		# Пример работы с заполнением сплошного градиента
		...
		# Пример работы с шумовым градиентом
...
**PSDPYTHON-9. Ошибка "Ссылка на объект не указывает на экземпляр объекта" при сохранении текстового слоя после обновления**
