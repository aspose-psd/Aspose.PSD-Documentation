---
title: Aspose.PSD для Python via .NET 24.8 - Примечания к выпуску
type: docs
weight: 10
url: /ru/python-net/aspose-psd-for-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

Эта страница содержит примечания к выпуску для [Aspose.PSD для Python via .NET 24.8](https://pypi.org/project/aspose-psd/).

{{% /alert %}}

| **Ключ**      | **Краткое описание**                                                                                               | **Категория** |
|:-------------|:-------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [Формат AI] Добавить обработку групп XObject                                                      | Улучшение    |
| PSDPYTHON-82 | Улучшить возможности трансформации Warp, добавив WarpSettings для TextLayer и SmartObjectLayer | Функция      |
| PSDPYTHON-83 | [Формат AI] Обработка слоев в операторах потоков контента                                             | Функция      |
| PSDPYTHON-84 | Результат рендеринга файла AI очень отличается по сравнению с результатами Illustrator               | Ошибка          |
| PSDPYTHON-85 | Перепривязка Smart Object не применяется ко всем Smart Object в файле PSD                          | Ошибка          |
...
**PSDPYTHON-81. [Формат AI] Добавить обработку групп XObject**
{{< highlight python >}}
#Пример отсутствует. Это внутреннее улучшение
{{< /highlight >}}

**PSDPYTHON-82. Улучшить возможности трансформации Warp, добавив WarpSettings для TextLayer и SmartObjectLayer**
{{< highlight python >}}
...
**PSDPYTHON-83. [Формат AI] Обработка слоев в операторах потоков контента**
{{< highlight python >}}
...
**PSDPYTHON-84. Результат рендеринга файла AI очень отличается по сравнению с результатами Illustrator**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. Перепривязка Smart Object не применяется ко всем Smart Object в файле PSD**
{{< highlight python >}}
