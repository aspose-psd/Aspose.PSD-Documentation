---
title: Note sulla versione di Aspose.PSD per Java 24.8
type: docs
weight: 40
url: /it/java/aspose-psd-for-java-24-8-release-notes/
---

{{% alert color="primary" %}} Questa pagina contiene le note sulla versione di [Aspose.PSD per Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Chiave**  | **Sommario**                                                                                         | **Categoria** |
|:------------|:-----------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [AI Format] Aggiunta gestione per Gruppi XObject                                                     | Miglioramento |
| PSDJAVA-645 | Migliorare le capacità di trasformazione Warp aggiungendo WarpSettings per TextLayer e SmartObjectLayer | Funzionalità |
| PSDJAVA-646 | [AI Format] Gestione dei livelli negli operatori dei flussi di contenuti                            | Funzionalità |
| PSDJAVA-647 | Il risultato del rendering del file AI è molto diverso rispetto ai risultati di Illustrator         | Errore       |
| PSDJAVA-648 | Il ricollegamento dello Smart Object non si applica a tutti gli Smart Object nel file PSD          | Errore       |
...
**PSDJAVA-645. Migliorare le capacità di trasformazione Warp aggiungendo WarpSettings per TextLayer e SmartObjectLayer**
...
**PSDJAVA-646. [AI Format] Gestione dei livelli negli operatori dei flussi di contenuti**
...
**PSDJAVA-647. Il risultato del rendering del file AI è molto diverso rispetto ai risultati di Illustrator**
...
**PSDJAVA-648. Il ricollegamento dello Smart Object non si applica a tutti gli Smart Object nel file PSD**
