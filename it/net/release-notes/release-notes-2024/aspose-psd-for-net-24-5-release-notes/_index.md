---
title: Note sulla versione di Aspose.PSD per .NET 24.5
type: docs
weight: 80
url: /it/net/aspose-psd-for-net-24-5-release-notes/
---

{{% alert color="primary" %}}

Questa pagina contiene le note sulla versione di [Aspose.PSD per .NET 24.5](https://www.nuget.org/packages/Aspose.PSD/)
