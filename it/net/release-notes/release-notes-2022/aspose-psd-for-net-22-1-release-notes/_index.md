---
title: Note sulla versione di Aspose.PSD per .NET 22.1
type: docs
weight: 120
url: /it/net/aspose-psd-for-net-22-1-note-sulla-versione/
---

{{% alert color="primary" %}}

Questa pagina contiene le note sulla versione di [Aspose.PSD per .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Chiave**|**Sommario**|**Categoria**|
| :- | :- | :- |
|PSDNET-1017|L'overlay del pattern può essere applicato solo una volta|Errore|
|PSDNET-1056|Sovraccarico dei file temporanei durante l'apertura di un file da uno stream|Errore|
|PSDNET-991|Ottimizzazione del rendering per il filtro smart del blur gaussiano|Caratteristica|
|PSDNET-1044|Supporto di molti dati dei modelli presso PattResource|Caratteristica|
...
## **Esempi di utilizzo:**
**PSDNET-1017. L'overlay del pattern può essere applicato solo una volta**
{{< highlight csharp >}}
...
**PSDNET-1056. Sovraccarico dei file temporanei durante l'apertura di un file da uno stream**
{{< highlight csharp >}}
            ...
            using (var memStream = new MemoryStream())
            {
                ...
                {
                    // cerca la più bassa eccezione di livello
                    exception = mainEx;
                ...
                // controlla eccezione
                string typeName = exception.GetType().Name; // per il debug
...
**PSDNET-991. Ottimizzazione del rendering per il filtro smart del blur gaussiano**
{{< highlight csharp >}}
          string sourceFilte = "psdnet991_layers.psd";
            ...
            using (var image = (PsdImage)Image.Load(sourceFilte))
            {
                ...
                // Applica il filtro al livello SmartObject
                gaussianBlur.Apply(smartLayer);
                smartLayer.SmartFilters.UpdateResourceValues();
                smartLayer.UpdateModifiedContent();

                // Applica il filtro al livello della maschera
...
**PSDNET-1044. Supporto di molti dati dei modelli presso PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("Lettura corretta degli elementi di PattResourceData.");
                }
