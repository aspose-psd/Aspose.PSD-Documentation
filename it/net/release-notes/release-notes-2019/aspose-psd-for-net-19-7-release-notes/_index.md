---
title: Note sulla versione di rilascio di Aspose.PSD per .NET 19.7
type: docs
weight: 60
url: /it/net/aspose-psd-for-net-19-7-release-notes/
---

{{% alert color="primary" %}} 

Questa pagina contiene le note sulla versione di [Aspose.PSD per .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Chiave**|**Sommario**|**Categoria**|
| :- | :- | :- |
|PSDNET-126|Supporto per l'elaborazione delle maschere vettoriali sui livelli|Funzionalità|
|PSDNET-130|Implementa correttamente il metodo di ridimensionamento per i file PSD|Funzionalità|
|PSDNET-165|Aggiungi supporto per l'esportazione di PSD in PDF|Funzionalità|
|PSDNET-186|Aggiungi supporto per l'esportazione del formato AI (Versione 2 e 3) in altri formati|Funzionalità|
...
## **Esempi di utilizzo:**
**PSDNET-126. Supporto per l'elaborazione delle maschere vettoriali sui livelli**
...
{{< highlight java >}}
...

            {
                ...
                // apportare modifiche ai punti del percorso vettoriale
...
**PSDNET-130. Implementa correttamente il metodo di ridimensionamento per i file PSD**

{{< highlight java >}}

              // Implementa correttamente il metodo di ridimensionamento per i file PSD.
...
**PSDNET-165. Aggiungi supporto per l'esportazione di PSD in PDF**

{{< highlight java >}}

   // Aggiungi supporto per l'esportazione di PSD in PDF
...
**PSDNET-186. Aggiungi supporto per l'esportazione del formato AI (Versione 2 e 3) in altri formati**

{{< highlight java >}}

 // Aggiungi supporto per l'esportazione del formato AI (Versione 2 e 3) in altri formati
