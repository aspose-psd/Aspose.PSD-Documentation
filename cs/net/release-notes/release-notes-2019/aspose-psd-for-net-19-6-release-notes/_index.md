```cs
---
title: Aspose.PSD pro .NET 19.6 - Poznámky k vydání
type: docs
weight: 70
url: /cs/net/aspose-psd-pro-net-19-6-poznamky-k-vydani/
---

{{% alert color="primary" %}}

Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/).

{{% /alert %}}

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDNET-127|Schopnost konvertovat soubor PSD na PSB a naopak|Funkce|
|PSDNET-154|Přenesení zdrojových kódů Aspose.Imaging 19.5 do Aspose.PSD|Vylepšení|
|PSDNET-155|Vyčištění veřejného API týkajícího se Aspose.PSD|Vylepšení|
|PSDNET-159|Odstranění vlastnosti IsLicensed|Vylepšení|
|PSDNET-102|Konverze PSB na JPG zamrzne|Chyba|
|PSDNET-150|Nově přidaná textová vrstva má posunutou pozici při úpravě v Photoshopu|Chyba|
