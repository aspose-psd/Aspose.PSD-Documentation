---
title: Aspose.PSD pro .NET 19.5 - Poznámky k vydání
type: docs
weight: 80
url: /cs/net/aspose-psd-pro-net-19-5-poznamky-k-vydani/
---

{{% alert color="primary" %}} 

Tato stránka obsahuje poznámky k vydání pro Aspose.PSD pro .NET 19.5

{{% /alert %}} 

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDNET-133|Přidána podpora vrstev vyplňování: Vzor|Funkce|
|PSDNET-138|Podpora PtFlResource|Funkce|
|PSDNET-129|Implementace správné metody ořezávání pro soubory PSD|Funkce|
|PSDNET-140|Podpora VsmsResource|Funkce|
|PSDNET-121|Viditelné vrstvy ve viditelné podadresáři v neviditelném adresáři jsou vykresleny, ale neměly by být|Chyba|
|PSDNET-119|PSD (režim RGB 16 bitů na kanál) není správně převeden na JPG|Chyba|
...
## **Příklady použití:**
**PSDNET-133. Přidání podpory vrstev vyplňování: Vzor**

{{< highlight java >}}

 // Přidání podpory vrstev vyplňování: Vzor
...

         {
...

             {
                  ...
                  if (fillSettings.HorizontalOffset != -46 || 
                      ...
                      fillSettings.PatternName != "$$$/Presets/Patterns/OpticalSquares=Optické čtverce" ||
...

                      {
                          ...
                          throw new Exception("Obrázek PSD byl špatně načten");
...
**PSDNET-138. Podpora PtFlResource**

{{< highlight java >}}

  // Podpora PtFlResource
...

                {
...

                    {
                        ...
                        if (
                            ...
                            resource.PatternName != "$$$/Presets/Patterns/OpticalSquares=Optické čtverce\0" ||
                            ...
                            !(Math.Abs(resource.Scale - 50) < tolerance)) {
                                ...
                                throw new Exception("PtFl Resource byl načten špatně");
                        ...
                        // Nemáme data obrázku v PattResource, takže je můžeme přidat.
                        ...
                        fillSettings.PatternName = "$$$/Presets/Patterns/VerticalLine=Svislá čára nová\0";
...
**PSDNET-129. Implementace správné metody ořezávání pro soubory PSD**

{{< highlight java >}}

             // Implementace správné metody ořezávání pro soubory PSD.
...
**PSDNET-140. Podpora VsmsResource**

{{< highlight java >}}

 // Podpora VsmsResource

        static void PříkladPodporyVsmsResource()

        {
...

            {
...

                {
                        ...
                        throw new Exception("VsmsResource byl načten špatně");
                ...
                // Pravidlo trasy plnění cesty neobsahuje žádné další informace
...

                {
                    ...
                    throw new Exception("Cesty VsmsResource byly načteny špatně");
...

        {
...

            {
                ...
                throw new Exception("VsmsResource nebyl nalezen");
...
**PSDNET-121: Viditelné vrstvy ve viditelném podadresáři v neviditelném adresáři jsou vykresleny, ale neměly by být**

{{< highlight java >}}

 // Viditelné vrstvy ve viditelném podadresáři v neviditelném adresáři jsou vykresleny, ale neměly být
...
**PSDNET-119. PSD (režim RGB 16 bitů na kanál) není správně převeden na JPG**

{{< highlight java >}}

  // Psd není správně převeden na jpg
