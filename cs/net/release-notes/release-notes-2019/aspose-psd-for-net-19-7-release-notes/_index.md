---
title: Aspose.PSD pro .NET 19.7 - Poznámky k vydání
type: docs
weight: 60
url: /cs/net/aspose-psd-pro-net-19-7-poznamky-k-vydani/
---

{{% alert color="primary" %}} 

Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDNET-126|Podpora zpracování vektorových masek vrstvy|Funkce|
|PSDNET-130|Implementace správné metody změny velikosti pro soubory PSD|Funkce|
|PSDNET-165|Přidání podpory pro exportování PSD do PDF|Funkce|
|PSDNET-186|Přidání podpory pro export formátu AI (Verze 2 a 3) do jiných formátů|Funkce|
...
## **Příklady použití:**
**PSDNET-126. Podpora zpracování vektorových masek vrstvy**
...
{{< highlight java >}}
...

            {
                ...
                // provedení změn ve vektorových cestách
...
**PSDNET-130. Implementace správné metody změny velikosti pro soubory PSD**

{{< highlight java >}}

              // Implementace správné metody změny velikosti pro soubory PSD.
...
**PSDNET-165. Přidání podpory pro exportování PSD do PDF**

{{< highlight java >}}

   // Přidání podpory pro exportování PSD do PDF
...
**PSDNET-186. Přidání podpory pro export formátu AI (Verze 2 a 3) do jiných formátů**

{{< highlight java >}}

 // Přidání podpory pro export formátu AI (Verze 2 a 3) do jiných formátů
