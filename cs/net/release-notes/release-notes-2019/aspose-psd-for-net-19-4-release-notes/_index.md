---
title: Aspose.PSD pro .NET 19.4 - Poznámky k vydání
type: docs
weight: 90
url: /cs/net/aspose-psd-pro-net-19-4-poznamky-k-vydani/
---

{{% alert color="primary" %}} 

Tato stránka obsahuje poznámky k vydání pro Aspose.PSD pro .NET 19.4

{{% /alert %}} 

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDNET-87|Umožnit funkci načíst soubory obrázků JPEG/PNG atd. do obrázku PsdImage bez přímého načítání (což není podporováno v Aspose.PSD)|Funkce|
|PSDNET-120|Podpora režimu barev RGB s 16 bity/kanál (64 bity na barvu)|Funkce|
|PSDNET-108|Podpora vektorových masek vrstev a vlastního otočení textových vrstev|Funkce|
|PSDNET-99|Všechny asijské znaky nejsou správně vykreslovány|Chyba|
|PSDNET-116|Symboly \r\n jsou interpretovány jako dvojité odřádkování, což je chybné|Chyba|
|PSDNET-117|Pokud je TextLayer aktualizován řetězcem obsahujícím odřádkování, stane se soubor PSD nečitelným|Chyba|
|PSDNET-118|Pokud je TextLayer aktualizován řetězcem obsahujícím znaky tabulátoru, zpracování selže s výjimkou|Chyba|
...
## **Příklady použití:**
**PSDNET-87. Umožnění funkce načíst soubory obrázků JPEG/PNG atd. do obrázku PsdImage bez přímého načítání (což není podporováno v Aspose.PSD)**

{{< highlight java >}}

 string filePath = "Příklad.psd";

string outputFilePath = "Výsledek.psd";
...
**PSDNET-120. Podpora režimu barev RGB s 16 bity/kanál (64 bity na barvu)**

{{< highlight java >}}

  // Podpora režimu barev RGB s 16 bity/kanál (64 bity na barvu)
...
**PSDNET-108. Podpora vektorových masek vrstev a vlastního otočení textových vrstev**

{{< highlight java >}}

 // Operace RotateFlip nefunguje tak, jak se očekává s PSD
...
**PSDNET-99. Všechny asijské znaky nejsou správně vykreslovány**

[**Prosím zkontrolujte přiložený příklad**](attachments/86278147/86343681.cs)

**PSDNET-116. Symboly \r\n jsou interpretovány jako dvojité odřádkování, což je chybné**
...
string exportPath = "Výsledek.psd";
...
using(Image image = Image.Load(sourceFileName)) {
 ...
 for (int index = layers.Length - 1; index >= 0; index--) {
  ...
  textLayer.UpdateText("První odstavec\r\nDruhý odstavec\rTřetí odstavec\nČtvrtý odstavec");
...
// Soubor musí být otevřen bez výjimky a musí být čitelný pro Photoshop. Musí obsahovat 3 odřádkování, jedno mezi každým řádkem

using(Image image = Image.Load(exportPath)) {}

{{< /highlight >}}

**PSDNET-117. Pokud je TextLayer aktualizován řetězcem obsahujícím odřádkování, stane se soubor PSD nečitelným**

{{< highlight java >}}

 // Pokud je TextLayer aktualizován řetězcem obsahujícím odřádkování, stane se soubor PSD nečitelným.
