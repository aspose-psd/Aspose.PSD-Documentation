---
title: Aspose.PSD pro .NET 23.12 - Poznámky k vydání
type: docs
weight: 10
url: /cs/net/aspose-psd-pro-net-23-12-poznamky-k-vydani/
---

{{% alert color="primary" %}}

Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro .NET 23.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Klíč**    | **Souhrn**                                                                                                | **Kategorie** |
|:------------|:----------------------------------------------------------------------------------------------------------|:------------|
| PSDNET-1679 | [AI Formát] Přidání podpory pro vykreslování rastrových obrázků ve nové verzi AI                              |   Funkce   |
| PSDNET-1454 | Zpracování typu šumu gradientu v GdflResrource                                                           |   Funkce   |
| PSDNET-1827 | Chyba "Odkaz na objekt není nastaven na instanci objektu." při ukládání textové vrstvy po aktualizaci      |     Chyba     |
| PSDNET-1776 | Oprava manuálního načítání písem na MacOS pomocí System.Drawing.Common a Aspose.Drawing.                  |     Chyba     |
| PSDNET-1536 | AllowWarpRepaint v možnostech načtení PsdLeadOptions vede k výjimce                                     |     Chyba     |
| PSDNET-1714 | [AI Formát] Implementace zpracování proudů křížových odkazů.                                              | Vylepšení |
| PSDNET-1834 | Licence Control pro VectorPathDataResource funguje nesprávně                                          | Vylepšení |
| PSDNET-770  | Otevření libovolného souboru obrázku jako vložený chytrý objekt v obrázku PSD.                           | Vylepšení |
| PSDNET-1864 | Aspose.PSD Plugin Licenční systém                                                                       | Vylepšení |
...
**PSDNET-1679. [AI Formát] Přidání podpory pro vykreslování rastrového obrázku ve nové verzi AI**
...
**PSDNET-1454. Zpracování typu gradientu Noise v GdflResrource**
...
**PSDNET-1827. Chyba "Odkaz na objekt není nastaven na instanci objektu." při ukládání textové vrstvy po aktualizaci**
...
**PSDNET-1536. Povolit AllowWarpRepaint v možnostech PsdLoadOptions vede k výjimce**
...
**PSDNET-1834. Licence Control pro VectorPathDataResource funguje nesprávně**
...
**PSDNET-770. Otevřít libovolný soubor obrázku jako vložený chytrý objekt v obrázku PSD**
...
**PSDNET-1864. Aspose.PSD Plugin Licenční systém**

{{< highlight csharp >}}            
    var metered = new Metered();
    metered.SetMeteredKey(pluginPublic, pluginPrivate);
			
	// Manipulace specifické pro plugin
{{< /highlight >}}