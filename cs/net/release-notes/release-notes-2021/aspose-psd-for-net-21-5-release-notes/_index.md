---
title: Aspose.PSD pro .NET 21.5 - Poznámky k vydání
type: docs
weight: 80
url: /cs/net/aspose-psd-pro-net-21-5-poznamky-k-vydani/
---

{{% alert color="primary" %}} 

Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro .NET 21.5](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDNET-758|Podpora změny velikosti vrstev tvarů s vektorovými cestami|Funkce|
|PSDNET-862|Podpora změny velikosti vrstev tvarů s vektorovými cestami, když je změněna pouze vrstva|Funkce|
|PSDNET-578|Oříznutý textový řetězec|Chyba|
...
**PSDNET-578. Oříznutý textový řetězec**
...
**PSDNET-758. Podpora změny velikosti vrstev tvarů s vektorovými cestami**
...
**PSDNET-862. Podpora změny velikosti vrstev tvarů s vektorovými cestami, když je změněna pouze vrstva**

{{< highlight csharp >}}
            // Tento příklad ukazuje, jak změnit velikosti vrstev s Vogk a vektorovou cestou v obrázku PSD
            float scaleX = 0.45f;
            float scaleY = 1.60f;
