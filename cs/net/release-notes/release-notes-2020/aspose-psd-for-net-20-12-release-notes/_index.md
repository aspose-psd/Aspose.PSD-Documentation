---
title: Aspose.PSD pro .NET 20.12 - Poznámky k vydání
type: docs
weight: 10
url: /cs/net/aspose-psd-pro-net-20-12-poznamky-k-vydani/
---

{{% alert color="primary" %}} 

Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro .NET 20.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Klíč**|**Shrnutí**|**Kategorie**|
| :- | :- | :- |
|PSDNET-757|Podpora konverze vrstev na Vrstvu chytrého objektu|Funkce|
|PSDNET-764|Metoda SmartObjectLayer.ReplaceContents vyvolává výjimku NullReferenceException, pokud se pokusíme přidat soubor PSB|Chyba|
|PSDNET-773|Nesprávné vykreslování obrázků CMYK 8-bit a CMYK 16-bit, pokud je vrstva větší než plátno|Chyba|
|PSDNET-782|Uložený soubor PSB lze otevřít pomocí našeho API, ale ne Photoshopu|Chyba|
|PSDNET-783|Při pokusu o změnu chytré vrstvy v konkrétním souboru PSD se sdíleným datovým zdrojem obdržíme výjimku|Chyba|
|PSDNET-172|Přejmenování FileFormatVersion na PsdVersion pro zabránění zmatení|Vylepšení|
|PSDNET-620|Odstranění konfigurace Compact framework z Aspose.PSD .NET|Vylepšení|
|PSDNET-765|PsdImageException: Neznámá hlavička prostředků při pokusu o otevření souboru PSB s chytrými vrstvami|Vylepšení|
|PSDNET-798|Přesunutí hierarchie tříd Vector Mask do jádrového jmenného prostoru pro zajištění jednotnosti produktů Aspose.PSD a Aspose.Imaging|Vylepšení|
