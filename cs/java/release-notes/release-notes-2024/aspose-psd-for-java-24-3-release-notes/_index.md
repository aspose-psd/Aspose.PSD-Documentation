---
title: Aspose.PSD pro Java 24.3 - Poznámky k vydání
type: docs
weight: 40
url: /cs/java/aspose-psd-pro-java-24-3-poznamky-k-vydani/
---

{{% alert color="primary" %}} Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro Java 24.3](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.3/) {{% /alert %}}

| **Klíč**     | **Souhrn**                                                                  | **Kategorie** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDJAVA-601 | [AI Formát] Snížení doby načítání velkých vícestránkových obrázků AI.       | Vylepšení     |
| PSDJAVA-604 | Soubor PSD se po převedení z 8 bitů na 16 bitů stal nečitelným.              | Oprava chyby  |
| PSDJAVA-605 | Soubor PSD se po převedení z 8 bitů na 32 bitů stal nečitelným.              | Oprava chyby  |
| PSDJAVA-606 | [AI Formát] Oprava vykreslování krátké křivky v souboru AI.                   | Oprava chyby  |
...
** PSDJAVA-604. Soubor PSD se po převedení z 8 bitů na 16 bitů stal nečitelným**
...
{{< highlight java >}}
        ...
        try (PsdImage psdImage16 = (PsdImage) Image.load(outputFile)) {
            if (psdImage16.getGlobalLayerResources()[0] instanceof Lr16Resource) {
                ...
                throw new Exception("Špatný globální zdroj, první zdroj by měl být Lr16Resource");
            }
        }

{{< /highlight >}}

** PSDJAVA-605. Soubor PSD se po převedení z 8 bitů na 32 bitů stal nečitelným**
...
** PSDJAVA-606. [AI Formát] Oprava vykreslování krátké křivky v souboru AI**
