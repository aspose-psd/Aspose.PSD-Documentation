---
title: Aspose.PSD pro Java 24.8 - Poznámky k vydání
type: docs
weight: 40
url: /cs/java/aspose-psd-pro-java-24-8-poznamky-k-vydani/
---

{{% alert color="primary" %}} Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Klíč**     | **Shrnutí**                                                                                        | **Kategorie** |
|:------------|:---------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [AI Formát] Přidání zpracování XObject Groups                                                        | Vylepšení    |
| PSDJAVA-645 | Vylepšení možností transformace Warp přidáním WarpSettings pro TextLayer a SmartObjectLayer       | Funkce       |
| PSDJAVA-646 | [AI Formát] Zpracování vrstev v operátorech obsahu streamu                                           | Funkce       |
| PSDJAVA-647 | Výsledek vykreslení souboru AI je velmi odlišný ve srovnání s výsledky z Illustratoru              | Chyba        |
| PSDJAVA-648 | Přelinkování Smart Object se nevztahuje na všechny Smart Object v souboru PSD                       | Chyba        |
...
**PSDJAVA-645. Vylepšení možností transformace Warp přidáním WarpSettings pro TextLayer a SmartObjectLayer**
...
**PSDJAVA-646. [AI Formát] Zpracování vrstev v operátorech obsahu streamu**
...
**PSDJAVA-647. Výsledek vykreslení souboru AI je velmi odlišný ve srovnání s výsledky z Illustratoru**
...
**PSDJAVA-648. Přelinkování Smart Object se nevztahuje na všechny Smart Object v souboru PSD**
