---
title: Aspose.PSD pro Java 23.10 - Poznámky k vydání
type: docs
weight: 40
url: /cs/java/aspose-psd-pro-java-23-10-poznamky-k-vydani/
---

{{% alert color="primary" %}} Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro Java 23.10](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-pro-java-23.10/) {{% /alert %}}

| **Klíč**        | **Souhrn**                                                                             | **Kategorie** |
|:---------------|:----------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-538    | Podpora vertikálního směru textu                                                      |    Funkce   |
| PSDJAVA-542    | Použití nastavení kreslení z pod zdroje vstk ve vykreslování tvarového rysu           |    Funkce   |
| PSDJAVA-540    | Implementace vykreslování vnitřní oblasti tvarů rysování                              |    Funkce   |
| PSDJAVA-541    | Nerenderovat vrstvu tvaru, pokud nebyla změněna                                      |    Funkce   |
| PSDJAVA-545    | [AI formát] Přidání podpory pro čtení záhlaví z AI souborů založených na PDF          |    Funkce   |
| PSDJAVA-546    | Různé způsoby nastavení rozlišení souboru Psd nefungují                                |      Chyba     |
| PSDJAVA-547    | FontSettings.SetFontsFolders nefunguje nebo Aspose.PSD používá nesprávný font         |      Chyba     |
| PSDJAVA-548    | Regrese. Opravena chyba nulové reference při ukládání PsdImage s vrstvou tvaru       |      Chyba     |
...
** PSDJAVA-538. Podpora vertikálního směru textu**
...
** PSDJAVA-542. Použití nastavení kreslení z pod zdroje vstk ve vykreslování tvarového rysu**
