---
title: Aspose.PSD pro Javu 23.4 - Poznámky k vydání
type: docs
weight: 40
url: /cs/java/aspose-psd-pro-java-23-4-poznamky-k-vydani/
---

{{% alert color="primary" %}} Tato stránka obsahuje poznámky k vydání pro [Aspose.PSD pro Javu 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-pro-java-23.4/) {{% /alert %}}

|**Klíč**|**Souhrn**|**Kategorie**|
| :- | :- | :- |
|PSDJAVA-446|Port chybějící funkcionality z Aspose.PSD pro .Net do Aspose.PSD pro Javu|Vylepšení|
|PSDJAVA-441|Návrh třídy RawColor pro veřejné API k použití v API PSD místo zastaralé struktury Color|Vylepšení|
|PSDJAVA-418|Integrace moderní licence Aspose pro Aspose.PSD|Vylepšení|
|PSDJAVA-445|Formátování se posune při úpravě v photoshopu|Chyba|
|PSDJAVA-443|Úprava textu pomocí částí textu neukládá správný výsledek|Chyba|
|PSDJAVA-444|Začátek a konec stylů nebo odstavců se zobrazuje na nesprávném místě při úpravě vrstvy textu pomocí ITextPortion|Chyba|
|PSDJAVA-445|Formátování se posune při úpravě v photoshopu|Chyba|
