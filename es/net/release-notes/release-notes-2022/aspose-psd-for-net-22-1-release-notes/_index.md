---
title: Notas de Lanzamiento de Aspose.PSD for .NET 22.1
type: docs
weight: 120
url: /es/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}} 

Esta página contiene notas de lanzamiento para [Aspose.PSD for .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Clave**|**Resumen**|**Categoría**|
| :- | :- | :- |
|PSDNET-1017|La superposición de patrón solo se puede aplicar una vez|Error|
|PSDNET-1056|Desbordamiento de archivos temporales al abrir un archivo desde un flujo|Error|
|PSDNET-991|Optimización de renderización para filtro inteligente de desenfoque gaussiano|Característica|
|PSDNET-1044|Soporte de muchos datos de patrones en PattResource|Característica|
...
## **Ejemplos de Uso:**
**PSDNET-1017. La superposición de patrón solo se puede aplicar una vez**
{{< highlight csharp >}}
...
**PSDNET-1056. Desbordamiento de archivos temporales al abrir un archivo desde un flujo**
{{< highlight csharp >}}
...
**PSDNET-991. Optimización de renderización para filtro inteligente de desenfoque gaussiano**
{{< highlight csharp >}}
...
**PSDNET-1044. Soporte de muchos datos de patrones en PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("Lectura correcta de los elementos de PattResourceData.");
                }
