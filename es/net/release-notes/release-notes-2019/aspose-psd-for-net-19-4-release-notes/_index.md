---
title: Notas de lanzamiento de Aspose.PSD para .NET 19.4
type: docs
weight: 90
url: /es/net/aspose-psd-for-net-19-4-release-notes/
---

{{% alert color="primary" %}} 

Esta página contiene las notas de lanzamiento para Aspose.PSD para .NET 19.4

{{% /alert %}} 

|**Clave**|**Resumen**|**Categoría**|
| :- | :- | :- |
|PSDNET-87|Agregar función para cargar archivos de imagen JPEG/PNG/etc en PsdImage sin carga directa (lo cual no es compatible con Aspose.PSD)|Función|
|PSDNET-120|Soporte del modo de color RGB con 16 bits por canal (64 bits por color)|Función|
|PSDNET-108|Soporte de Máscaras de Vectores de Capa y Rotación Personalizada de Capa de Texto|Función|
|PSDNET-99|Todos los caracteres asiáticos no se renderizan correctamente|Error|
|PSDNET-116|Símbolos \r\n son interpretados como doble salto de línea lo cual es incorrecto|Error|
|PSDNET-117|Si una capa de texto se actualiza con una cadena que contiene saltos de línea, el archivo PSD se vuelve ilegible|Error|
|PSDNET-118|Si una capa de texto se actualiza con una cadena que contiene símbolos de tabulación, el procesamiento falla con una excepción|Error|
...
## **Ejemplos de uso:**
**PSDNET-87. Agregar función para cargar archivos de imagen JPEG/PNG/etc en PsdImage sin carga directa (lo cual no es compatible con Aspose.PSD)**
...
**PSDNET-120. Soporte del modo de color RGB con 16 bits por canal (64 bits por color)**

{{< highlight java >}}

  // Soporte del modo de color RGB con 16 bits por canal (64 bits por color)
...
// Los archivos deben abrirse sin excepciones y ser legibles para Photoshop    

using(Image image = Image.Load(outputFilePathPsd)) {}  

{{< /highlight >}}

**PSDNET-108. Soporte de Máscaras de Vectores de Capa y Rotación Personalizada de Capa de Texto**

{{< highlight java >}}

 // La operación de Rotación e Inversión no funciona como se espera con PSD
...
**PSDNET-99. Todos los caracteres asiáticos no se renderizan correctamente**

[**Por favor, revise el ejemplo adjunto**](attachments/86278147/86343681.cs)

**PSDNET-116. Símbolos \r\n son interpretados como doble salto de línea lo cual es incorrecto**
...
// El archivo debe abrirse sin excepciones y ser legible para Photoshop. Debe contener 3 saltos de línea, uno entre cada fila

using(Image image = Image.Load(exportPath)) {}

{{< /highlight >}}

**PSDNET-117. Si una capa de texto se actualiza con una cadena que contiene saltos de línea, el archivo PSD se vuelve ilegible**

{{< highlight java >}}

 // Si una capa de texto se actualiza con una cadena que contiene saltos de línea, el archivo PSD se vuelve ilegible.
...
**PSDNET-118. Si una capa de texto se actualiza con una cadena que contiene símbolos de tabulación, el procesamiento falla con una excepción**

{{< highlight java >}}

 // Si una capa de texto se actualiza con una cadena que contiene símbolos de tabulación, el procesamiento falla con una excepción
