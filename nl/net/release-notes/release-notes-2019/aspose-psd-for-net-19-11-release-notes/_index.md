---
title: Aspose.PSD voor .NET 19.11 - Release-opmerkingen
type: docs
weight: 20
url: /nl/net/aspose-psd-for-net-19-11-release-notes/
---

{{% alert color="primary" %}} 

Deze pagina bevat release-opmerkingen voor [Aspose.PSD voor .NET 19.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Sleutel**|**Samenvatting**|**Categorie**|
| :- | :- | :- |
|PSDNET-151|[Ondersteuning van Inner Shadow Layer Effect](/psd/nl/net/shadow-effects-in-photoshop/#shadoweffectsinphotoshop-innershadoweffect)|Functie|
|PSDNET-135|[Implementatie van het renderen van Fill Layer: Patroon](/psd/nl/net/support-of-fill-layers/#supportoffilllayers-filllayerswithpatternfill)|Functie|
|PSDNET-187|[Ondersteuning van Raster Afbeeldingen in AI Formaat Bestanden](/psd/nl/net/manipulating-adobe-illustrator-formats/#manipulatingadobeillustratorformats-rasterimagesinillustrator)|Functie|
|PSDNET-225|[Eigenschappen verkrijgen van inline opmaak van TextLayer](/psd/nl/net/working-with-text-layers/#workingwithtextlayers-gettextpropertiesfromatextlayer)|Functie|
|PSDNET-214|Onjuiste export van PSD naar andere formats als het Layer Effects en Adjustment Layers bevat|Fout|

## **Wijzigingen in publieke API**
# **Toegevoegde API's:**
...
## **Gebruik voorbeelden:**
**PSDNET-151. Ondersteuning van Inner Shadow Layer Effect**
...
{{< highlight java >}}
            ...
            // Laad een bestaande afbeelding in een instantie van PsdImage-klasse
...
**PSDNET-135. Implementatie van het renderen van Fill Layer: Patroon**
...
**PSDNET-187. Ondersteuning van Raster Afbeeldingen in AI Formaat Bestanden**
...
**PSDNET-225. Eigenschappen verkrijgen van inline opmaak van TextLayer**
     ...
     using (var psdImage = (PsdImage)Image.Load("inline_formatting.psd"))

            {
...

                {
                    ...
                    // krijg de lettertypen die in de tekstlaag zitten
...
**PSDNET-214. Onjuiste export van PSD naar andere formats als het Layer Effects en Adjustment Layers bevat**
