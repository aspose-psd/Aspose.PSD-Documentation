---
title: Aspose.PSD voor Java 23.4 - Release-opmerkingen
type: docs
weight: 40
url: /nl/java/aspose-psd-voor-java-23-4-release-opmerkingen/
---

{{% alert color="primary" %}} Deze pagina bevat de release-opmerkingen voor [Aspose.PSD voor Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) {{% /alert %}}

|**Key**|**Samenvatting**|**Categorie**|
| :- | :- | :- |
|PSDJAVA-446|Functionaliteit die ontbrak in Aspose.PSD voor .Net naar Aspose.PSD voor Java overzetten|Verbetering|
|PSDJAVA-441|Ontwerp van de RawColor-klasse voor de openbare API om deze te gebruiken in de PSD-API in plaats van de verouderde Color-structuur|Verbetering|
|PSDJAVA-418|Moderne Aspose Licentie integreren voor Aspose.PSD|Verbetering|
|PSDJAVA-445|Opmaak wijzigt bij bewerking in photoshop|Fout|
|PSDJAVA-443|Bewerken van tekst met behulp van Tekstgedeelten slaat niet het juiste resultaat op|Fout|
|PSDJAVA-444|Het begin en einde van stijlen of alinea's verschijnen op de verkeerde plaats bij het bewerken van een Tekstlaag door ITextPortion|Fout|
...
# **Verwijderde API's:**
- M:com.aspose.psd.FontSettings.addFontsFolder(java.lang.String**Vervolg toegevoegde API's:**
