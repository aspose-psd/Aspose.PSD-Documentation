---
title: Aspose.PSD voor Java 20.2 - Release-opmerkingen
type: docs
weight: 20
url: /nl/java/aspose-psd-voor-java-20-2-release-opmerkingen/
---

{{% alert color="primary" %}} Deze pagina bevat release-opmerkingen voor [Aspose.PSD voor Java 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) {{% /alert %}} 

|**Trefwoord**|**Samenvatting**|**Categorie**|
| :- | :- | :- |
|PSDJAVA-96|Verbetering van de mogelijkheid om tekst in Text Layer in verschillende kleuren weer te geven|Functie|
|PSDJAVA-97|Ondersteuning van clbl-bron (laagbron met informatie over Blend-clipelementen)|Functie|
|PSDJAVA-100|Ondersteuning van blwh-bron (Bron bevat gegevens van Black & White Adjustment Layer)|Functie|
|PSDJAVA-101|Mogelijkheid om Layer Group te exporteren naar Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf|Functie|
|PSDJAVA-105|Ondersteuning van lspf-bron (Bevat instellingen over Layer Protected instelling)|Functie|
|PSDJAVA-106|Ondersteuning van infx-bron (Bevat gegevens over Blenden van interne elementen)|Functie|
|PSDJAVA-99|Refactor van PsdImage en Layer om Transformation-gedrag te wijzigen (Correcte vergroting/rotatie/bijsnijding voor laagmaskers als we een laag afzonderlijk transformeren)|Verbetering|
|PSDJAVA-98|In sommige globalisatie-instellingen kan AI-afbeeldingsrasterafbeelding niet worden geopend|Fout|
|PSDJAVA-102|Na het uitvoeren van de FlipRotate-operatie op Layer wordt de PSD-afbeelding onleesbaar|Fout|
|PSDJAVA-103|System.ArgumentException tijdens het laden van PSD-bestand|Fout|
|PSDJAVA-104|Na gebruik van een transformatiemethode voor slechts één laag heeft de opgeslagen laag onjuiste grenzen of een masker|Fout|

# **Publieke API-wijzigingen**
# **Deze API is tijdelijk uitgeschakeld en wordt ingeschakeld in de volgende release:**
...
` `**Gebruik in de tussentijd v19.4 als u een geschikte afhankelijkheid heeft.**
# **Toegevoegde API's:**
...
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.getTintColorBlue
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.getTintColorGreen
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.getTintColorRed
...
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.setTintColorBlue(double)
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.setTintColorGreen(double)
- M:com.aspose.psd.fileformats.psd.layers.layerresources.BlwhResource.setTintColorRed(double)
