---
title: Aspose.PSD voor Java 24.2 - Release-opmerkingen
type: docs
weight: 40
url: /nl/java/aspose-psd-for-java-24-2-release-notes/
---

{{% alert color="primary" %}} Deze pagina bevat release-opmerkingen voor [Aspose.PSD voor Java 24.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.2/) {{% /alert %}}

| **Sleutel**  | **Samenvatting**                                                               | **Categorie** |
|:------------|:------------------------------------------------------------------------------|:-------------|
| PSDJAVA-584 | Behandel hoek eigenschap voor PatternFillSettings.                              | Functie      |
| PSDJAVA-585 | Ondersteuning van verticale en horizontale schaal voor TextLayer.               | Functie      |
| PSDJAVA-589 | [AI-formaat] Implementeer correcte weergave van achtergrond in op PDF-Gebaseerd AI-formaat. | Functie      |
| PSDJAVA-590 | Verander vervormingsmechanisme in warp.                                         | Verbetering  |
| PSDJAVA-591 | Versnel warps.                                                                 | Verbetering  |
| PSDJAVA-592 | "Afbeeldingsladen mislukt." uitzondering bij openen van document.                 | Fout          |
| PSDJAVA-593 | Repareer het opslaan van psd-bestanden met Stroke-patroon.                        | Fout          |
| PSDJAVA-594 | De tekststijl is incorrect in een slim object bij gebruik van ReplaceContents.   | Fout          |
| PSDJAVA-595 | [AI-formaat] Repareer de Kubische Bezier-rendering bij AI-bestand.               | Fout          |
...
**PSDJAVA-584. Behandel hoek eigenschap voor PatternFillSettings**
...
**PSDJAVA-585. Ondersteuning van verticale en horizontale schaal voor TextLayer**
...
**PSDJAVA-589. [AI-formaat] Implementeer correcte weergave van achtergrond in op PDF-Gebaseerd AI-formaat**
...
**PSDJAVA-590. Verander vervormingsmechanisme in warp**
...
{{< highlight java >}}
        ...
        if (timeInSec > 100000) {
            throw new RuntimeException("Procestijd is te lang");
        }

{{< /highlight >}}

**PSDJAVA-592. "Afbeeldingsladen mislukt." uitzondering bij openen van document**
...
**PSDJAVA-593. Repareer het opslaan van psd-bestanden met Stroke-patroon**
...
**PSDJAVA-594. De tekststijl is incorrect in een slim object bij het gebruik van ReplaceContents**

{{< highlight java >}}

        String invoerbestand = "src/main/resources/source.psd";
        String uitvoer2 = "src/main/resources/output.png";

        PsdLoadOptions psdLoadOptions = new PsdLoadOptions();
        psdLoadOptions.setLoadEffectsResource(true);

        try (PsdImage psdImage = (PsdImage) Image.load(invoerbestand, psdLoadOptions)) {
            ...
            psdImage.save(uitvoer2, pngOptions);
        }

{{< /highlight >}}

**PSDJAVA-595. [AI-formaat] Repareer de Kubische Bezier-rendering in AI-bestand**
