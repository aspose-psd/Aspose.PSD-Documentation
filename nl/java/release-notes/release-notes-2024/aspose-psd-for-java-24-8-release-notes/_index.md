---
title: Aspose.PSD voor Java 24.8 - Uitgaveopmerkingen
type: docs
weight: 40
url: /nl/java/aspose-psd-voor-java-24-8-release-notes/
---

{{% alert color="primary" %}} Deze pagina bevat uitgaveopmerkingen voor [Aspose.PSD voor Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Sleutel**  | **Samenvatting**                                                                                 | **Categorie** |
|:------------|:--------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [AI-formaat] Toevoegen van verwerking voor XObject-groepen                                           | Verbetering  |
| PSDJAVA-645 | Uitbreiden van Warp-transformatiemogelijkheden door WarpSettings toe te voegen voor TextLayer en SmartObjectLayer | Functie      |
| PSDJAVA-646 | [AI-formaat] Behandelen van lagen in operators van inhoudsstroom                                     | Functie      |
| PSDJAVA-647 | Rendert resultaat van AI-bestand is zeer verschillend in vergelijking met Illustrator resultaten     | Fout         |
| PSDJAVA-648 | Opnieuw koppelen van Slim Object wordt niet toegepast op alle Slimme Objecten in PSD-bestand       | Fout         |
...
**PSDJAVA-645. Uitbreiden van Warp-transformatiemogelijkheden door WarpSettings toe te voegen voor TextLayer en SmartObjectLayer**
...
**PSDJAVA-646. [AI-formaat] Lagen behandelen in operators van inhoudsstroom**
...
**PSDJAVA-647. Rendert resultaat van AI-bestand is zeer verschillend in vergelijking met Illustrator resultaten**
...
**PSDJAVA-648. Opnieuw koppelen van Slim Object wordt niet toegepast op alle Slimme Objecten in PSD-bestand**
