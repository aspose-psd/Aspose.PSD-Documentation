---
title: Aspose.PSD สำหรับ .NET 19.6 - บันทึกการอัปเดต
type: สื่อ
weight: 70
url: /th/net/aspose-psd-for-net-19-6-release-notes/
---

{{% alert color="primary" %}} 

หน้านี้มีบันทึกการอัปเดตสำหรับ [Aspose.PSD สำหรับ .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Key**|**สรุป**|**หมวดหมู่**|
| :- | :- | :- |
|PSDNET-127|ความสามารถในการแปลงไฟล์ PSD เป็น PSB และ PSB เป็น PSD|คุณลักษณะ|
|PSDNET-154|การโยกย้ายของแหล่งกำเนิด Aspose.Imaging 19.5 ไป Aspose.PSD|การพัฒนา|
|PSDNET-155|ล้าง API สาธารณะที่เกี่ยวกับ Aspose.PSD|การพัฒนา|
|PSDNET-159|เอาคุณสมบัติ IsLicensed ออก|การพัฒนา|
|PSDNET-102|การแปลง PSB เป็น JPG ถือจอด|ข้อบกพร่อง|
|PSDNET-150|ตำแหน่งเลเยอร์ข้อความที่เพิ่มเข้ามาใหม่มีการเปลี่ยนที่ตำแหน่งเมื่อแก้ไขใน Photoshop|ข้อบกพร่อง|
...
- M:Aspose.PSD.FileFormats.Gif.Blocks.GifUnknownExtensionBlock.#