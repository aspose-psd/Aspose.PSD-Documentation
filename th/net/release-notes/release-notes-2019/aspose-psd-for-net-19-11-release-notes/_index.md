---
title: บันทึกการอัปเดต Aspose.PSD for .NET 19.11
type: มันส์
weight: 20
url: /th/net/aspose-psd-for-net-19-11-release-notes/
---

{{% alert color="primary" %}} 

หน้านี้มีบันทึกการอัปเดตสำหรับ [Aspose.PSD for .NET 19.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Key**|**สรุป**|**หมวดหมู่**|
| :- | :- | :- |
|PSDNET-151|[การสนับสนุน Inner Shadow Layer Effect](/psd/th/net/shadow-effects-in-photoshop/#shadoweffectsinphotoshop-innershadoweffect)|คุณลักษณะ|
|PSDNET-135|[การนำเสนอการเรนเดอร์ Fill Layer: Pattern](/psd/th/net/support-of-fill-layers/#supportoffilllayers-filllayerswithpatternfill)|คุณลักษณะ|
|PSDNET-187|[การสนับสนุนภาพเราะและในไฟล์รูปแบบ AI](/psd/th/net/manipulating-adobe-illustrator-formats/#manipulatingadobeillustratorformats-rasterimagesinillustrator)|คุณลักษณะ|
|PSDNET-225|[รับคุณสมบัติของการจัดรูปแบบใน TextLayer](/psd/th/net/working-with-text-layers/#workingwithtextlayers-gettextpropertiesfromatextlayer)|คุณลักษณะ|
|PSDNET-214|การส่งออก PSD ผิดพลาดไปยังรูปแบบอื่น ๆ หากมีเอฟเฟกต์เลเยอร์และเลเยอร์การปรับเเลื่อน|บั๊ก|
...
## **ตัวอย่างการใช้:**
**PSDNET-151. การสนับสนุน Inner Shadow Layer Effect**
...
**PSDNET-135. การนำเสนอการเรนเดอร์ Fill Layer: Pattern**
...
**PSDNET-187. การสนับสนุนภาพเราะและในไฟล์รูปแบบ AI**
...
**PSDNET-225. รับคุณสมบัติของการจัดรูปแบบใน TextLayer**
...
**PSDNET-214. การส่งออก PSD ผิดพลาดไปยังรูปแบบอื่น ๆ หากมีเอฟเฟกต์เลเยอร์และเลเยอร์การปรับเเลื่อน**
