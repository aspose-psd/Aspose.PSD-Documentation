---
title: บันทึกการออก Aspose.PSD สำหรับ .NET 22.1
type: เอกสาร
weight: 120
url: /th/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}} 

หน้านี้ประกอบด้วยบันทึกการออก Aspose.PSD สำหรับ .NET 22.1(https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**คีย์**|**สรุป**|**หมวดหมู่**|
| :- | :- | :- |
|PSDNET-1017|PatternOverlay สามารถใช้ได้เพียงครั้งเดียว|ข้อบกพร่อง|
|PSDNET-1056|ไฟล์ชั่วคราวเกินขนาดเมื่อเปิดไฟล์จากสตรีม|ข้อบกพร่อง|
|PSDNET-991|การปรับปรุงการเรนเดอร์สำหรับตัวกรองอัจฉริยะ Gaussian blur|คุณสมบัติ|
|PSDNET-1044|การสนับสนุนข้อมูลรูปแบบมากมายที่ PattResource|คุณสมบัติ|


## **การเปลี่ยนแปลงทาง API สาธาณะ**
# **API เพิ่มเติม:**
...
## **ตัวอย่างการใช้:**
**PSDNET-1017. PatternOverlay สามารถใช้ได้เพียงครั้งเดียว**
{{< highlight csharp >}}
...
**PSDNET-1056. ไฟล์ชั่วคราวเกินขนาดเมื่อเปิดไฟล์จากสตรีม**
{{< highlight csharp >}}
...
**PSDNET-991. การปรับปรุงการเรนเดอร์สำหรับตัวกรองอัจฉริยะ Gaussian blur**
{{< highlight csharp >}}
...
**PSDNET-1044. การสนับสนุนข้อมูลรูปแบบมากมายที่ PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("การอ่านรายการ PattResourceData ถูกต้อง");
                }
