---
title: บันทึกการเปลี่ยนแปลง Aspose.PSD for .NET 23.10
type: สำหรับเอกสาร
weight: 30
url: /th/net/aspose-psd-for-net-23-10-release-notes/
---

{{% alert color="primary" %}}

หน้านี้มีบันทึกการเปลี่ยนแปลงสำหรับ [Aspose.PSD for .NET 23.10](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **คีย์**     | **สรุป**                                                                                                                | **หมวดหมู่** |
|:------------|:------------------------------------------------------------------------|:--------|
| PSDNET-692 | รองรับการทำงานในทิศทางข้อความแนวตั้ง | คุณลักษณะ |
| PSDNET-1402 | ใช้การตั้งค่าที่เซ็ตจากทรัพยากร vstk ในการตัดรูปร่างรายการ | คุณลักษณะ |
| PSDNET-1607 | การนำเสนอการเข้ารหัสของพื้นที่ภายในของรูปร่าง Stroke | คุณลักษณะ |
| PSDNET-1644 | ไม่ต้องวาดรูปร่าง Shape หากมันไม่เปลี่ยนแปลง | คุณลักษณะ |
| PSDNET-1696 | [รูปแบบ AI] เพิ่มการสนับสนุนในการอ่านแถวหัวจากไฟล์ AI ที่มีเส้น PDF | คุณลักษณะ |
| PSDNET-1560 | วิธีต่าง ๆ ในการตั้งค่าความละเอียดของไฟล์ Psd ไม่ทำงาน | ข้อผิดพลาด |
| PSDNET-1728 | FontSettings.SetFontsFolders ไม่ทำงานหรือ Aspose.PSD ใช้แบบอักษรที่ไม่ถูกต้อง | ข้อผิดพลาด |
| PSDNET-1739 | การถดถอย แก้ปัญหาส่งออก Null reference ขึ้นเมื่อมี Shape layer | ข้อผิดพลาด |
...
**PSDNET-692. รองรับการทำงานในทิศทางข้อความแนวตั้ง**
...
**PSDNET-1402. ใช้การตั้งค่าที่เซ็ตจากทรัพยากร vstk ในการตัดรูปร่างรายการ**
...
**PSDNET-1607. การนำเสนอการเข้ารหัสของพื้นที่ภายในของรูปร่าง Stroke**
...
**PSDNET-1644. ไม่ต้องวาดรูปร่าง Shape หากมันไม่เปลี่ยนแปลง**
...
using (PsdImage image = (PsdImage)Image.Load(sourceFile))
{
    ...
    // อย่าใช้การอัปเดตของ Shape layer ก่อนการบันทึก
...
// ตรวจสอบว่าข้อมูลของรูปร่าง layer ยังคงเหมือนเดิม
using (PsdImage image = (PsdImage)Image.Load(outputFile))
{
    ShapeLayer shapeLayer = (ShapeLayer)image.Layers[1];
    ColorFillSettings fillSettings = (ColorFillSettings)shapeLayer.Fill;
...
**PSDNET-1696. [รูปแบบ AI] เพิ่มการสนับสนุนในการอ่านแถวหัวจากไฟล์ AI ที่มีเส้น PDF**
...
**PSDNET-1560. วิธีต่าง ๆ ในการตั้งค่าความละเอียดของไฟล์ Psd ไม่ทำงาน**
...
**PSDNET-1728. FontSettings.SetFontsFolders ไม่ทำงานหรือ Aspose.PSD ใช้แบบอักษรที่ไม่ถูกต้อง**
