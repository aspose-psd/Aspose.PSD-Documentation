---
title: Aspose.PSD for Java 24.6 - บันทึกการอัปเดต
type: docs
weight: 40
url: /th/java/aspose-psd-for-java-24-6-release-notes/
---

{{% alert color="primary" %}} หน้านี้ประกอบด้วยบันทึกการอัปเดตสำหรับ [Aspose.PSD for Java 24.6](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.6/) {{% /alert %}}

| **Key**     | **รายละเอียด**                                                                                                      | **หมวดหมู่** |
|:------------|:-----------------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-628 | ปรับปรุงการสนับสนุนชั้น Gradient map                                                                          | คุณลักษณะ   |
| PSDJAVA-629 | [รูปแบบ AI] เพิ่มการสนับสนุนเอกสาร XPacket Metadata สำหรับรูปแบบ AI                                           | คุณลักษณะ   |
| PSDJAVA-630 | ปรับปรุง Inflate, Squeeze, และ Twist ประเภทของการทำงอ                                                                   | คุณลักษณะ   |
| PSDJAVA-631 | โหมด Rgb และ Lab ไม่สามารถมีช่องน้อยกว่า 3 และมากกว่า 4 ในไฟล์ที่มีชั้น ArtBoard Layers | ข้อผิดพลาด   |
| PSDJAVA-632 | พื้นที่ประมวลผลด้านบนต้องเป็นบวก (ตัวแปร 'areaToProcess') ในการประมวลผลของไฟล์ที่เฉพาะเจาะจง         | ข้อผิดพลาด   |
| PSDJAVA-633 | รูปที่ขยายตัวเกินขอบแคนวาสถูกตัดทอดหลังจากการบันทึก ข้อมูลหายไป แต่ภาพตัวอย่างดูถูกต้อง               | ข้อผิดพลาด   |
...
**PSDJAVA-628. ปรับปรุงการสนับสนุนชั้น Gradient map**
...
**PSDJAVA-629. [รูปแบบ AI] เพิ่มการสนับสนุนเอกสาร XPacket Metadata สำหรับรูปแบบ AI**
...
**PSDJAVA-630. ปรับปรุง Inflate, Squeeze, และ Twist ประเภทของการทำงอ**
...
**PSDJAVA-631. โหมด Rgb และ Lab ไม่สามารถมีช่องน้อยกว่า 3 และมากกว่า 4 ในไฟล์ที่มีชั้น ArtBoard Layers**
...
**PSDJAVA-632. พื้นที่ประมวลผลด้านบนต้องเป็นบวก (ตัวแปร 'areaToProcess') ในการประมวลผลของไฟล์ที่เฉพาะเจาะจง**
...
**PSDJAVA-633. รูปที่ขยายตัวเกินขอบแคนวาสถูกตัดทอดหลังจากการบันทึก ข้อมูลหายไป แต่ภาพตัวอย่างดูถูกต้อง**
