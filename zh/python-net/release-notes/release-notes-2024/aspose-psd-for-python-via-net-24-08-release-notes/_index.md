---
title: Aspose.PSD for Python via .NET 24.8 - 发布说明
type: 文档
weight: 10
url: /zh/python-net/aspose-psd-for-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

本页面包含 [Aspose.PSD for Python via .NET 24.8](https://pypi.org/project/aspose-psd/) 的发布说明

{{% /alert %}}

| **关键**      | **摘要**                                                                                                       | **类别** |
|:-------------|:------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [AI 格式] 添加对 XObject 组的处理                                                        | 增强  |
| PSDPYTHON-82 | 通过为 TextLayer 和 SmartObjectLayer 添加 WarpSettings 来增强 Warp 转换功能 | 特性      |
| PSDPYTHON-83 | [AI 格式] 处理内容流操作符中的图层                                             | 特性      |
| PSDPYTHON-84 | AI 文件的渲染结果与 Illustrator 结果相比非常不同               | 错误          |
| PSDPYTHON-85 | 重新链接智能对象不适用于 PSD 文件中的所有智能对象             | 错误          |
...
**PSDPYTHON-81. [AI 格式] 添加对 XObject 组的处理**
{{< highlight python >}}
# 无示例。这是一个内部改进
{{< /highlight >}}

**PSDPYTHON-82. 通过为 TextLayer 和 SmartObjectLayer 添加 WarpSettings 来增强 Warp 转换功能**
{{< highlight python >}}
...
**PSDPYTHON-83. [AI 格式] 处理内容流操作符中的图层**
{{< highlight python >}}
...
**PSDPYTHON-84. AI 文件的渲染结果与 Illustrator 结果相比非常不同**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. 重新链接智能对象不适用于 PSD 文件中的所有智能对象**
{{< highlight python >}}
