---
title: Aspose.PSD for Java 21.5 - 发布说明
type: docs
weight: 40
url: /zh/java/aspose-psd-for-java-21-5-release-notes/
---

{{% alert color="primary" %}} 本页面包含 [Aspose.PSD for Java 21.5](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-21.5/) 的发布说明 {{% /alert %}}

{{% alert color="info" %}}
这是 Aspose.PSD for Java 的中间版本。它有一些已知问题。因此，如果您需要稳定版本，请使用 [Aspose.PSD 20.9](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.9/)，直到 Aspose.PSD 21.6 发布为止。此版本包含自 20.9 以来的所有 Aspose.PSD .Net 功能（包括智能对象）以及下面列出的功能。
{{% /alert %}}

|**关键**|**摘要**|**类别**|
| :- | :- | :- |
|PSDJAVA-340|仅调整图层大小时支持带有向量路径的形状图层调整大小|功能|
|PSDJAVA-341|支持调整带有向量路径的形状图层大小|功能|
|PSDJAVA-342|截断文本字符串|错误|
...
- F:com.aspose.psd.asynctask.AsyncTask