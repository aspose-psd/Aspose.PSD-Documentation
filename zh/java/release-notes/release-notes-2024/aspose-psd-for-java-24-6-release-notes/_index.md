---
title: Aspose.PSD for Java 24.6 - 发布说明
type: docs
weight: 40
url: /zh/java/aspose-psd-for-java-24-6-release-notes/
---

{{% alert color="primary" %}} 本页面包含 [Aspose.PSD for Java 24.6](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.6/) 的发布说明 {{% /alert %}}

| **关键字**   | **摘要**                                                                                                      | **类别**  |
|:------------|:-----------------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-628 | 实现渐变地图图层的支持                                                                          | 功能      |
| PSDJAVA-629 | [AI格式] 添加对AI格式的XPacket元数据支持                                                         | 功能      |
| PSDJAVA-630 | 实现Inflate, Squeeze和Twist类型的扭曲                                                              | 功能      |
| PSDJAVA-631 | 文件中的Rgb和Lab模式在包含ArtBoard图层的文件中不能包含少于3个通道和多于4个通道 | 错误         |
| PSDJAVA-632 | 处理区域的顶部必须为正数。在处理特定文件时的（'areaToProcess'参数）         | 错误         |
| PSDJAVA-633 | 保存后画布图像被裁剪。数据丢失，但预览看起来正确                                               | 错误         |
...
**PSDJAVA-629. [AI格式] 添加对AI格式的XPacket元数据支持**
...
**PSDJAVA-630. 实现Inflate、Squeeze和Twist类型的扭曲**
...
**PSDJAVA-631. Rgb和Lab模式在包含ArtBoard图层的文件中不能包含少于3个通道和多于4个通道**
...
**PSDJAVA-632. 处理区域的顶部必须为正数。在处理特定文件时的（'areaToProcess'参数）**
...
**PSDJAVA-633. 扩展到画布图像保存后被裁剪。数据丢失，但预览看起来正确**
