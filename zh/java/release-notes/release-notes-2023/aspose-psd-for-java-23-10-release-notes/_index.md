---
title: Aspose.PSD for Java 23.10 - 发布说明
type: docs
weight: 40
url: /zh/java/aspose-psd-for-java-23-10-release-notes/
---

{{% alert color="primary" %}} 本页面包含 [Aspose.PSD for Java 23.10](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.10/) 的发布说明 {{% /alert %}}

| **关键**        | **摘要**                                                                             | **类别** |
|:--------------|:-------------------------------------------------------------------------------------|:---------|
| PSDJAVA-538    | 支持竖向文本方向                                                                      |    功能   |
| PSDJAVA-542    | 使用来自 vstk 资源的描边设置绘制形状描边                                              |    功能   |
| PSDJAVA-540    | 实现描边形状内部区域的渲染                                                            |    功能   |
| PSDJAVA-541    | 如果形状图层未更改，则无需重绘形状图层                                               |    功能   |
| PSDJAVA-545    | [AI 格式] 添加对从基于 PDF 的 AI 文件读取标题的支持                                    |    功能   |
| PSDJAVA-546    | 设置 Psd 文件分辨率的各种方式不起作用                                                  |      错误 |
| PSDJAVA-547    | FontSettings.SetFontsFolders 不起作用或 Aspose.PSD 使用不正确的字体                     |      错误 |
| PSDJAVA-548    | 回归。当具有形状图层时，在 PsdImage.Save 时引发空引用异常                              |      错误 |
