---
title: Aspose.PSD for Java 23.11 - 发行说明
type: docs
weight: 40
url: /zh/java/aspose-psd-for-java-23-11-release-notes/
---

{{% alert color="primary" %}} 本页包含了 [Aspose.PSD for Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) 的发行说明 {{% /alert %}}

| **关键**       | **摘要**                                                                                           | **类别**    |
|:---------------|:----------------------------------------------------------------------------------------------------|:------------|
| PSDJAVA-551    | Support of LMskResource （LMskResource 支持）                                                       |    功能     |
| PSDJAVA-552    | [AI 格式] 增加渲染具有 Aspose.PSD 的基于 PDF 的 AI 文件的能力                                     |    功能     |
| PSDJAVA-553    | [AI 格式] 增加对“cm” PostScript 运算符的支持                                                     |    功能     |
| PSDJAVA-554    | 增加新的扭曲类型：Wave、shell up、shell down                                                      |    功能     |
| PSDJAVA-555    | 增加垂直扭曲支持                                                                                  |    功能     |
| PSDJAVA-556    | 调用 TextLayer.GetFonts() 时出现 System.ArgumentNullException: ‘Value cannot be null. (Parameter ‘key’)’  |    错误    |
...
**PSDJAVA-552. [AI 格式] 增加渲染 PDF-Based AI 文件的能力**
...
**PSDJAVA-553. [AI 格式] 增加对“cm” PostScript 运算符的支持**
...
**PSDJAVA-554. 增加新的扭曲类型：Wave、shell up、shell down**
...
**PSDJAVA-556. 调用 TextLayer.GetFonts() 时出现 System.ArgumentNullException: 'Value cannot be null. (Parameter 'key')'**
