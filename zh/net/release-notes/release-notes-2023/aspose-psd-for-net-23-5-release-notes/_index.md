---
title: Aspose.PSD for .NET 23.5 - 发行说明
type: docs
weight: 80
url: /zh/net/aspose-psd-for-net-23-5-release-notes/
---

{{% alert color="primary" %}}

本页面包含 [Aspose.PSD for .NET 23.5](https://www.nuget.org/packages/Aspose.PSD/) 的发行说明

{{% /alert %}}

| **关键字**  | **摘要**                                                                | **分类** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDNET-343  | 支持过滤器: 锐化 -> 锐化                                      | 功能      |
| PSDNET-1179 | PSD 文件 (RGB/8位或RGB/16位) 无图层保存为32位            | 功能      |
| PSDNET-1408 | 从 vsms 或 vmsk 资源中处理路径对象以用于 ShapeLayer | 功能      |
| PSDNET-1508 | 增加网格点对彼此的影响                                  | 功能      |
...
**PSDNET-1179. PSD 文件 (RGB/8位或RGB/16位) 无图层保存为32位**
...
**PSDNET-1408. 从 vsms 或 vmsk 资源中处理路径对象以用于 ShapeLayer**
