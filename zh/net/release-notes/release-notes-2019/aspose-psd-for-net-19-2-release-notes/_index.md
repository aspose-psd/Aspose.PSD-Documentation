---
title: Aspose.PSD for .NET 19.2 - 发行说明
type: docs
weight: 110
url: /zh/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

该页面包含了Aspose.PSD for .NET 19.2的发行说明

{{% /alert %}} 

|**关键**|**摘要**|**类别**|
| :- | :- | :- |
|PSDNET-97|添加对填充图层的支持：颜色填充|功能|
|PSDNET-98|添加对填充图层的支持：渐变填充|功能|
|PSDNET-105|支持GdFlResource|功能|
|PSDNET-106|支持VmskResource|功能|
|PSDNET-109|将实际Aspose.Imaging源码迁移到Aspose.PSD|增强|
|PSDNET-92|为部分方法添加部分加载支持|增强|
|PSDNET-110|PSD性能下降了数倍|错误|
