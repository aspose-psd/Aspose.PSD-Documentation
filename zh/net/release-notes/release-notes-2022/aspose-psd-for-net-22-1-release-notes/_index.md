---
title: Aspose.PSD for .NET 22.1 - 发行说明
type: docs
weight: 120
url: /zh/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}}

此页面包含了 [Aspose.PSD for .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/) 的发行说明。

{{% /alert %}}

|**关键**|**摘要**|**类别**|
| :- | :- | :- |
|PSDNET-1017|只能应用一次PatternOverlay|错误|
|PSDNET-1056|从流中打开文件时临时文件溢出|错误|
|PSDNET-991|高斯模糊智能滤镜的渲染优化|功能|
|PSDNET-1044|在PattResource中支持多个图案数据|功能|
...
## **使用示例:**
**PSDNET-1017. 只能一次应用 PatternOverlay**
{{< highlight csharp >}}
...
**PSDNET-1044. 在PattResource中支持多个图案数据**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("正确读取了PattResourceData项。");
                }
