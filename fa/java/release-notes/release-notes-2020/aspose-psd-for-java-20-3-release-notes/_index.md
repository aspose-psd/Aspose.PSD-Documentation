---
title: Aspose.PSD برای جاوا 20.3 - یادداشت های انتشار
type: docs
weight: 10
url: /fa/java/aspose-psd-for-java-20-3-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل یادداشت های انتشار برای [Aspose.PSD برای جاوا 20.3](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) است. {{% /alert %}} 

|**کلید**|**خلاصه**|**دسته**|
| :- | :- | :- |
|PSDJAVA-133|تبدیل فایل های Adobe Illustrator به PDF|قابلیت|
|PSDJAVA-134|افزودن قابلیت رندر کردن استایل های مختلف در یک لایه متن|قابلیت|
|PSDJAVA-135|پشتیبانی از لایه تنظیم سیاه و سفید|قابلیت|
|PSDJAVA-137|افزودن پشتیبانی از صدور فرمت AI (نسخه 8) به فرمت های دیگر|قابلیت|
|PSDJAVA-138|پشتیبانی از پردازش حالت ادغام PassThrough (تنها برای گروه لایه) |قابلیت|
|PSDJAVA-136|استثنا: خطای بارگذاری تصویر در هنگام بارگذاری تصویر با منابع نام یونیکد خالی|خطا|
|PSDJAVA-139|خروجی نادرست پس از تغییر دید لایه گروه|خطا|
|PSDJAVA-140|استثنا در هنگام بارگذاری تصویر PSD: بخش رنگ (منبع سایه ریختن) باید شامل 3 جزء رنگ برای RGB و 4 جزء رنگ برای CMYK باشد|خطا|
|PSDJAVA-141|استثنا اگر سعی شود برای نقاشی روی لایه ای که به تازگی ایجاد شده است از نسخه ساده سازنده استفاده شود|خطا|
# **تغییرات API عمومی**
# **API های اضافه شده:**
...
# **مثال های استفاده:**
**PSDJAVA-133. تبدیل فایل های Adobe Illustrator به PDF**
...
**PSDJAVA-134. افزودن قابلیت رندر کردن استایل های مختلف در یک لایه متن**
...
**PSDJAVA-135. پشتیبانی از لایه تنظیم سیاه و سفید**

{{< highlight java >}}

 // مثال از پشتیبانی از افزودن لایه تنظیم سیاه و سفید به صورت زمان اجرا.
...
// مثال از پشتیبانی از لایه تنظیم سیاه و سفید.
...
**PSDJAVA-137. افزودن پشتیبانی از صادرات فرمت AI (نسخه 8) به سایر فرمت ها**

{{< highlight java >}}

 // مثال از صادر کردن فایل AI به فرمت PSD و PNG
...
**PSDJAVA-138. پشتیبانی از پردازش حالت ادغام PassThrough (تنها برای گروه لایه)**
...
**PSDJAVA-136. استثنا: خطای بارگذاری تصویر در هنگام بارگذاری تصویر با منابع نام یونیکد خالی**
...

{
    ...
    // در اینجا نباید هیچ استثنا ای دریافت کنیم
...
**PSDJAVA-139. خروجی نادرست پس از تغییر دید لایه گروه**
...
// تغییر نام های لایه ها و ذخیره آن
...

{
...

    {
        ...
        // خاموش کردن همه چیز درون یک گروه
...
**PSDJAVA-140. استثنا در هنگام بارگذاری تصویر PSD: بخش رنگ (منبع سایه ریختن) باید شامل 3 جزء رنگ برای RGB و 4 جزء رنگ برای CMYK باشد**
...
**PSDJAVA-141. استثنا اگر سعی شود برای نقاشی روی لایه ای که به تازگی ایجاد شده است از نسخه ساده سازنده استفاده شود**
