---
title: Aspose.PSD برای جاوا 19.4 - یادداشت های نسخه
type: docs
weight: 20
url: /fa/java/aspose-psd-for-java-19-4-release-notes/
---

{{% alert color="primary" %}} 

این صفحه شامل یادداشت های انتشار Aspose.PSD برای جاوا 19.4 می باشد

{{% /alert %}} 

|**کلید**|**خلاصه**|**دسته**|
| :- | :- | :- |
|PSDJAVA-1|ایجاد ویژگی بارگذاری فایل‌های تصویری JPEG/PNG و غیره به تصویر Psd بدون بارگذاری مستقیم(که توسط Aspose.PSD پشتیبانی نمی شود)|ویژگی|
|PSDJAVA-2|پشتیبانی از حالت رنگی RGB با 16 بیت برای هر کانال (64 بیت برای هر رنگ)|ویژگی|
|PSDJAVA-3|پشتیبانی از ماسک های بردار لایه و چرخش و سفر های سفارشی لایه متن|ویژگی|
|PSDJAVA-4|تمامی حروف آسیایی به درستی پردازش نمی‌شوند|خطا|
|PSDJAVA-5|نمادهای \r\n به صورت اشتباه به عنوان دو خط جداگانه تفسیر می‌شوند|خطا|
|PSDJAVA-6|اگر لایه متن با رشته‌ای که حاوی شکست خط است به روز شود، فایل PSD قابل خواندن نخواهد بود|خطا|
|PSDJAVA-7|اگر لایه متن با رشته‌ای که حاوی نمادهای تب باشد به روز شود، پردازش با خطا مواجه می‌شود|خطا|
# **تغییرات API عمومی**
# **API های اضافه شده:**
...
**PSDJAVA-1. ایجاد ویژگی بارگذاری فایل‌های تصویری JPEG/PNG و غیره به تصویر Psd بدون بارگذاری مستقیم(که توسط Aspose.PSD پشتیبانی نمی شود)**
...
**PSDJAVA-2. پشتیبانی از حالت رنگی RGB با 16 بیت برای هر کانال (64 بیت برای هر رنگ)**

{{< highlight java >}}

  // پشتیبانی از حالت رنگی RGB با 16 بیت برای هر کانال (64 بیت برای هر رنگ)
    ...
    // فایل‌ها باید بدون مشکل باز شوند و باید قابل خواندن برای فتوشاپ باشند    
...
**PSDJAVA-3. پشتیبانی از ماسک های بردار لایه و چرخش و سفر های سفارشی لایه متن**

{{< highlight java >}}

 // عملیات چرخش و سفارش  های متن به درستی کار نمی‌کنند با PSD
...
**PSDJAVA-4. تمامی حروف آسیایی به درستی پردازش نمی‌شوند**

[**لطفا نمونه فایل پیوست را بررسی نمایید**](attachments/92602686/92766213.java)

**PSDJAVA-5. نمادهای \r\n به صورت اشتباه به عنوان دو خط جداگانه تفسیر می‌شوند**

{{< highlight java >}}

 // نمادهای \r\n به صورت اشتباه به عنوان دو خط جداگانه تفسیر میشوند
...

            {
                ...
                // تصویر ایجاد شده باید توسط Aspose.PSD/Aspose