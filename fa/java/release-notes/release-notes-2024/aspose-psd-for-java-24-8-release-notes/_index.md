---
title: اسپوز.پی‌اِس‌دی برای جاوا 24.8 - یادداشت‌های انتشار
type: docs
weight: 40
url: /fa/java/aspose-psd-for-java-24-8-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل یادداشت‌های انتشار برای [اسپوز.پی‌اِس‌دی برای جاوا 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) می‌باشد. {{% /alert %}}

| **کلید**     | **خلاصه**                                                                                        | **دسته‌بندی** |
|:------------|:--------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [قالب AI] اضافه کردن قابلیت پردازش برای گروه‌های XObject                                                 | بهبود       |
| PSDJAVA-645 | بهبود قابلیت‌های تبدیل جابه‌جایی تحت تأثیر اضافه کردن تنظیمات جابه‌جایی برای TextLayer و SmartObjectLayer     | ویژگی     |
| PSDJAVA-646 | [قالب AI] پردازش لایه‌ها در اپراتورهای جریان محتوا                                             | ویژگی     |
| PSDJAVA-647 | نتیجه رندر فایل AI با نتایج ایلوستریتور بسیار متفاوت است                                         | باگ      |
| PSDJAVA-648 | لینک مجدد Smart Object برای تمام Smart Object‌ها در فایل PSD اعمال نمی‌شود                       | باگ      |
...
**PSDJAVA-645. بهبود قابلیت‌های تبدیل جابه‌جایی تحت تأثیر اضافه کردن تنظیمات جابه‌جایی برای TextLayer و SmartObjectLayer**
...
**PSDJAVA-646. [قالب AI] پردازش لایه‌ها در اپراتورهای جریان محتوا**
...
**PSDJAVA-647. نتیجه رندر فایل AI با نتایج ایلوستریتور بسیار متفاوت است**
...
**PSDJAVA-648. لینک مجدد Smart Object برای تمام Smart Object‌ها در فایل PSD اعمال نمی‌شود**
        ...
        try (var image = (PsdImage) Image.load(sourceFile[i])) {
            for (Layer layer : image.getLayers()) {
                if (layer instanceof SmartObjectLayer) {
                    ...
                    // در لایه هوشمند دوم اینجا خطا وجود دارد
