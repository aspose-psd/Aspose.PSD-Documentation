---
title: یادداشت‌های نسخه 24.2 Aspose.PSD برای جاوا
type: docs
weight: 40
url: /fa/java/aspose-psd-for-java-24-2-release-notes/
---

{{% alert color="primary" %}} این صفحه حاوی یادداشت‌های ویرایش برای [Aspose.PSD برای جاوا 24.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.2/) است. {{% /alert %}}

| **کلید**    | **خلاصه**                                                                      | **دسته‌بندی** |
|:-----------|:-------------------------------------------------------------------------------|:--------------|
| PSDJAVA-584 | مدیریت خاصیت Angle برای PatternFillSettings.                                   | ویژگی       |
| PSDJAVA-585 | پشتیبانی از مقیاس عمودی و افقی برای TextLayer.                                 | ویژگی       |
| PSDJAVA-589 | [فرمت AI] پیاده‌سازی صحیح رندرینگ پس‌زمینه در فرمت AI مبتنی بر PDF.            | ویژگی       |
| PSDJAVA-590 | تغییر مکانیزم Distort در تغییر شکل.                                             | بهبود        |
| PSDJAVA-591 | افزایش سرعت تغییر شکل‌ها.                                                       | بهبود        |
| PSDJAVA-592 | استثنای "بارگذاری تصویر ناموفق." هنگام باز کردن سند.                          | باگ         |
| PSDJAVA-593 | رفع مشکل در ذخیره سازی فایل‌های psd حاوی الگوی Stroke.                       | باگ         |
| PSDJAVA-594 | استیل متنی اشتباه در یک شیوه هوشمند هنگام استفاده از ReplaceContents.       | باگ         |
| PSDJAVA-595 | [فرمت AI] رفع مشکل رندرینگ Cubic Bezier در فایل AI.                           | باگ         |
...
** PSDJAVA-584. مدیریت خاصیت Angle برای PatternFillSettings**
...
** PSDJAVA-585. پشتیبانی از مقیاس عمودی و افقی برای TextLayer**
...
** PSDJAVA-589. [فرمت AI] پیاده‌سازی صحیح رندرینگ پس‌زمینه در فرمت AI مبتنی بر PDF**
...
** PSDJAVA-590. تغییر مکانیزم Distort در تغییر شکل**
...
** PSDJAVA-591. افزایش سرعت تغییر شکل‌ها**
...
{{< highlight java >}}
        ...
        if (timeInSec > 100000) {
            throw new RuntimeException("زمان پردازش خیلی طولانی است");
        }

{{< /highlight >}}

** PSDJAVA-592. استثنای "بارگذاری تصویر ناموفق." هنگام باز کردن سند**
...
** PSDJAVA-593. رفع مشکل در ذخیره سازی فایل‌های psd حاوی الگوی Stroke**
...
** PSDJAVA-594. استیل متنی اشتباه در یک شیوه هوشمند هنگام استفاده از ReplaceContents**
...
** PSDJAVA-595. [فرمت AI] رفع مشکل رندرینگ Cubic Bezier در فایل AI**
