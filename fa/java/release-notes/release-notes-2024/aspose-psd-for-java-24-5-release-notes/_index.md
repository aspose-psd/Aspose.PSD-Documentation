---
title: دستاوردهای نسخه 24.5 Aspose.PSD برای جاوا
type: docs
weight: 40
url: /fa/java/aspose-psd-for-java-24-5-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل دستاوردهای نسخه [24.5 Aspose.PSD برای جاوا](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.5/) است. {{% /alert %}}

| **کلید**    | **خلاصه**                                                                                                             | **دسته‌بندی** |
|:------------|:------------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-617 | اضافه کردن پشتیبانی برای پرونده‌های AI دارای هدر EPSF                                                          | ویژگی       |
| PSDJAVA-620 | پیش‌نمایش نادرست شفافیت نیمه روی پرونده psd                                                          | اشکال       |
| PSDJAVA-621 | رندرینگ لایه شکل جزئیاً نادرست                                                                            | اشکال       |
| PSDJAVA-622 | خطا هنگام ذخیره کردن فایل‌های PSD با اندازه بیشتر از 200 مگابایت و ابعاد بزرگ (مشکلی در استفاده از حافظه) | اشکال       |
| PSDJAVA-623 | خطا در ذخیره‌سازی تصویر هنگام ذخیره کردن در قالب PDF بعد از به‌روزرسانی از 23.7 به 24.3                                         | اشکال       |
| PSDJAVA-624 | رفع مشکل در روش GetFontInfoRecords برای فونت‌های چینی                                                        | اشکال       |
...
**PSDJAVA-617. اضافه کردن پشتیبانی برای پرونده‌های AI دارای هدر EPSF**
...
**PSDJAVA-620. پیش‌نمایش نادرست شفافیت نیمه روی پرونده psd**
...
**PSDJAVA-622. خطایی هنگام ذخیره کردن فایل‌های PSD با اندازه بیشتر از 200 MB و ابعاد بزرگ (مشکلی در استفاده از حافظه)**
