---
title: یادداشت های انتشار Aspose.PSD برای Java 24.1
type: docs
weight: 40
url: /fa/java/aspose-psd-for-java-24-1-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل یادداشت های انتشار برای [Aspose.PSD برای Java 24.1](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.1/) است. {{% /alert %}}

| **کلید**   | **خلاصه**                                                                                     | **دسته‌بندی** |
|:------------|:-----------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-576 | [فرمت AI] اضافه کردن پردازش پایه برای تصاویر AI چند برگه                               | قابلیت       |
| PSDJAVA-579 | تاثیر متن انعطاف‌پذیر بر روی متن اعمال نمی‌شود                                           | باگ          |
| PSDJAVA-580 | نادرست رندر کردن ماسک در فایل خاص                                                         | باگ          |
| PSDJAVA-581 | NullReferenceException در Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor | باگ          |
| PSDJAVA-582 | [فرمت AI] رفع مشکل استفاده از حافظه در AiExporterUtils                                      | باگ          |
...
** PSDJAVA-576. [فرمت AI] اضافه کردن پردازش پایه برای تصاویر AI چند برگه**
...
{{< highlight java >}}
        ...
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // به طور پیش‌فرض، ActivePageIndex برابر با 0 است.
            // بنابراین اگر تصویر AI را بدون تغییر این ویژگی ذخیره کنید، اولین صفحه رندر می‌شود و ذخیره می‌شود.
            image.save(firstPageOutputPng, new PngOptions());

            // تغییر دادن شاخص صفحه فعال به صفحه دوم.
            image.setActivePageIndex(1);

            // ذخیره کردن صفحه دوم تصویر AI به عنوان یک تصویر PNG.
            image.save(secondPageOutputPng, new PngOptions());

            // تغییر دادن شاخص صفحه فعال به صفحه سوم.
            image.setActivePageIndex(2);

            // ذخیره کردن صفحه سوم تصویر AI به عنوان یک تصویر PNG.
            image.save(thirdPageOutputPng, new PngOptions());
        }

{{< /highlight >}}

** PSDJAVA-579. تاثیر متن انعطاف‌پذیر بر روی متن اعمال نمی‌شود**
...
** PSDJAVA-580. نادرست رندر کردن ماسک در فایل خاص**
...
** PSDJAVA-581. NullReferenceException در Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor**

{{< highlight java >}}

        String fontsFolder = "src/main/resources/فونت‌ها";
...
** PSDJAVA-582. [فرمت AI] رفع مشکل استفاده از حافظه در AiExporterUtils**
...
{{< highlight java >}}
        ...
        // بارگذاری تصویر AI.
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // ذخیره کردن صفحه اول تصویر AI به عنوان تصویر PNG.
