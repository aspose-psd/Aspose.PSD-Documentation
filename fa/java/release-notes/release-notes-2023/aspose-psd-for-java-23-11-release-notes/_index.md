---
title: یادداشت‌های نسخه Aspose.PSD برای Java 23.11
type: مستندات
weight: 40
url: /fa/java/aspose-psd-for-java-23-11-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل یادداشت‌های انتشار برای [Aspose.PSD برای Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) می‌باشد. {{% /alert %}}

| **کلید**       | **خلاصه**                                                                                                  | **دسته‌بندی**  |
|:---------------|:-----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | پشتیبانی از LMskResource                                                                                 |    قابلیت    |
| PSDJAVA-552    | [فرمت AI] افزودن توانایی رندر کردن فایل AI مبتنی بر PDF با Aspose.PSD                                      |    قابلیت   |
| PSDJAVA-553    | [فرمت AI] افزودن پشتیبانی از اپراتور PostScript “cm”                                                 |    قابلیت    |
| PSDJAVA-554    | افزودن انواع جدیدی از تغییر شکل: موج، صدف بالا، صدف پایین                                        |    قابلیت    |
| PSDJAVA-555    | افزودن پشتیبانی از تغییر شکل عمودی                                                                      |    قابلیت    |
| PSDJAVA-556    | System.ArgumentNullException: 'مقدار نمی‌تواند null باشد. (پارامتر 'key')' هنگام فراخوانی TextLayer.GetFonts()  |     اشکال    |
...
**PSDJAVA-551. پشتیبانی از LMskResource**
...
{{< highlight java >}}
    ...
    static void assertAreEqual(Object expected, Object actual) {
        assertAreEqual(expected, actual, "اشیاء برابر نیستند.");
    }
...
** PSDJAVA-552. [فرمت AI] افزودن توانایی رندر کردن فایل AI مبتنی بر PDF با Aspose.PSD**
...
** PSDJAVA-553. [فرمت AI] افزودن پشتیبانی از اپراتور PostScript "cm"**
...
** PSDJAVA-554. افزودن انواع جدیدی از تغییر شکل: موج، صدف بالا، صدف پایین**
...
** PSDJAVA-555. افزودن پشتیبانی از تغییر شکل عمودی**
...
** PSDJAVA-556. System.ArgumentNullException: 'مقدار نمی‌تواند null باشد. (پارامتر 'key')' هنگام فراخوانی TextLayer.GetFonts()**
