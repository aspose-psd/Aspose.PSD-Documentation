---
title: گزارش انتشار Aspose.PSD برای جاوا 23.4
type: docs
weight: 40
url: /fa/java/aspose-psd-for-java-23-4-release-notes/
---

{{% alert color="primary" %}} این صفحه شامل یادداشت‌های انتشار برای [Aspose.PSD برای جاوا 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) است. {{% /alert %}}

|**کلید**|**خلاصه**|**دسته**|
| :- | :- | :- |
|PSDJAVA-446|انتقال وظیفه‌های از دسترسی از Aspose.PSD برای .Net به Aspose.PSD برای جاوا|بهبود|
|PSDJAVA-441|طراحی کلاس RawColor برای API عمومی برای استفاده از آن در PSD API به جای ساختمان قدیمی Color|بهبود|
|PSDJAVA-418|ادغام مدرن لایسنس Aspose برای Aspose.PSD|بهبود|
|PSDJAVA-445|حرکت فرمت‌بندی هنگام ویرایش در فتوشاپ|اشکال|
|PSDJAVA-443|ویرایش متن با استفاده از قسمت‌های متن در بخش‌های متن صحیح ذخیره نمی‌شود|اشکال|
|PSDJAVA-444|آغاز و پایان استایل‌ها یا پاراگراف‌ها در مکان اشتباهی در ویرایش لایه متن با استفاده از ITextPortion ظاهر می‌شوند|اشکال|
...
- M:com.aspose.psd.fileformats.psd.layers.text.ITextStyle.set_is_standardVerticalRomanAlignmentEnabled(boolean)
...
- M:com.aspose.psd.fileformats.p