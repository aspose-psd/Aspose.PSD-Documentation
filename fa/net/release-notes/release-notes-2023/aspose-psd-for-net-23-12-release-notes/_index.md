---
title: یادداشت‌های انتشار Aspose.PSD برای .NET 23.12
type: docs
weight: 10
url: /fa/net/aspose-psd-for-net-23-12-release-notes/
---

{{% alert color="primary" %}}

این صفحه حاوی یادداشت‌های انتشار برای [Aspose.PSD برای .NET 23.12](https://www.nuget.org/packages/Aspose.PSD/) می‌باشد

{{% /alert %}}

| **کلید**   | **خلاصه**                                                                                                  | **رده**     |
|:------------|:---------------------------------------------------------------------------------------------------------|:-----------|
| PSDNET-1679 | [فرمت AI] اضافه کردن پشتیبانی از رندر تصویر سیاه و سفید در نسخه جدید AI                                   | ویژگی     |
| PSDNET-1454 | رسیدگی به نوع Gradient Noise در GdflResrource                                                            | ویژگی     |
| PSDNET-1827 | خطا "مرجع شیء به یک نمونه اشاره نشده است." در زمان ذخیره لایه متن پس از به‌روزرسانی             | خطای برنامه‌نویسی     |
| PSDNET-1776 | رفع بارگذاری دستی فونت‌ها در MacOS با استفاده از System.Drawing.Common و Aspose.Drawing.        | خطای برنامه‌نویسی     |
| PSDNET-1536 | AllowWarpRepaint در PsdLoadOptions منجر به استثناء می‌شود                                             | خطای برنامه‌نویسی     |
| PSDNET-1714 | [فرمت AI] پردازش جریان‌های ارجاع متقاطع.                                                              | بهبود    |
| PSDNET-1834 | کنترل لایسنس برای VectorPathDataResource به طور نادرست کار می‌کند                                | بهبود    |
| PSDNET-770  | باز کردن هر فایل تصویر به عنوان یک شیء هوشمند جاسازی شده در تصویر PSD.                         | بهبود    |
| PSDNET-1864 | سامانه لایسنس افزونه Aspose.PSD                                                                           | بهبود    |
...
**PSDNET-1679. [فرمت AI] اضافه کردن پشتیبانی از رندر تصویر سیاه و سفید در نسخه جدید AI**
...
**PSDNET-1454. رسیدگی به نوع Gradient Noise در GdflResrource**
...
**PSDNET-1827. خطا "مرجع شیء به یک نمونه اشاره نشده است." در زمان ذخیره لایه متن پس از به‌روزرسانی**
...
using (var psdImage = (PsdImage)Image.Load(sourceFile))
{
    ...
    // در اینجا نباید هیچ خطا وجود دارد
    psdImage.Save(outputFile);
}
{{< /highlight >}}

**PSDNET-1536. AllowWarpRepaint در PsdLoadOptions منجر به استثناء می‌شود**
...
**PSDNET-1834. کنترل لایسنس برای VectorPathDataResource به طور نادرست کار می‌کند**
...
**PSDNET-770. باز کردن هر فایل تصویر به عنوان یک شیء هوشمند جاسازی شده در تصویر PSD**
...
**PSDNET-1864. سامانه لایسنس افزونه Aspose.PSD**

{{< highlight csharp >}}            
    var metered = new Metered();
    metered.SetMeteredKey(pluginPublic, pluginPrivate);
			
	// Manipulation خاص افزونه
{{< /highlight >}}