---
title: دفترچه‌های انتشار Aspose.PSD برای ‌.NET 20.12
type: docs
weight: 10
url: /fa/net/aspose-psd-for-net-20-12-release-notes/
---

{{% alert color="primary" %}} 

صفحه حاوی یادداشت‌های انتشار [Aspose.PSD برای .NET 20.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**کلید**|**خلاصه**|**دسته‌بندی**|
| :- | :- | :- |
|PSDNET-757|پشتیبانی از تبدیل لایه‌ها به لایه Smart Object|ویژگی|
|PSDNET-764|روش SmartObjectLayer.ReplaceContents استثنا NullReferenceException را ایجاد می‌کند اگر سعی کنیم فایل PSB را اضافه کنیم|افزونه|
|PSDNET-773|رندر نادرست تصاویر CMYK 8 بیتی و CMYK 16 بیتی، اگر لایه از محدوده Canvas بزرگتر باشد|افزونه|
|PSDNET-782|فایل PSB ذخیره شده با API ما قابل باز شدن است، اما با فتوشاپ نیست|افزونه|
|PSDNET-783|اگر سعی کنیم لایه هوشمند در یک PSD خاص با یک منبع داده مشترک را تغییر دهیم، یک استثنا دریافت می‌کنیم|افزونه|
|PSDNET-172|تغییر نام FileFormatVersion به PsdVersion برای پیشگیری از ابهام|بهبود|
|PSDNET-620|پاکسازی پیکربندی چارچوب Compact از Aspose.PSD .NET|بهبود|
|PSDNET-765|PsdImageException: سربرگ منبع ناشناخته در تلاش برای باز کردن فایل PSB با SmartObjectLayers|بهبود|
