---
title: Notes de publication d'Aspose.PSD pour .NET 21.10
type: docs
weight: 30
url: /fr/net/aspose-psd-pour-net-21-10-notes-de-release/
---

{{% alert color="primary" %}}

Cette page contient les notes de publication pour [Aspose.PSD pour .NET 21.10](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDNET-128|Support du mécanisme de filtres intelligents|Fonctionnalité|
|PSDNET-414|Prise en charge de Fxid/FEidResource|Fonctionnalité|
|PSDNET-556|Erreur lors du chargement d'AliasStructure|Bogue|
|PSDNET-948|Changement de police et de couleur pour TextLayer PSD|Bogue|
|PSDNET-971|Ajouter la possibilité de créer personnalisée d'une couche avec un masque vectoriel|Amélioration|
...
**PSDNET-128. Support du mécanisme de filtres intelligents**
...
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(sourceFilte))
            {
                ...
                // éditer les filtres intelligents
                GaussianBlurSmartFilter gaussianBlur = (GaussianBlurSmartFilter)smartObj.SmartFilters.Filters[0];

                // vérification des valeurs de filtres
...
**PSDNET-414. Prise en charge de Fxid/FEidResource**
...
**PSDNET-556. Erreur lors du chargement d'AliasStructure**
...
**PSDNET-948. Changement de police et de couleur pour TextLayer PSD**
