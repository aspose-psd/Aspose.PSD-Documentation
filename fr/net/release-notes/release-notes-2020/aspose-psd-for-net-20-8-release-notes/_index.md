---
title: Aspose.PSD pour .NET 20.8 - Notes de version
type: docs
weight: 50
url: /fr/net/aspose-psd-for-net-20-8-release-notes/
---

{{% alert color="primary" %}} 

Cette page contient les notes de version pour [Aspose.PSD pour .NET 20.8](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDNET-390|Support de PlLdResource (ressource de calque placé pour calque d'objet intelligent)|Fonctionnalité|
|PSDNET-400|Support de SoLdResource (ressource de données de calque d'objet intelligent)|Fonctionnalité|
|PSDNET-693|Ajout du support des structures Array d'objets et Array d'unités : signatures ObAr / UnFl|Fonctionnalité|
|PSDNET-600|Correction de la sauvegarde d'une image PSD modifiée avec le mode couleur CMJN sur 16 bits par canal|Correctif|
|PSDNET-664|Souligné et barré perdu après la mise au point sur le texte dans un fichier enregistré avec Aspose.PSD|Correctif|
|PSDNET-710|Régression : Aspose.PSD 20.7.0 casse les tailles de police pour les anciens fichiers|Correctif|
...
**PSDNET-390. Support de PlLdResource (ressource de calque placé pour un calque d'objet intelligent)**
{{< highlight csharp >}}
        void AssertAreEqual(object actual, object expected)
        {
            ...
            if (!areEqual)
            {
                throw new FormatException(
                    string.Format("La valeur actuelle {0} n'est pas égale à l'attendue {1}.", actual, expected));
            }
        }
        ...
        {
            // Insérer les valeurs attendues ici...
        };
...
**PSDNET-400. Support de SoLdResource (ressource de données de calque d'objet intelligent)**
{{< highlight csharp >}}
        // Insérer l'exemple d'utilisation ici...
{{< /highlight >}}

**PSDNET-693. Ajout du support des structures Array d'objets et Array d'unités : signatures ObAr / UnFl**
{{< highlight csharp >}}
        // Insérer l'exemple d'utilisation ici...
{{< /highlight >}}

**PSDNET-600. Correction de la sauvegarde d'une image PSD modifiée avec le mode couleur CMJN sur 16 bits par canal**
{{< highlight csharp >}}
        // Insérer l'exemple d'utilisation ici...
{{< /highlight >}}

**PSDNET-664. Souligné et barré perdu après la mise au point sur le texte dans un fichier enregistré avec Aspose.PSD**
{{< highlight csharp >}}
        // Insérer l'exemple d'utilisation ici...
{{< /highlight >}}

**PSDNET-710. Régression : Aspose.PSD 20.7.0 casse les tailles de police pour les anciens fichiers**
{{< highlight csharp >}}
            // Insérer l'exemple d'utilisation ici...
{{< /highlight >}}