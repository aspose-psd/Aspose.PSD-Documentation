---
title: Aspose.PSD pour .NET 19.6 - Notes de version
type: docs
weight: 70
url: /fr/net/aspose-psd-pour-net-19-6-notes-de-version/
---

{{% alert color="primary" %}} 

Cette page contient les notes de version pour [Aspose.PSD pour .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDNET-127|Capacité de convertir un fichier PSD en PSB et vice versa|Fonctionnalité|
|PSDNET-154|Portage des sources Aspose.Imaging 19.5 vers Aspose.PSD|Amélioration|
|PSDNET-155|Nettoyage de l'API publique liée à Aspose.PSD|Amélioration|
|PSDNET-159|Suppression de la propriété IsLicensed|Amélioration|
|PSDNET-102|La conversion PSB en JPG se bloque|Bogue|
|PSDNET-150|Le positionnement de la nouvelle couche de texte ajoutée est décalé lors de l'édition dans Photoshop|Bogue|
...
- F:Aspose.PSD.FileFormats.Gif.Dis