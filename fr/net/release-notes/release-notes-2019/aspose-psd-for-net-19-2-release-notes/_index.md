---
title: Notes de version Aspose.PSD pour .NET 19.2
type: docs
weight: 110
url: /fr/net/aspose-psd-pour-net-19-2-notes-de-version/
---

{{% alert color="primary" %}}

Cette page contient les notes de version pour Aspose.PSD pour .NET 19.2

{{% /alert %}}

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDNET-97|Ajout de la prise en charge des calques de remplissage : remplissage de couleur|Fonctionnalité|
|PSDNET-98|Ajout de la prise en charge des calques de remplissage : remplissage de dégradé|Fonctionnalité|
|PSDNET-105|Prise en charge de GdFlResource|Fonctionnalité|
|PSDNET-106|Prise en charge de VmskResource|Fonctionnalité|
|PSDNET-109|Portage des sources réelles Aspose.Imaging vers Aspose.PSD|Amélioration|
|PSDNET-92|Ajout de la prise en charge du chargement partiel pour certaines méthodes|Amélioration|
|PSDNET-110|Les performances PSD ont considérablement diminué|Bogue|
...
- P:```
Aspose.PSD.FileFormats.Psd.Layers.LayerEffects.GradientColorPoint.MedianPointLocation
