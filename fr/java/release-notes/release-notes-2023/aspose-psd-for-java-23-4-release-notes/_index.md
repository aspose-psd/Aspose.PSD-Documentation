---
title: Aspose.PSD pour Java 23.4 - Notes de publication
type: docs
weight: 40
url: /fr/java/aspose-psd-for-java-23-4-release-notes/
---

{{% alert color="primary" %}} Cette page contient les notes de publication de [Aspose.PSD pour Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) {{% /alert %}}

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDJAVA-446|Port manqué de fonctionnalités d'Aspose.PSD pour .Net à Aspose.PSD pour Java|Amélioration|
|PSDJAVA-441|Conception de la classe RawColor pour l'API publique pour l'utiliser dans l'API PSD à la place de la structure Color obsolète|Amélioration|
|PSDJAVA-418|Intégrer la licence moderne Aspose pour Aspose.PSD|Amélioration|
|PSDJAVA-445|Déplacement du format lors de l'édition dans Photoshop|Bogue|
|PSDJAVA-443|L'édition du texte à l'aide de portions de texte ne sauvegarde pas le résultat correct|Bogue|
|PSDJAVA-444|Le début et la fin des styles ou des paragraphes apparaissent au mauvais endroit lors de l'édition de la couche de texte par ITextPortion|Bogue|
...
- M:com.aspose.p{{< highlight java >}}
	FontSettings.removeFontsFolder(java.lang.String)
	...
	M:com.aspose.psd.fileformats.psd.layers.layerresources.PattResource.setPattern(int[],com