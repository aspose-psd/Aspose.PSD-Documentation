---
title: Notes de publication Aspose.PSD pour Java 23.11
type: docs
weight: 40
url: /fr/java/aspose-psd-pour-java-23-11-notes-de-version/
---

{{% alert color="primary" %}} Cette page contient les notes de publication pour [Aspose.PSD pour Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) {{% /alert %}}

| **Clé**        | **Résumé**                                                                                                | **Catégorie** |
|:---------------|:-----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | Support de LMskResource                                                                                    |    Fonction   |
| PSDJAVA-552    | [Format AI] Ajout de la capacité de rendre un fichier AI basé sur PDF avec Aspose.PSD                        |    Fonction   |
| PSDJAVA-553    | [Format AI] Ajout de la prise en charge de l'opérateur PostScript "cm"                                       |    Fonction   |
| PSDJAVA-554    | Ajout de nouveaux types de déformations : Wave, coquille haute, coquille basse                               |    Fonction   |
| PSDJAVA-555    | Ajout de la prise en charge de la déformation verticale                                                     |    Fonction   |
| PSDJAVA-556    | System.ArgumentNullException : "La valeur ne peut pas être nulle. (Paramètre 'clé')" lors de l'appel de TextLayer.GetFonts()  |      Problème     |
...
** PSDJAVA-551. Support de LMskResource**
...
** PSDJAVA-552. [Format AI] Ajout de la capacité de rendre un fichier AI basé sur PDF avec Aspose.PSD**
...
{{< highlight java >}}
    ...
    // Charger l'image AI basée sur PDF.
...
** PSDJAVA-553. [Format AI] Ajout de la prise en charge de l'opérateur PostScript "cm"**
...
** PSDJAVA-554. Ajouter de nouveaux types de déformations : Wave, coquille haute, coquille basse**
...
** PSDJAVA-555. Ajouter la prise en charge de la déformation verticale**
...
** PSDJAVA-556. System.ArgumentNullException: 'La valeur ne peut pas être nulle. (Paramètre 'clé')' lors de l'appel de TextLayer.GetFonts()**
