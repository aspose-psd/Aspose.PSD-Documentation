---
title: Aspose.PSD for Java 21.7 - Notes de publication
type: docs
weight: 40
url: /fr/java/aspose-psd-for-java-21-7-release-notes/
---

{{% alert color="primary" %}} Cette page contient les notes de publication pour [Aspose.PSD for Java 21.7](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-21.7/) {{% /alert %}}

|**Clé**|**Résumé**|**Catégorie**|
| :- | :- | :- |
|PSDJAVA-362|Prise en charge de l'édition de polices en utilisant TextPortions|Fonctionnalité|
|PSDJAVA-363|Aspose.PSD 21.6: ImageSaveException lors d'une tentative de conversion PSD en PNG|Bogue|
...
**PSDJAVA-362. Prise en charge de l'édition de polices en utilisant TextPortions**
...
**PSDJAVA-363. Aspose.PSD 21.6: ImageSaveException lors d'une tentative de conversion PSD en PNG**
