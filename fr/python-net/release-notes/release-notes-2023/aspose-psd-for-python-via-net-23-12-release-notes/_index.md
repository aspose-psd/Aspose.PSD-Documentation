---
title: Notes de version de Aspose.PSD pour Python via .NET 23.12
type: docs
weight: 10
url: /fr/net/aspose-psd-for-python-via-net-23-12-release-notes/
---

{{% alert color="primary" %}}

Cette page contient les notes de version pour [Aspose.PSD pour Python via .NET 23.12](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Clé**      | **Résumé**                                                                                             | **Catégorie** |
|:--------------|:------------------------------------------------------------------------------------------------------|:-------------|
|  PSDPYTHON-7  | [Format AI] Ajouter le support du rendu d'image matricielle dans la nouvelle version de AI            |   Fonctionnalité    |
|  PSDPYTHON-8  | Gérer le type de bruit de dégradé dans GdflResrource                                                  |   Fonctionnalité    |
|  PSDPYTHON-9  | Erreur "La référence d'objet n'est pas définie à une instance d'un objet." lors de la sauvegarde de la couche de texte après mise à jour        |     Problème     |
|  PSDPYTHON-10 | Corriger le chargement manuel des polices sur MacOS en utilisant System.Drawing.Common et Aspose.Drawing.                  |     Problème     |
|  PSDPYTHON-11 | AllowWarpRepaint dans les PsdLoadOptions entraîne l'exception                                             |     Problème     |
|  PSDPYTHON-12 | [Format AI] Implémenter le traitement des flux de référence croisée                                              | Amélioration |
|  PSDPYTHON-13 | Le contrôle de licence pour VectorPathDataResource fonctionne incorrectement                                             | Amélioration |
...
**PSDPYTHON-7. [Format AI] Ajouter le support du rendu d'image matricielle dans la nouvelle version de AI**
...
**PSDPYTHON-8. Gérer le type de bruit de dégradé dans GdflResrource**

{{< highlight python >}}
        # Exemple pour travailler sur cette ressource GdFlResource en utilisant l'API de base   
		...
		# Exemple pour gérer un dégradé solide
		...
		# Exemple pour gérer un dégradé de bruit
...
**PSDPYTHON-9. Erreur "La référence d'objet n'est pas définie à une instance d'un objet." lors de la sauvegarde de la couche de texte après mise à jour**
...
**PSDPYTHON-11. AllowWarpRepaint dans les PsdLoadOptions entraîne l'exception**
