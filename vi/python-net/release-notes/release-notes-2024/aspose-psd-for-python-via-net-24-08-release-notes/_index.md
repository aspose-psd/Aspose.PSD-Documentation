---
title: Aspose.PSD cho Python via .NET 24.8 - Ghi chú Phát hành
type: docs
weight: 10
url: /vi/python-net/aspose-psd-cho-python-thong-qua-net-24-8-ghi-chu-phat-hanh/
---

{{% alert color="primary" %}}

Trang này chứa bản ghi chú cho [Aspose.PSD cho Python via .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Khóa**      | **Tóm tắt**                                                                                                         | **Danh mục** |
|:-------------|:------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [Định Dạng AI] Thêm xử lý cho Nhóm XObject                                                  | Cải tiến  |
| PSDPYTHON-82 | Nâng cao khả năng biến đổi Warp bằng cách thêm WarpSettings cho TextLayer và SmartObjectLayer | Tính năng      |
| PSDPYTHON-83 | [Định Dạng AI] Xử lý lớp trong các toán tử dòng nội dung                                             | Tính năng      |
| PSDPYTHON-84 | Kết quả vẽ của tệp AI khác biệt rất lớn so với kết quả của Illustrator               | Lỗi          |
| PSDPYTHON-85 | Liên kết lại Smart Object không áp dụng cho tất cả Smart Object trong tệp PSD                                    | Lỗi          |  
...
**PSDPYTHON-81. [Định Dạng AI] Thêm xử lý cho Nhóm XObject**
{{< highlight python >}}
#Không có ví dụ. Đây là cải tiến bên trong
{{< /highlight >}}

**PSDPYTHON-82. Nâng cao khả năng biến đổi Warp bằng cách thêm WarpSettings cho TextLayer và SmartObjectLayer**
{{< highlight python >}}
...
**PSDPYTHON-83. [Định Dạng AI] Xử lý lớp trong các toán tử dòng nội dung**
{{< highlight python >}}
...
**PSDPYTHON-84. Kết quả vẽ của tệp AI khác biệt rất lớn so với kết quả của Illustrator**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. Liên kết lại Smart Object không áp dụng cho tất cả Smart Object trong tệp PSD**
{{< highlight python >}}
