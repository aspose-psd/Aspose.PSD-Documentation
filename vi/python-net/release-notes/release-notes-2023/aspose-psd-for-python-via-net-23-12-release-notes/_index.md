---
title: Aspose.PSD cho Python via .NET 23.12 - Ghi chú phát hành
type: docs
weight: 10
url: /vi/net/aspose-psd-cho-python-qua-net-23-12-ghi-chu-phat-hanh/
---

{{% alert color="primary" %}}

Trang này chứa các ghi chú phát hành cho [Aspose.PSD cho Python via .NET 23.12](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Khóa**     | **Tóm tắt**                                                                                            | **Danh mục** |
|:--------------|:---------------------------------------------------------------------------------------------------------|:------------|
|  PSDPYTHON-7  | [Định dạng AI] Thêm hỗ trợ vẽ ảnh raster trong phiên bản AI mới                                   |   Tính năng  |
|  PSDPYTHON-8  | Xử lý loại nhiễu Gradient trong GdflResrource                                                               |   Tính năng  |
|  PSDPYTHON-9  | Lỗi "Tham chiếu đối tượng không được thiết lập thành một thể hiện của một đối tượng" khi lưu lớp Văn bản sau khi cập nhật     |     Sửa lỗi     |
|  PSDPYTHON-10 | Sửa việc tải thủ công các phông chữ trên MacOS bằng cách sử dụng System.Drawing.Common và Aspose.Drawing.           |     Sửa lỗi     |
|  PSDPYTHON-11 | Cho phép AllowWarpRepaint trong PsdLoadOptions dẫn đến ngoại lệ                                             |     Sửa lỗi     |
|  PSDPYTHON-12 | [Định dạng AI] Thực hiện xử lý các luồng tham khảo chéo                                                      | Cải tiến |
|  PSDPYTHON-13 | Kiểm soát Giấy phép cho VectorPathDataResource hoạt động không chính xác                                    | Cải tiến |
...
**PSDPYTHON-7. [Định dạng AI] Thêm hỗ trợ vẽ ảnh raster trong phiên bản AI mới**
...
**PSDPYTHON-8. Xử lý loại Nhiễu Gradient trong GdflResrource**

{{< highlight python >}}
        # Ví dụ để làm việc với GdFlResource này bằng API cơ bản   
		...
		# Ví dụ để xử lý Gradient đồng nhất
...
**PSDPYTHON-9. Lỗi "Tham chiếu đối tượng không được thiết lập thành một thể hiện của một đối tượng" khi lưu lớp Văn bản sau khi cập nhật**
