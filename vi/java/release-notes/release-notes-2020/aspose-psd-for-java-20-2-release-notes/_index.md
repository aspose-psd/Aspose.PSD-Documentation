---
title: Ghi chú phát hành Aspose.PSD cho Java 20.2
type: docs
weight: 20
url: /vi/java/aspose-psd-for-java-20-2-release-notes/
---

{{% alert color="primary" %}} Trang này chứa các ghi chú phát hành cho [Aspose.PSD cho Java 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) {{% /alert %}} 

| **Key**   | **Tóm tắt**                                                                     | **Danh mục**  |
| :-        | :-                                                                              | :-            |
| PSDJAVA-96  | Cải tiến khả năng hiển thị văn bản màu sắc khác nhau trong Lớp Văn bản                | Tính năng     |
| PSDJAVA-97  | Hỗ trợ tài nguyên clbl (Tài nguyên Lớp chứa thông tin về các yếu tố chắn trội)     | Tính năng     |
| PSDJAVA-100 | Hỗ trợ tài nguyên blwh (Tài nguyên chứa Dữ liệu Lớp Điều chỉnh Đen trắng)           | Tính năng     |
| PSDJAVA-101 | Khả năng xuất Nhóm Lớp thành Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf           | Tính năng     |
| PSDJAVA-105 | Hỗ trợ tài nguyên lspf (Chứa cài đặt về Cài đặt Bảo vệ Lớp)                        | Tính năng     |
| PSDJAVA-106 | Hỗ trợ tài nguyên infx (Chứa dữ liệu về Trộn các yếu tố bên trong)                  | Tính năng     |
| PSDJAVA-99  | Tinh chỉnh PsdImage và Layer để thay đổi Hành vi Biến đổi (Thay đổi kích thước/ quay/ cắt cho lớp mask nếu chúng ta biến đổi lớp một cách riêng biệt) | Cải tiến |
| PSDJAVA-98  | Trong một số cài đặt toàn cầu AI Image, hình ảnh raster không thể mở được         | Sửa lỗi    |
| PSDJAVA-102 | Sau khi thực hiện thao tác FlipRotate trên Lớp, Hình ảnh PSD trở nên không thể đọc được | Sửa lỗi    |
| PSDJAVA-103 | System.ArgumentException trong quá trình tải tệp PSD                                  | Sửa lỗi     |
| PSDJAVA-104 | Sau khi sử dụng một phương thức biến đổi cho một lớp, lớp đã lưu có ranh giới không chính xác hoặc một mask     | Sửa lỗi     |

# **Thay đổi API công khai**
# **API này tạm thời bị tắt và sẽ được bật trong bản phát hành tiếp theo:**
...
` `**Vui lòng sử dụng v19.4 nếu bạn có sự phụ thuộc phù hợp.**
# **API đã thêm:**
...
- M:com.aspose.psd.fileformats.psd.layers.adjustmentmentlayers.BlackWhiteAdjustmentLayer.setBlackAndWhitePresetFileName(java.lang.String)
...
- F:com.aspose.psd.fileformats.psd.layers.fillsettings.Gradient