---
title: Aspose.PSD cho Java 21.5 - Ghi chú phát hành
type: docs
weight: 40
url: /vi/java/aspose-psd-cho-java-21-5-ghi-chu-phat-hanh/
---

{{% alert color="primary" %}} Trang này chứa các ghi chú phát hành cho [Aspose.PSD cho Java 21.5](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-cho-java-21.5/) {{% /alert %}}

{{% alert color="info" %}}
Đây là phiên bản trung gian của Aspose.PSD cho Java.
Có một số vấn đề đã biết. Vì vậy, nếu bạn cần một phiên bản ổn định, bạn nên sử dụng [Aspose.PSD 20.9](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-cho-java-20.9/) cho đến khi Aspose.PSD 21.6 được phát hành.
Phiên bản này bao gồm tất cả các tính năng của Aspose.PSD .Net (Bao gồm Đối tượng Thông minh) từ phiên bản 20.9 và các tính năng được liệt kê dưới đây.
{{% /alert %}} 

|**Khóa**|**Tóm tắt**|**Danh mục**|
| :- | :- | :- |
|PSDJAVA-340|Hỗ trợ thay đổi kích thước lớp hình dạng với đường dẫn vector khi chỉ có một lớp bị thay đổi kích thước|Tính năng|
|PSDJAVA-341|Hỗ trợ thay đổi kích thước lớp hình dạng với đường dẫn vector|Tính năng|
|PSDJAVA-342|Xâu văn bản bị cắt|Lỗi|
...
- M:com.aspose.psd.asynctask.AsyncTaskFunc.spawn(com.aspose.psd.system.AsyncCallback,java.lang.Object)
- M:com.aspose.psd.asynctask.IAsyncTaskState.getException
- M:com.aspose.psd.asynctask.IAsyncTaskState.getErrorCode
- M:com.aspose.psd.asynctask.IAsyncTaskState.getResult
- M:com.aspose.psd.asynctask.IAsyncTaskState.isComplete
- E:com.aspose.psd.asynctask.TaskAction
- E:com.aspose.psd.asynctask.TaskFunction
- M:com.aspose.psd.system.AsyncCallback.#ctor(System.AsyncCallbackTarget,System.Object)
- M:com.aspose.psd.system.AsyncCallback.#ctor(com.aspose.psd.system.AsyncCallback,System.AsyncCallbackTarget,System.Object)
- M:com.aspose.psd.system.AsyncCallback.Invoke(System.IAsyncResult)
- M:com.aspose.psd.system.AsyncCallback.InvokePoolThread(System.IAsyncResult)
- F:com.aspose.psd.system.AsyncCallback.Target
- F:com.aspose.psd.system.AsyncCallback.TargetInfo
- F:com.aspose.psd.system.AsyncCallback.WeakInvoke
- E:com.aspose.psd.system.IAsyncResult
- M:com.aspose.psd.system.IAsyncResult.AsyncState.get
- M:com.aspose.psd.system.IAsyncResult.CompletedSynchronously.get
- M:com.aspose.psd.system.IAsyncResult.IsCompleted.get
- M:com.aspose.psd.system.io.FileSystem.DirectoryExists(System.String)
- M:com.aspose.psd.system.io.FileSystem.FileExists(System.String)
- M:com.aspose.psd.system.io.FileSystem.GetDirectories(System.String)
```
