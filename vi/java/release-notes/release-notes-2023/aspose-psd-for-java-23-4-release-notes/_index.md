---
title: Aspose.PSD cho Java 23.4 - Release Notes
type: docs
weight: 40
url: /vi/java/aspose-psd-cho-java-23-4-release-notes/
---

{{% alert color="primary" %}} Trang này chứa các ghi chú phát hành cho [Aspose.PSD cho Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-cho-java-23.4/) {{% /alert %}}

|**Khóa**|**Tóm tắt**|**Danh mục**|
| :- | :- | :- |
|PSDJAVA-446|Chuyển chức năng được bỏ lỡ từ Aspose.PSD cho .Net sang Aspose.PSD cho Java|Cải tiến|
|PSDJAVA-441|Thiết kế lớp RawColor cho API công khai để sử dụng trong API PSD thay vì cấu trúc Color lỗi thời|Cải tiến|
|PSDJAVA-418|Tích hợp Giấy phép Aspose hiện đại cho Aspose.PSD|Cải tiến|
|PSDJAVA-445|Di chuyển định dạng khi chỉnh sửa trong photoshop|Lỗi|
|PSDJAVA-443|Chỉnh sửa văn bản bằng Các Phần Văn Bản không lưu kết quả chính xác|Lỗi|
|PSDJAVA-444|Bắt đầu và kết thúc của các kiểu hoặc đoạn văn xuất hiện ở địa điểm không chính xác khi chỉnh sửa Lớp Văn bản bằng ITextPortion|Lỗi|
