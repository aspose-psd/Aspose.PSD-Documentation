---
title: Aspose.PSD cho .NET 20.11 - Ghi chú Phát hành
type: docs
weight: 20
url: /vi/net/aspose-psd-cho-net-20-11-ghi-chu-phat-hanh/
---

{{% alert color="primary" %}} 

Trang này chứa các ghi chú về [Aspose.PSD cho .NET 20.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Khóa**|**Tóm tắt**|**Danh mục**|
| :- | :- | :- |
|PSDNET-713|Aspose.PSD không thể chuyển đổi PSD sang các Chế độ màu/Độ sâu Bits khác mà không cần lưu chúng dưới dạng tệp|Tính năng|
|PSDNET-754|Thêm khả năng sao chép Lớp Đối tượng Thông minh trong hình ảnh PSD|Tính năng|
|PSDNET-267|Ngoại lệ khi tải và lưu tệp PSD chứa Hiệu ứng Lớp|Lỗi|
|PSDNET-579|Phương thức "Image.LoadRawData" gây ra ngoại lệ con trỏ Null|Lỗi|
|PSDNET-741|Ngoại lệ ImageLoadException được ném khi cố gắng mở tệp|Lỗi|
|PSDNET-744|Aspose.PSD 20.10: Không thể tải Psd|Lỗi|
...
**PSDNET-267. Ngoại lệ khi tải và lưu tệp PSD chứa Hiệu ứng Lớp**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-579. Phương thức "Image.LoadRawData" gây ra ngoại lệ con trỏ Null**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-713. Aspose.PSD không thể chuyển đổi PSD sang các Chế độ màu/Độ sâu Bits khác mà không cần lưu chúng dưới dạng tệp**
{{< highlight csharp >}}
            string dataDir = "PSDNET713_1\\";
            string outputDir = dataDir + "output\\";

            // Những ví dụ này mô tả chuyển đổi định dạng hình ảnh PSD sang các Chế độ màu/Độ sâu Bits khác.
            ...
            // Lưu thành tệp PSD sau đó tải và lưu lại thành tệp PNG.
...
{{< /highlight >}}
**PSDNET-741. Ngoại lệ ImageLoadException được ném khi cố gắng mở tệp**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-744. Aspose.PSD 20.10: Không thể tải Psd**
{{< highlight csharp >}}         
...
{{< /highlight >}}
**PSDNET-754. Thêm khả năng sao chép Lớp Đối tượng Thông minh trong hình ảnh PSD**
{{< highlight csharp >}}
            string dataDir = "PSDNET754_1\\";
            string outputDir = dataDir + "output\\";

            // Những ví dụ này mô tả cách sao chép các lớp đối tượng thông minh trong hình ảnh PSD.
            ...
            {
                int layerNumber = 0; // Số lớp cần sao chép
                ...
                using (PsdImage image = (PsdImage)Image.Load(filePath))
                {
                    ...
                    {
                        // Hãy đảo ngược hình ảnh thông minh nhúng (cho một hình ảnh PSD trong hình ảnh nội bộ chúng ta chỉ đảo ngược lớp đầu tiên)
                        InvertImage(innerImage);

                        // Hãy thay thế hình ảnh thông minh nhúng trong lớp PSD
                        smartObjectLayer.ReplaceContents(innerImage);
                    }

                    // Lớp được nhân bản chia sẻ hình ảnh được nhúng với đối tượng thông minh gốc
                    // và nó phải được cập nhật một cách rõ ràng khác thì bộ nhớ cache vẽ của nó sẽ không thay đổi.
                    // Chúng ta cập nhật mọi đối tượng thông minh để đảm bảo rằng lớp mới được tạo bằng NewSmartObjectViaCopy
                    // không chia sẻ hình ảnh được nhúng với các lớp khác.
            ...
            // Đảo ngược hình ảnh raster bao gồm cả hình ảnh PSD.
