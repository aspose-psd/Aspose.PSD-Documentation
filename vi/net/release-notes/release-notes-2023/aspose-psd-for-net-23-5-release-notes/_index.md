---
title: Aspose.PSD cho .NET 23.5 - Ghi chú phát hành
type: docs
weight: 80
url: /vi/net/aspose-psd-cho-net-23-5-ghi-chu-phat-hanh/
---

{{% alert color="primary" %}}

Trang này chứa các ghi chú phát hành cho [Aspose.PSD cho .NET 23.5](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Khóa**     | **Tóm tắt**                                                                | **Danh mục** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDNET-343  | Hỗ trợ Bộ lọc: Sắc nét -> Sắc nét                                      | Tính năng      |
| PSDNET-1179 | Lưu tệp PSD (RGB/8bit hoặc RGB/16bit) mà không có lớp vào 32bit            | Tính năng      |
| PSDNET-1408 | Thực hiện xử lý đối tượng đường dẫn từ tài nguyên vsms hoặc vmsk cho ShapeLayer | Tính năng      |
| PSDNET-1508 | Thêm ảnh hưởng của các điểm lưới lên nhau                             | Tính năng      |
...
**PSDNET-343. Hỗ trợ Bộ lọc: Sắc nét -> Sắc nét**
...
**PSDNET-1179. Lưu tệp PSD (RGB/8bit hoặc RGB/16bit) mà không có lớp vào 32bit**
...
**PSDNET-1408. Thực hiện xử lý đối tượng đường dẫn từ tài nguyên vsms hoặc vmsk cho ShapeLayer**
...
using (PsdImage image = (PsdImage)Image.Load(srcFile, new PsdLoadOptions { LoadEffectsResource = true }))
{
    ...
    // Lưu dữ liệu đã thay đổi vào tài nguồn
...
// Kiểm tra giá trị đã thay đổi trong tệp đã lưu
using (PsdImage image = (PsdImage)Image.Load(outFile, new PsdLoadOptions { LoadEffectsResource = true }))
{
    ...
    // Tệp đã lưu nên có 1 hình dạng
    AssertAreEqual(1, shapes.Count);
}
{{< /highlight >}}

**PSDNET-1508. Thêm ảnh hưởng của các điểm lưới lên nhau**
