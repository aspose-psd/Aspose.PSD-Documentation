---
title: Aspose.PSD cho .NET 19.2 - Ghi chú Phát hành
type: docs
weight: 110
url: /vi/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

Trang này chứa các ghi chú phát hành cho Aspose.PSD cho .NET 19.2

{{% /alert %}} 

|**Khóa**|**Tóm tắt**|**Danh mục**|
| :- | :- | :- |
|PSDNET-97|Thêm hỗ trợ lớp Fill: Fill màu|Tính năng|
|PSDNET-98|Thêm hỗ trợ lớp Fill: Fill gradient|Tính năng|
|PSDNET-105|Hỗ trợ GdFlResource|Tính năng|
|PSDNET-106|Hỗ trợ VmskResource|Tính năng|
|PSDNET-109|Chuyển của nguồn của Aspose.Imaging thực tế sang Aspose.PSD|Nâng cấp|
|PSDNET-92|Thêm hỗ trợ tải một phần cho một số phương thức|Nâng cấp|
|PSDNET-110|Hiệu suất PSD giảm một số lần|Lỗi|
