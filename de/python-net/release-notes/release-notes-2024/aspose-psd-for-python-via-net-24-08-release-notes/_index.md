---
title: Aspose.PSD für Python via .NET 24.8 - Versionshinweise
type: docs
weight: 10
url: /de/python-net/aspose-psd-fur-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

Diese Seite enthält Versionshinweise für [Aspose.PSD für Python via .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Schlüssel** | **Zusammenfassung**                                                                                                       | **Kategorie** |
|:-------------|:------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [AI-Format] Hinzufügen der Behandlung für XObject-Gruppen                                                        | Verbesserung  |
| PSDPYTHON-82 | Verbessern der Verzerrungstransformationen durch Hinzufügen von WarpSettings für TextLayer und SmartObjectLayer | Feature      |
| PSDPYTHON-83 | [AI-Format] Behandeln von Ebenen in Inhaltstreams-Operatoren                                             | Feature      |
| PSDPYTHON-84 | Das Renderingergebnis der AI-Datei unterscheidet sich erheblich von den Illustratorergebnissen               | Fehler          |
| PSDPYTHON-85 | Neu verknüpftes Smartobjekt wird nicht auf alle Smartobjekte in der PSD-Datei angewendet                                  | Fehler          |
...
**PSDPYTHON-81. [AI-Format] Hinzufügen der Behandlung für XObject-Gruppen**
{{< highlight python >}}
#Kein Beispiel. Es handelt sich um eine interne Verbesserung
{{< /highlight >}}

**PSDPYTHON-82. Verbessern der Verzerrungstransformationen durch Hinzufügen von WarpSettings für TextLayer und SmartObjectLayer**
{{< highlight python >}}
...
**PSDPYTHON-83. [AI-Format] Behandeln von Ebenen in Inhaltsteuerungsoperatoren**
{{< highlight python >}}
...
**PSDPYTHON-84. Das Renderingergebnis der AI-Datei unterscheidet sich erheblich von den Illustratorergebnissen**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. Neu verknüpftes Smartobjekt wird nicht auf alle Smartobjekte in der PSD-Datei angewendet**
{{< highlight python >}}
