---
title: Aspose.PSD für .NET 19.7 - Versionshinweise
type: docs
weight: 60
url: /de/net/aspose-psd-fur-net-19-7-versionshinweise/
---

{{% alert color="primary" %}}

Diese Seite enthält Versionshinweise für [Aspose.PSD für .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDNET-126|Unterstützung der Verarbeitung von Ebenevektor-Masken|Feature|
|PSDNET-130|Implementierung der korrekten Resize-Methode für PSD-Dateien|Feature|
|PSDNET-165|Hinzufügen der Unterstützung für den Export von PSD in PDF|Feature|
|PSDNET-186|Hinzufügen der Unterstützung für den Export von AI-Format (Version 2 und 3) in andere Formate|Feature|
...
**PSDNET-126. Unterstützung der Verarbeitung von Ebenevektor-Masken**
...
{{< highlight java >}}
...

            {
                ...
                // Änderungen an den Vektorepfadpunkten vornehmen
...
**PSDNET-130. Implementierung der korrekten Resize-Methode für PSD-Dateien**

{{< highlight java >}}

              // Implementierung der korrekten Resize-Methode für PSD-Dateien.
...
**PSDNET-165. Hinzufügen der Unterstützung für den Export von PSD in PDF**

{{< highlight java >}}

   // Hinzufügen der Unterstützung für den PSD-Export in PDF
...
**PSDNET-186. Hinzufügen der Unterstützung für den Export von AI-Format (Version 2 und 3) in andere Formate**

{{< highlight java >}}

 // Hinzufügen der Unterstützung für den Export von AI-Format (Version 2 und 3) in andere Formate
