---
title: Aspose.PSD für .NET 19.6 - Versionshinweise
type: docs
weight: 70
url: /de/net/aspose-psd-fur-net-19-6-versionshinweise/
---

{{% alert color="primary" %}} 

Diese Seite enthält Versionshinweise für [Aspose.PSD für .NET 19.6](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDNET-127|Möglichkeit zur Konvertierung von PSD-Datei in PSB und umgekehrt|Funktion|
|PSDNET-154|Portierung der Aspose.Imaging 19.5-Quellen zu Aspose.PSD|Verbesserung|
|PSDNET-155|Bereinigung der öffentlichen API im Zusammenhang mit Aspose.PSD|Verbesserung|
|PSDNET-159|Entfernen der Eigenschaft IsLicensed|Verbesserung|
|PSDNET-102|Die Konvertierung von PSB zu JPG hängt|Fehler|
|PSDNET-150|Die Position der neu hinzugefügten Textebene verschiebt sich beim Bearbeiten in Photoshop|Fehler|
...
- P:Aspose.PSD.FileFormats.Gif.Blocks.GifPlainTextRenderingBlock.TextGridWidth- P:Aspose.PSD.FileFormats.Gif.Blocks.GifPlainTextRenderingBlock.TextGridHeight
...
- F:Aspose.PSD.FileFormats.Gif.DisposalMethod.Previu