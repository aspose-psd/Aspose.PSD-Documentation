---
title: Aspose.PSD für .NET 24.4 - Versionshinweise
type: docs
weight: 90
url: /de/net/aspose-psd-fuer-net-24-4-versionshinweise/
---

{{% alert color="primary" %}}

Diese Seite enthält Versionshinweise für [Aspose.PSD für .NET 24.4](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Schlüssel** | **Zusammenfassung**                                       | **Kategorie** |
|:-------------|:---------------------------------------------------------|:-------------|
| PSDNET-1871  | [AI-Format] Hinzufügen der XObjectForm-Ressourcenverarbeitung | Feature      |
| PSDNET-1961  | Hinzufügen eines Konstruktors für das ShapeLayer           | Feature      |
| PSDNET-1879  | Beheben der Konvertierung einer Psd-Datei von RGB zu CMYK | Bug          |
| PSDNET-1966  | Bestimmte PSD-Datei kann nicht mit Aspose.PSD exportiert werden | Bug          |
...
**PSDNET-1871. [AI-Format] Hinzufügen der XObjectForm-Ressourcenverarbeitung**
...
**PSDNET-1879. Beheben der Konvertierung einer Psd-Datei von RGB zu CMYK**

{{< highlight csharp >}}
// Überprüfen, ob die Psd-Datei, die von RGB zu CMYK konvertiert wurde, wirklich 4 Kanäle hat und HasTransparencyData == false ist.
...
**PSDNET-1961. Hinzufügen eines Konstruktors für das ShapeLayer**
...
using (PsdImage image = (PsdImage)Image.Load(outputFile))
{
    ...
    AssertAreEqual(3, shapeLayer.Path.GetItems()[0].GetItems().Length); // 3 Knoten in einer Form
...
**PSDNET-1966. Bestimmte PSD-Datei kann nicht mit Aspose.PSD exportiert werden**
