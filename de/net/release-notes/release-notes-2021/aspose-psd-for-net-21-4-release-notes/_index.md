---
title: Aspose.PSD für .NET 21.4 - Versionshinweise
type: docs
weight: 90
url: /de/net/aspose-psd-fur-net-21-4-versionshinweise/
---

{{% alert color="primary" %}} 

Diese Seite enthält Versionshinweise für [Aspose.PSD für .NET 21.4](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDNET-259|Rendering des Musteroverlay-Layereffekts|Feature|
|PSDNET-861|Unbekannte Vogk-Ressourceneigenschaften hinzufügen, um das Ändern der Formebenen mit Vektorpfaden in einer PSD-Bilddatei zu unterstützen|Feature|
|PSDNET-90|PSD nicht ordnungsgemäß in PDF konvertiert|Fehler|
|PSDNET-830|Ausnahme beim Speichern der spezifischen PSD-Datei mit Textebenen|Fehler| (Früher behoben)
...
**PSDNET-90. PSD nicht ordnungsgemäß in PDF konvertiert**
...
**PSDNET-259. Rendering des Musteroverlay-Layereffekts**
...
**PSDNET-861. Unbekannte Vogk-Ressourceneigenschaften hinzufügen, um das Ändern der Formebenen mit Vektorpfaden in einer PSD-Bilddatei zu unterstützen**

{{< highlight csharp >}}
            // Dieses Beispiel zeigt, wie die neuen Transform- und OriginBoxCorners-Eigenschaften
            // der ShapeOriginSettings des Vogk-Ressourcenfüllungslayers in der PSD-Datei abgerufen und festgelegt werden
            ...
            using (PsdImage image = (PsdImage)Image.Load(sourceFileName)) 
            {
                ...
                // Überprüfen neuer Eigenschaften
                ...
                // Diese PSD-Bilddatei mit geänderten Eigenschaften speichern
                image.Save(outputPath, new PsdOptions(image));
            }

            // Laden der gespeicherten PSD-Bilddatei mit geänderten Eigenschaften
            using (PsdImage image = (PsdImage)Image.Load(outputPath))
            {
                ...
                // Überprüfen, ob Eigenschaften richtig gespeichert und geladen wurden
                var setting = resource.ShapeOriginSettings[0];
                AssertAreEqual(true, setting.IsOriginIndexPresent);
                AssertAreEqual(false, setting.IsShapeInvalidatedPresent);
                AssertAreEqual(true, setting.IsOriginResolutionPresent);
            ...
            VogkResource GetVogkResource(FillLayer layer)
            {
                if (layer == null)
                {
                    throw new PsdImageArgumentException("Der Parameter layer darf nicht null sein.");
                }
                ...
                if (resource == null)
                {
                    throw new PsdImageException("VogkResource nicht gefunden.");
                }
            ...
            void AssertAreEqual(object actual, object expected)
            {
                ...
                {
                    throw new FormatException(string.Format("Der tatsächliche Wert {0} entspricht nicht dem erwarteten {1}.", actual, expected));
                }
            }
{{< /highlight >}}