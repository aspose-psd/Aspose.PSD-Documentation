---
title: Aspose.PSD für .NET 20.12 - Versionshinweise
type: docs
weight: 10
url: /de/net/aspose-psd-fur-net-20-12-release-notes/
---

{{% alert color="primary" %}} 

Diese Seite enthält Versionshinweise für [Aspose.PSD für .NET 20.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDNET-757|Unterstützung beim Konvertieren von Ebenen in Smart Object Layer|Funktion|
|PSDNET-764|SmartObjectLayer.ReplaceContents-Methode wirft NullReferenceException, wenn wir versuchen, eine PSB-Datei hinzuzufügen|Fehler|
|PSDNET-773|Fehlerhafte Darstellung von CMYK 8-Bit- und CMYK 16-Bit-Bildern, wenn die Ebene größer als die Leinwand ist|Fehler|
|PSDNET-782|Gespeicherte PSB-Datei kann mit unserer API geöffnet werden, jedoch nicht mit Photoshop|Fehler|
|PSDNET-783|Beim Versuch, eine Smart Layer in einer bestimmten PSD-Datei mit gemeinsamem Datenquellenzugriff zu ändern, tritt eine Ausnahme auf|Fehler|
|PSDNET-172|Umbenennung von FileFormatVersion in PsdVersion, um Verwechslungen zu vermeiden|Verbesserung|
|PSDNET-620|Entfernen der Compact-Framework-Konfiguration aus Aspose.PSD .NET|Verbesserung|
|PSDNET-765|PsdImageException: Unbekannter Ressourcenheader beim Versuch, eine PSB-Datei mit SmartObjectLayers zu öffnen|Verbesserung|
|PSDNET-798|Verschieben der Hierarchie der Vektormaskenklassen in den Core-Namespace, um die Einheitlichkeit der Aspose.PSD- und Aspose.Imaging-Produkte sicherzustellen|Verbesserung|
...
- F:Aspose.PSD.FileFormats.Psd.Layers.Bl