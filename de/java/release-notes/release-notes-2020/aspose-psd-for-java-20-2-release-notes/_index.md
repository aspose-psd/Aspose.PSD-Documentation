---
title: Aspose.PSD für Java 20.2 - Versionshinweise
type: docs
weight: 20
url: /de/java/aspose-psd-für-java-20-2-versionshinweise/
---

{{% alert color="primary" %}} Diese Seite enthält Versionshinweise für [Aspose.PSD für Java 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-für-java-20.2/) {{% /alert %}} 

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDJAVA-96|Verbesserung der Fähigkeit, Text in Textebene mit verschiedenen Farben zu rendern|Funktion|
|PSDJAVA-97|Unterstützung des clbl-Ressource (Ressource der Ebene enthält Informationen über überblendende Elemente)|Funktion|
|PSDJAVA-100|Unterstützung der blwh-Ressource (Ressource enthält Daten zur Schwarz-Weiß-Anpassungsschicht)|Funktion|
|PSDJAVA-101|Möglichkeit, eine Ebenengruppe nach Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf zu exportieren|Funktion|
|PSDJAVA-105|Unterstützung der lspf-Ressource (Enthält Einstellungen zur Ebenen-Schutzeinstellung)|Funktion|
|PSDJAVA-106|Unterstützung der infx-Ressource (Enthält Daten zum Mischen von inneren Elementen)|Funktion|
|PSDJAVA-99|Refactoring von PsdImage und Layer zur Änderung des Transformationsverhaltens (Korrekte Größenänderung/Drehung/Ausschnitt für Ebenenmasken, wenn eine Ebene getrennt transformiert wird)|Verbesserung|
|PSDJAVA-98|Unter bestimmten Globalisierungseinstellungen kann eine AI-Bildrasterdatei nicht geöffnet werden|Fehler|
|PSDJAVA-102|Nach Durchführung der FlipRotate-Operation auf der Ebene wird das PSD-Bild unleserlich|Fehler|
|PSDJAVA-103|ArgumentException beim Laden der PSD-Datei|Fehler|
|PSDJAVA-104|Nach Verwendung einer Transformationsmethode für eine Ebene nur, hat die gespeicherte Ebene falsche Grenzen oder eine Maske|Fehler|

# **Änderungen an der öffentlichen API**
# **Diese API ist vorübergehend deaktiviert und wird im nächsten Release aktiviert:**
...
` `**Bitte verwenden Sie in der Zwischenzeit v19.4, wenn Sie eine entsprechende Abhängigkeit haben.**
# **Hinzugefügte APIs:**
...
- M:com.aspose.psd.fileformats.psd.layers.layerresources