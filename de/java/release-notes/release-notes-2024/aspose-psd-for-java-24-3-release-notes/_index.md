---
title: Aspose.PSD für Java 24.3 - Versionshinweise
type: docs
weight: 40
url: /de/java/aspose-psd-fur-java-24-3-versionshinweise/
---

{{% alert color="primary" %}} Diese Seite enthält Versionshinweise für [Aspose.PSD für Java 24.3](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.3/) {{% /alert %}}

| **Schlüssel** | **Zusammenfassung**                                                         | **Kategorie** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDJAVA-601 | [AI-Format] Reduzieren Sie die Ladezeit von großen mehrseitigen AI-Bildern. | Verbesserung  |
| PSDJAVA-604 | PSD-Datei nach der Konvertierung von 8 Bit auf 16 Bit wurde unlesbar.       | Fehler        |
| PSDJAVA-605 | PSD-Datei nach der Konvertierung von 8 Bit auf 32 Bit wurde unlesbar.       | Fehler        |
| PSDJAVA-606 | [AI-Format] Beheben Sie die Kurvenrasterung in der AI-Datei.                | Fehler        |
...
**PSDJAVA-604. PSD-Datei nach der Konvertierung von 8 Bit auf 16 Bit wurde unlesbar**
...
**PSDJAVA-605. PSD-Datei nach der Konvertierung von 8 Bit auf 32 Bit wurde unlesbar**
...
**PSDJAVA-606. [AI-Format] Beheben der Kurvenrasterung in der AI-Datei**
