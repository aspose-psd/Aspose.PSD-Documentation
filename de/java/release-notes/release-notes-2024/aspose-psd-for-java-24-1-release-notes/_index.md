---
title: Aspose.PSD für Java 24.1 - Versionshinweise
type: docs
weight: 40
url: /de/java/aspose-psd-fur-java-24-1-versionshinweise/
---

{{% alert color="primary" %}} Diese Seite enthält Versionshinweise für [Aspose.PSD für Java 24.1](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-fur-java-24.1/) {{% /alert %}}

| **Schlüssel** | **Zusammenfassung**                                                                       | **Kategorie** |
|:------------|:-----------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-576 | [AI-Format] Hinzufügen grundlegender Handhabungsmöglichkeiten für mehrseitige AI-Bilder.    | Feature      |
| PSDJAVA-579 | Warpeffekt für Text wird nicht angewendet.                                                  | Fehler       |
| PSDJAVA-580 | Inkorrekte Darstellung von Masken in einer bestimmten Datei.                                  | Fehler       |
| PSDJAVA-581 | NullReferenceException in Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor.| Fehler       |
| PSDJAVA-582 | [AI-Format] Beheben der Speichernutzung in AiExporterUtils.                                   | Fehler       |
...
**PSDJAVA-576. [AI-Format] Hinzufügen grundlegender Handhabungsmöglichkeiten für mehrseitige AI-Bilder**
...
{{< highlight java >}}
        ...
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // Standardmäßig ist die ActivePageIndex 0.
            // Wenn Sie das AI-Bild ohne Änderung dieser Eigenschaft speichern, wird die erste Seite gerendert und gespeichert.
            image.save(firstPageOutputPng, new PngOptions());

            // Ändern des aktiven Seitenindex auf die zweite Seite.
            image.setActivePageIndex(1);

            // Speichern der zweiten Seite des AI-Bildes als PNG-Bild.
            image.save(secondPageOutputPng, new PngOptions());

            // Ändern des aktiven Seitenindex auf die dritte Seite.
            image.setActivePageIndex(2);

            // Speichern der dritten Seite des AI-Bildes als PNG-Bild.
            image.save(thirdPageOutputPng, new PngOptions());
        }

{{< /highlight >}}

**PSDJAVA-579. Warpeffekt für Text wird nicht angewendet**
...
**PSDJAVA-580. Inkorrekte Darstellung von Masken in einer spezifischen Datei**
...
**PSDJAVA-582. [AI-Format] Beheben der Speichernutzung in AiExporterUtils**
...
{{< highlight java >}}
        ...
        // Laden des AI-Bildes.
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // Speichern der ersten Seite des AI-Bildes als PNG-Bild.
            image.save(firstPageOutputPng, new PngOptions());
        ...
        if (memoryUsed > MemoryLimit) {
            throw new RuntimeException("Die Speichernutzung ist zu hoch. " + memoryUsed + " anstatt von " + String.format("%.1f", MemoryLimit));
        }
