---
title: Aspose.PSD for Java 23.4 - Versionshinweise
type: docs
weight: 40
url: /de/java/aspose-psd-for-java-23-4-release-notes/
---

{{% alert color="primary" %}} Diese Seite enthält Versionshinweise für [Aspose.PSD für Java 23.4](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.4/) {{% /alert %}}

|**Schlüssel**|**Zusammenfassung**|**Kategorie**|
| :- | :- | :- |
|PSDJAVA-446|Port fehlender Funktionalität von Aspose.PSD für .Net zu Aspose.PSD für Java|Verbesserung|
|PSDJAVA-441|Entwurf der RawColor-Klasse für die öffentliche API zur Verwendung in der PSD-API anstelle des veralteten Color-Structs|Verbesserung|
|PSDJAVA-418|Integration der modernen Aspose-Lizenz für Aspose.PSD|Verbesserung|
|PSDJAVA-445|Formatierung verschiebt sich beim Bearbeiten in Photoshop|Fehler|
|PSDJAVA-443|Textbearbeitung mit Textabschnitten speichert kein korrektes Ergebnis|Fehler|
|PSDJAVA-444|Der Anfang und das Ende der Stile oder Absätze erscheinen am falschen Ort bei der Bearbeitung der Textebene durch ITextPortion|Fehler|
...
- M:com.aspose.preformats.psd.FontSettings.removeFontsFolder(java.lang.String)
...
- M:com.aspose.psd.fileformats.psd.layers.layerresources.PattResource.setName(java