---
title: Aspose.PSD עבור פייתון דרך .NET 24.8 - הערות לגרסה
type: docs
weight: 10
url: /he/python-net/aspose-psd-for-python-via-net-24-8-release-notes/
---

{{% alert color="primary" %}}

דף זה מכיל הערות לגרסה ל-[Aspose.PSD עבור פייתון דרך .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **מפתח**     | **סיכום**                                                                                                         | **קטגוריה** |
|:-------------|:------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDPYTHON-81 | [פורמט AI] הוספת טיפול לקבוצות XObject                                                        | שיפור  |
| PSDPYTHON-82 | שיפור אפשרויות ההתמוטטות על ידי הוספת WarpSettings לשכבת טקסט ולשכבת SmartObject               | יכולת חדשה      |
| PSDPYTHON-83 | [פורמט AI] טיפול בשכבות במפעילי תוכן של זרם תוכן                                             | יכולת חדשה      |
| PSDPYTHON-84 | תוצאת העברה של קובץ AI שונה מאוד בהשוואה עם תוצאות Illustrator               | באג          |
| PSDPYTHON-85 | חיבור מחדש של Smart Object לא מיישם את כל ה-Smart Object בקובץ PSD                                  | באג          |
...
**PSDPYTHON-81. [פורמט AI] הוספת טיפול לקבוצות XObject**
{{< highlight python >}}
#אין דוגמה. זה שיפור פנימי
{{< /highlight >}}

**PSDPYTHON-82. שיפור אפשרויות ההתמוטטות על ידי הוספת WarpSettings לשכבת טקסט ולשכבת SmartObject**
{{< highlight python >}}
