---
title: התעדכונים של Aspose.PSD עבור .NET 20.10
type: docs
weight: 30
url: /he/net/aspose-psd-for-net-20-10-release-notes/
---

{{% alert color="primary" %}} 

דף זה מכיל את רשימות השחרור עבור [Aspose.PSD עבור .NET 20.10](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**מפתח**|**סיכום**|**קטגוריה**|
| :- | :- | :- |
|PSDNET-565|חריגה בעת שמירת קובץ PSD ספציפי עם שכבות טקסט|תיקון|
|PSDNET-680|הגופנים אבודים לאחר מעגלים עם Aspose.PSD|תיקון|
|PSDNET-704|עיבוד של שכבת אובייקט חכם|תכונה|
|PSDNET-707|תמיכה בהפוך המרה בשכבת אובייקט חכם|תכונה|
|PSDNET-711|הזזת שכבת טקסט לאחר שמירה ללא שינויים|תיקון|
|PSDNET-720|Aspose.PSD 20.8: חריגת המרה מ- Psd ל- Tiff|תיקון|
...
## **דוגמאות שימוש:**
**PSDNET-565. חריגה בעת שמירת קובץ PSD מסוים עם שכבות טקסט**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-680. הגופנים אבודים לאחר מעגלים עם Aspose.PSD**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-704. עיבוד של שכבת אובייקט חכם**
{{< highlight csharp >}}
...
{{< /highlight >}}
**PSDNET-707. תמיכה בהפוך המרה בשכבת אובייקט חכם**
{{< highlight csharp >}}
