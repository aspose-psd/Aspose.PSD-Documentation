---
title: הערות שחרור Aspose.PSD עבור .NET 19.7
type: מסמך
weight: 60
url: /he/net/aspose-psd-for-net-19-7-release-notes/
---

{{% alert color="primary" %}} 

דף זה מכיל את ההערות לגרסה של [Aspose.PSD עבור .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**מפתח**|**סיכום**|**קטגוריה**|
| :- | :- | :- |
|PSDNET-126|תמיכה בעיבוד מיסכות וקטוריות של שכבות|תכונה|
|PSDNET-130|מימוש שיטת שינוי גודל נכונה עבור קבצי PSD|תכונה|
|PSDNET-165|הוספת תמיכה בייצוא של PSD ל- PDF|תכונה|
|PSDNET-186|הוספת תמיכה בייצוא לפורמט AI (גרסה 2 ו- 3) לפורמטים אחרים|תכונה|

## **שינויים בממשק הציבורי**
# **APIs שנוספו:**
...
## **דוגמאות שימוש:**
**PSDNET-126. תמיכה בעיבוד מיסכות וקטוריות של שכבות**
...
**PSDNET-130. מימוש שיטת שינוי גודל נכונה עבור קבצי PSD**

{{< highlight java >}}

              // מימוש שיטת שינוי גודל נכונה עבור קבצי PSD.
...
**PSDNET-165. הוספת תמיכה בייצוא של PSD ל- PDF**

{{< highlight java >}}

   // הוספת תמיכה בייצוא של PSD ל- PDF
...
**PSDNET-186. הוספת תמיכה בייצוא לפורמט AI (גרסה 2 ו- 3) לפורמטים אחרים**

{{< highlight java >}}

 // הוספת תמיכה בייצוא לפורמט AI (גרסה 2 ו- 3) לפורמטים אחרים
