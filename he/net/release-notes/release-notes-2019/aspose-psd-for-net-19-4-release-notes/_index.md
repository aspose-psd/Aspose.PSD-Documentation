---
title: Aspose.PSD for .NET 19.4 - הערות שחרור
type: docs
weight: 90
url: /he/net/aspose-psd-for-net-19-4-release-notes/
---

{{% alert color="primary" %}} 

דף זה מכיל את הערות השחרור של Aspose.PSD for .NET 19.4

{{% /alert %}} 

|**מפתח**|**סיכום**|**קטגוריה**|
| :- | :- | :- |
|PSDNET-87|יצירת תכונה לטעינת קבצי תמונה JPEG/PNG וכו' ל-PsdImage ללא טעינה ישירה (שאינה נתמכת ב-Aspose.PSD)|תכונה|
|PSDNET-120|תמיכה במצב צבע RGB עם 16 ביט לערוץ (64 ביט לצבע)|תכונה|
|PSDNET-108|תמיכה במסכי וקטור של שכבה ושכבת טקסט עם פליפ-סיבוב מותאם אישית|תכונה|
|PSDNET-99|כל התווים האסיאתיים אינם מוצגים כהלכה|תקלה|
|PSDNET-116|סמלי \r\n מפורשים כפסקת שורה כפולה שזו טעות|תקלה|
|PSDNET-117|אם עודכנה שכבת טקסט עם מחרוזת המכילה שבירות שורות, אז קובץ ה-PSD משתנה ללא אפשרות קריאה|תקלה|
|PSDNET-118|אם עודכנה שכבת טקסט עם מחרוזת המכילה סמלי טאב, העיבוד נכשל עם יוצא מן הכלל|תקלה|
...
## **דוגמאות שימוש:**
**PSDNET-87. יצירת תכונה לטעינת קבצי תמונה JPEG/PNG וכו' ל-PsdImage ללא טעינה ישירה (שאינה נתמכת ב-Aspose.PSD)**
...
**PSDNET-120. תמיכה במצב צבע RGB עם 16 ביט לערוץ (64 ביט לצבע)**

{{< highlight java >}}

  // תמיכה במצב צבע RGB עם 16 ביט לערוץ (64 ביט לצבע)
...
// קבצים חייבים להיפתח בלי חריגה ולהיות קריאים לפוטושופ    

using(Image image = Image.Load(outputFilePathPsd)) {}  

{{< /highlight >}}

**PSDNET-108. תמיכה במסכי וקטור של שכבה ושכבת טקסט עם פליפ-סיבוב מותאם אישית**

{{< highlight java >}}

 // פעולת פליפ-סיבוב לא עובדת כצפוי עם PSD
...
**PSDNET-99. כל התווים האסיאתיים אינם מוצגים כהלכה**

[**נא לבדוק את הדוגמא המצורפת**](attachments/86278147/86343681.cs)

**PSDNET-116. סמלי \r\n מפורשים כפסקת שורה כפולה שזו טעות**
