---
title: Aspose.PSD עבור .NET 19.2 - הערות הגרסה
type: docs
weight: 110
url: /he/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

דף זה מכיל הערות גרסה עבור Aspose.PSD עבור .NET 19.2

{{% /alert %}} 

|**מפתח**|**סיכום**|**קטגוריה**|
| :- | :- | :- |
|PSDNET-97|הוספת תמיכה בשכבות מילוי: מילוי צבע|תכונה|
|PSDNET-98|הוספת תמיכה בשכבות מילוי: מילוי הדרגה|תכונה|
|PSDNET-105|תמיכה ב- GdFlResource|תכונה|
|PSDNET-106|תמיכה ב- VmskResource|תכונה|
|PSDNET-109|העברת מקורות Aspose.Imaging הממשיים ל-Aspose.PSD|שיפור|
|PSDNET-92|הוספת תמיכה בטעינה חלקית לכמה שיטות|שיפור|
|PSDNET-110|ביצועים של PSD ירדו מספר פעמים|באג|
