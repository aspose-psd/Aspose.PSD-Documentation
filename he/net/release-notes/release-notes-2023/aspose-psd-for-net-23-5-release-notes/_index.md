---
title: Aspose.PSD עבור .NET 23.5 - הערות לגרסה
type: docs
weight: 80
url: /he/net/aspose-psd-%D7%A2%D7%91%D7%95%D7%A8-net-23-5-%D7%94%D7%A2%D7%A8%D7%95%D7%AA-%D7%9C%D7%92%D7%A8%D7%A1%D7%94/
---

{{% alert color="primary" %}}

דף זה מכיל הערות לגרסה של [Aspose.PSD עבור .NET 23.5](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **מפתח**     | **סיכום**                                                                | **קטגוריה** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDNET-343  | תמיכה במסנן: שחזור -> שחזור                                      | תכונה      |
| PSDNET-1179 | שמירת קובץ PSD (RGB/8 ביט או RGB/16 ביט) בלי שכבות ל-32 ביט            | תכונה      |
| PSDNET-1408 | טפסיסט טיפול באובייקטי נתיב ממשאבי vsms או vmsk עבור ShapeLayer | תכונה      |
| PSDNET-1508 | הוספת השפעת נקודות מש על כל נקודה אחרת                             | תכונה      |
...
**PSDNET-343. תמיכה במסנן: שחזור -> שחזור**
...
**PSDNET-1179. שמירת קובץ PSD (RGB/8 ביט או RGB/16 ביט) בלי שכבות ל-32 ביט**
...
**PSDNET-1408. טפסיסט טיפול באובייקטי נתיב ממשאבי vsms או vmsk עבור ShapeLayer**
...
void AssertAreEqual(object expected, object actual, string message = null)
{
    if (!object.Equals(expected, actual))
    {
        throw new Exception(message ?? "אובייקטים אינם שווים.");
    }
}
...
**PSDNET-1508. הוספת השפעת נקודות מש על כל נקודה אחרת**
