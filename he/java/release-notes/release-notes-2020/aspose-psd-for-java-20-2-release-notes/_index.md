---
title: הערות שחרור של Aspose.PSD עבור Java 20.2
type: מסמכים
weight: 20
url: /he/java/aspose-psd-for-java-20-2-release-notes/
---

{{% alert color="primary" %}} עמוד זה מכיל את הערות השחרור של [Aspose.PSD עבור Java 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) {{% /alert %}}  

|**Key**|**סיכום**|**קטגוריה**|
| :- | :- | :- |
|PSDJAVA-96|שיפור ביכולת לעדכן טקסטים בצבעים שונים בשכבת טקסט|תכונה|
|PSDJAVA-97|תמיכה במשאב clbl (משאב שכבה מכיל מידע על אלמנטי גירוס בלנד)|תכונה|
|PSDJAVA-100|תמיכה במשאב blwh (המשאב מכיל נתוני שכבת התאם לשחור וללבן)|תכונה|
|PSDJAVA-101|יכולת לייצא קבוצת שכבות ל-Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf|תכונה|
|PSDJAVA-105|תמיכה במשאב lspf (מכיל הגדרות בנושא הגנה של שכבה)|תכונה|
|PSDJAVA-106|תמיכה במשאב infx (מכיל מידע על מיזוג אלמנטים פנימיים)|תכונה|
|PSDJAVA-99|שיפור של PsdImage ושכבה לשינוי התנהגות ההמרה (גודל/סיבוב/חיתוך נכונים עבור מסכות שכבה אם אנו ממירים שכבה אחת בנפרד)|שדרוג|
|PSDJAVA-98|בכמה תצורות של גלובליזציה תמונת AI לא ניתן לפתוח|באג|
|PSDJAVA-102|לאחר ביצוע הפעולה FlipRotate על שכבה, התמונה בפורמט PSD מפסיקה להיות נקראת|באג|
|PSDJAVA-103|ArgumentException בעת טעינת קובץ PSD|באג|
|PSDJAVA-104|לאחר שימוש בשיטת המרה רק עבור שכבה, השכבה שמורה עם גבולות שגויים או מסכה|באג|

# **שינויים ב- API הציבורי**
# **תמנות זמניות ב-API הזה מושבתות ותהפוך מופעל בגרסה הבאה:**
...
` `**בבקשה להשתמש בגרסא 19.4 בינתיים אם יש תלות רלוונטית.**
