---
title: עדכוני הגרסה Aspose.PSD עבור Java 23.11
type: מסמכים
weight: 40
url: /he/java/aspose-psd-for-java-23-11-release-notes/
---

{{% alert color="primary" %}} עמוד זה מכיל את עדכוני הגרסה עבור [Aspose.PSD עבור Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) {{% /alert %}}

| **מפתח**      | **סיכום**                                                                                                | **קטגוריה** |
|:---------------|:-----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | תמיכה ב־LMskResource                                                                                    |    תכונה    |
| PSDJAVA-552    | [פורמט AI] הוספת אפשרות לעיבוד קובץ AI מבוסס PDF עם Aspose.PSD                                        |    תכונה    |
| PSDJAVA-553    | [פורמט AI] הוספת תמיכה באופרטור PostScript "cm"                                                       |    תכונה    |
| PSDJAVA-554    | הוספת סוגים חדשים של גלגול: גל, קליף למעלה, קליף למטה                                                          |    תכונה    |
| PSDJAVA-555    | הוספת תמיכה בגלגול אנכי                                                                                  |    תכונה    |
| PSDJAVA-556    | System.ArgumentNullException: 'ערך לא יכול להיות ריק. (פרמטר 'key')' בעת קריאה ל־TextLayer.GetFonts()  |      באג      |
...
** PSDJAVA-551. תמיכה ב־LMskResource**
...
** PSDJAVA-552. [פורמט AI] הוספת אפשרות לעיבוד קובץ AI מבוסס PDF עם Aspose.PSD**
...
** PSDJAVA-553. [פורמט AI] הוספת תמיכה באופרטור PostScript "cm"**
...
** PSDJAVA-554. הוספת סוגים חדשים של גלגול: גל, קליף למעלה, קליף למטה**
...
** PSDJAVA-555. הוספת תמיכה בגלגול אנכי**
...
** PSDJAVA-556. System.ArgumentNullException: 'ערך לא יכול להיות ריק. (פרמטר 'key')' בעת קריאה ל־TextLayer.GetFonts()**
