---
title: כאן-Aspose.PSD עבור Java 24.6 - הערות לשחרור
type: מסמכים
weight: 40
url: /he/java/aspose-psd-for-java-24-6-release-notes/
---

{{% alert color="primary" %}} דף זה מכיל הערות לשחרור עבור [Aspose.PSD for Java 24.6](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.6/) {{% /alert %}}

| **מפתח**    | **סיכום**                                                                                                      | **קטגוריה** |
|:------------|:-----------------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-628 | ליישם תמיכה בשכבת מפת צבעים                                                                         | יכולת       |
| PSDJAVA-629 | [פורמט AI] הוסף תמיכה במטא-נתונים של חבילת XPacket לפורמט AI                                            | יכולת       |
| PSDJAVA-630 | ליישם סוגי עקיבה Inflate, Squeeze, ו-Twist                                                                | יכולת       |
| PSDJAVA-631 | מצבי Rgb ו-Lab לא יכולים להכיל פחות מ-3 ערוצים ויותר מ-4 ערוצים בקובץ עם שכבות ArtBoard             | באג          |
| PSDJAVA-632 | אזור העיבוד העליון חייב להיות חיובי. (פרמטר 'areaToProcess') בעיבוד של קובץ ספציפי                   | באג          |
| PSDJAVA-633 | התמונה המורחבת מעל ללוח ניתכתה לאחר השמירה. הנתונים אבודים אך התצוגה נראית נכון	             | באג          |
...
**PSDJAVA-628. ליישם תמיכה בשכבת מפת צבעים**
...
**PSDJAVA-629. [פורמט AI] הוסף תמיכה במטא-נתונים של XPacket לפורמט AI**
...
{{< highlight java >}}
    ...
    static void assertIsNotNull(Object testObject) {
        if (testObject == null) {
            throw new RuntimeException("האובייקט בבדיקה הוא null.");
        }
    }

{{< /highlight >}}

**PSDJAVA-630. ליישם סוגי עקיבה Inflate, Squeeze, ו-Twist**
...
**PSDJAVA-631. מצבי Rgb ו-Lab לא יכולים להכיל פחות מ-3 ערוצים ויותר מ-4 ערוצים בקובץ עם שכבות ArtBoard**
...
{{< highlight java >}}
    ...
    try (PsdImage image = (PsdImage) Image.load(sourceFile)) {
        // אין צריך להיות חריג כאן
        image.save(outputFile);
    }

{{< /highlight >}}

**PSDJAVA-632. אזור העיבוד העליון חייב להיות חיובי. (פרמטר 'areaToProcess') בעיבוד של קובץ ספציפי**
...
{{< highlight java >}}
    ...
    try (PsdImage image = (PsdImage) PsdImage.load(sourceFile, psdLoadOptions)) {
        image.save(outputFile);
        // לא צריך להתרחש חריגה
    }

{{< /highlight >}}

**PSDJAVA-633. התמונה המורחבת מעל לקנבס נחתכת לאחר השמירה. הנתונים אבדו אך התצוגה נראית תקינה**
