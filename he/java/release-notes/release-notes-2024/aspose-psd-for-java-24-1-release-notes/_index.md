---
title: Aspose.PSD for Java 24.1 - תיקופות
type: docs
weight: 40
url: /he/java/aspose-psd-for-java-24-1-release-notes/
---

{{% alert color="primary" %}} הדף הזה מכיל את רשימות השחרור עבור [Aspose.PSD for Java 24.1](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.1/) {{% /alert %}}

| **מפתח**    | **סיכום**                                                                                   | **קטגוריה** |
|:------------|:-----------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-576 | [פורמט AI] הוספת טיפול בסיסי לתמונות AI מרובות עמודים.                                       | תכונה      |
| PSDJAVA-579 | אפקט טקסט מעוייף לא מיושם על הטקסט.                                                      | באג          |
| PSDJAVA-580 | תצוגה לא נכונה של מסכה בקובץ מסוים.                                                      | באג          |
| PSDJAVA-581 | NullReferenceException ב- Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor. | באג          |
| PSDJAVA-582 | [פורמט AI] תיקון שימוש בזיכרון ב- AiExporterUtils.                                           | באג          |

## **שינויים בממשק התכנות הציבורי**
# **APIs שנוספו:**
...
** PSDJAVA-576. [פורמט AI] הוספת טיפול בסיסי לתמונות AI מרובות עמודים**
...
{{< highlight java >}}
        ...
        try (AiImage image = (AiImage) Image.load(sourceFile)) {
            // כברירת מחדל, ActivePageIndex הוא 0.
            // לכן אם תעשה שמירה של תמונת ה-AI בלעדי שינוי מאפיין זה, הדף הראשון יתווצג וישמר.
            image.save(firstPageOutputPng, new PngOptions());

            // שנה את מספר העמוד הפעיל לעמוד השני.
            image.setActivePageIndex(1);

            // שמור את העמוד השני של תמונת ה-AI כתמונת PNG.
            image.save(secondPageOutputPng, new PngOptions());

            // שנה את מספר העמוד הפעיל לעמוד השלישי.
            image.setActivePageIndex(2);

            // שמור את העמוד השלישי של תמונת ה-AI כתמונת PNG.
            image.save(thirdPageOutputPng, new PngOptions());
        }

{{< /highlight >}}

** PSDJAVA-579. אפקט טקסט מעוייף לא מיושם על הטקסט**
...
** PSDJAVA-580. תצוגה לא נכונה של מסכה בקובץ מסוים**
...
** PSDJAVA-581. NullReferenceException ב- Aspose.PSD.FontParsing.OpenType.Serialization.OpenTypeFontInfo.ctor**
...
** PSDJAVA-582. [פורמט AI] תיקון שימוש בזיכרון ב- AiExporterUtils**

{{< highlight java >}}

        String sourceFile = "src/main/resources/threePages.ai";
        String firstPageOutputPng = "src/main/resources