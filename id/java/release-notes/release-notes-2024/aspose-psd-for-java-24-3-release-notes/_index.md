---
title: Catatan Rilis Aspose.PSD untuk Java 24.3
type: docs
weight: 40
url: /id/java/aspose-psd-for-java-24-3-release-notes/
---

{{% alert color="primary" %}} Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk Java 24.3](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.3/) {{% /alert %}}

| **Kunci**     | **Ringkasan**                                                              | **Kategori** |
|:------------|:---------------------------------------------------------------------------|:-------------|
| PSDJAVA-601 | [Format AI] Kurangi waktu pemuatan gambar AI multipage besar.              | Peningkatan  |
| PSDJAVA-604 | File PSD setelah dikonversi dari 8 bit ke 16 bit menjadi tidak bisa dibaca. | Bug          |
| PSDJAVA-605 | File PSD setelah dikonversi dari 8 bit ke 32 bit menjadi tidak bisa dibaca. | Bug          |
| PSDJAVA-606 | [Format AI] Perbaiki kurva pendek saat merender file AI.                   | Bug          |
...
**PSDJAVA-604. File PSD setelah dikonversi dari 8 bit ke 16 bit menjadi tidak bisa dibaca**
...
{{< highlight java >}}
        ...
        try (PsdImage psdImage16 = (PsdImage) Image.load(outputFile)) {
            if (psdImage16.getGlobalLayerResources()[0] instanceof Lr16Resource) {
                ...
                throw new Exception("Sumber daya global salah, sumber daya pertama harus menjadi Lr16Resource");
            }
        }

{{< /highlight >}}

**PSDJAVA-605. File PSD setelah dikonversi dari 8 bit ke 32 bit menjadi tidak bisa dibaca**
...
**PSDJAVA-606. [Format AI] Perbaiki kurva pendek saat merender file AI**
