---
title: Catatan Rilis Aspose.PSD untuk Java 24.8
type: docs
weight: 40
url: /id/java/aspose-psd-for-java-24-8-release-notes/
---

{{% alert color="primary" %}} Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) {{% /alert %}}

| **Kunci**   | **Ringkasan**                                                                                        | **Kategori** |
|:------------|:-----------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [Format AI] Tambah penanganan untuk Grup XObject                                                     | Peningkatan  |
| PSDJAVA-645 | Tingkatkan kemampuan transformasi Warp dengan menambahkan WarpSettings untuk TextLayer dan SmartObjectLayer | Fitur      |
| PSDJAVA-646 | [Format AI] Tangani lapisan dalam operator konten aliran                                             | Fitur        |
| PSDJAVA-647 | Hasil render dari file AI sangat berbeda dibandingkan dengan hasil Illustrator                       | Bug         |
| PSDJAVA-648 | Menghubungkan ulang Objek Pintar tidak berlaku untuk semua Objek Pintar dalam file PSD               | Bug         |
...
**PSDJAVA-645. Tingkatkan kemampuan transformasi Warp dengan menambahkan WarpSettings untuk TextLayer dan SmartObjectLayer**
...
**PSDJAVA-646. [AI Format] Tangani lapisan dalam operator aliran konten**
...
**PSDJAVA-647. Hasil rendering dari file AI sangat berbeda dibandingkan dengan hasil Illustrator**
...
**PSDJAVA-648. Menghubungkan ulang Objek Pintar tidak berlaku untuk semua Objek Pintar dalam file PSD**
        ...
        try (var image = (PsdImage) Image.load(sourceFile[i])) {
            for (Layer layer : image.getLayers()) {
                if (layer instanceof SmartObjectLayer) {
                    ...
                    // Untuk lapisan pintar kedua, terjadi kesalahan di sini
