```id
---
title: Catatan Rilis Aspose.PSD untuk Java 20.2
type: docs
weight: 20
url: /id/java/aspose-psd-for-java-20-2-release-notes/
---

{{% alert color="primary" %}} Halaman ini berisi catatan rilis untuk [Aspose.PSD for Java 20.2](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-20.2/) {{% /alert %}} 

|**Kunci**|**Ringkasan**|**Kategori**|
| :- | :- | :- |
|PSDJAVA-96|Peningkatan kemampuan merender teks berbagai warna dalam Lapisan Teks|Fitur|
|PSDJAVA-97|Dukungan untuk sumber daya clbl (Sumber daya lapisan berisi informasi tentang elemen penjepit campuran)|Fitur|
|PSDJAVA-100|Dukungan untuk sumber daya blwh (Sumber daya berisi Data Lapisan Penyesuaian Hitam & Putih)|Fitur|
|PSDJAVA-101|Kemampuan untuk mengekspor Grup Layer ke Jpeg/Png/Tiff/Gif/Bmp/Jpeg2000/Psd/Psb/Pdf|Fitur|
|PSDJAVA-105|Dukungan untuk sumber daya lspf (Mengandung pengaturan tentang pengaturan Proteksi Lapisan)|Fitur|
|PSDJAVA-106|Dukungan untuk sumber daya infx (Mengandung data tentang Pencampuran elemen interior)|Fitur|
|PSDJAVA-99|Refaktorisasi PsdImage dan Layer untuk mengubah perilaku Transformasi (Resize/Rotate/Crop yang benar untuk masker lapisan jika kita mengubah satu lapisan secara terpisah)|Peningkatan|
|PSDJAVA-98|Di beberapa pengaturan globalisasi, gambar raster AI tidak dapat dibuka|Bugs|
|PSDJAVA-102|Setelah melakukan operasi FlipRotate pada Layer, Gambar PSD menjadi tidak terbaca|Bugs|
|PSDJAVA-103|System.ArgumentException selama proses memuat file PSD|Bugs|
|PSDJAVA-104|Setelah menggunakan metode transformasi hanya untuk satu lapisan, lapisan yang disimpan memiliki batas atau masker yang salah|Bugs|

# **Perubahan API Publik**
# **API ini sementara dinonaktifkan dan akan diaktifkan kembali pada rilis berikutnya:**
...
` `**Sementara gunakan v19.4 jika Anda memiliki ketergantungan yang sesuai.**
# **API Ditambahkan:**
