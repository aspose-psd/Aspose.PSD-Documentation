---
title: Catatan Rilis Aspose.PSD untuk Java 23.11
type: docs
weight: 40
url: /id/java/aspose-psd-for-java-23-11-release-notes/
---

{{% alert color="primary" %}} Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk Java 23.11](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.11/) {{% /alert %}}

| **Kunci**       | **Ringkasan**                                                                                           | **Kategori** |
|:---------------|:----------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-551    | Dukungan LMskResource                                                                                   | Fitur       |
| PSDJAVA-552    | [Format AI] Menambahkan kemampuan untuk merender file AI berbasis PDF dengan Aspose.PSD                  | Fitur       |
| PSDJAVA-553    | [Format AI] Menambahkan dukungan untuk operator PostScript "cm"                                           | Fitur       |
| PSDJAVA-554    | Menambahkan tipe warp baru: Gelombang, kerang atas, kerang bawah                                         | Fitur       |
| PSDJAVA-555    | Menambahkan dukungan warp vertikal                                                                       | Fitur       |
| PSDJAVA-556    | System.ArgumentNullException: 'Nilai tidak boleh null. (Parameter 'kunci')' saat memanggil TextLayer.GetFonts() | Bug         |
...
** PSDJAVA-551. Dukungan LMskResource**
...
** PSDJAVA-552. [Format AI] Menambahkan kemampuan untuk merender file AI berbasis PDF dengan Aspose.PSD **
...
** PSDJAVA-553. [Format AI] Menambahkan dukungan untuk operator PostScript "cm" **
...
** PSDJAVA-554. Menambahkan tipe warp baru: Gelombang, kerang atas, kerang bawah **
...
** PSDJAVA-555. Menambahkan dukungan warp vertikal **
...
** PSDJAVA-556. System.ArgumentNullException: 'Nilai tidak boleh null. (Parameter 'kunci')' saat memanggil TextLayer.GetFonts() **
