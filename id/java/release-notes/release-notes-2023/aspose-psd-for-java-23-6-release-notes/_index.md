---
title: Catatan Rilis Aspose.PSD untuk Java 23.6
type: docs
weight: 40
url: /id/java/aspose-psd-for-java-23-6-release-notes/
---

{{% alert color="primary" %}} Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk Java 23.6](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-23.6/) {{% /alert %}}

| **Kunci**   | **Ringkasan**                                                                                                                                    | **Kategori** |
|:------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-479 | Memperbaiki TimeLine API                                                                                                                          | Peningkatan  |
| PSDJAVA-480 | Menghapus artefak saat merender distorsi                                                                                                          | Peningkatan  |
| PSDJAVA-481 | Optimisasi merender distorsi                                                                                                                      | Peningkatan  |
| PSDJAVA-482 | Dukungan untuk Lapisan Penyesuaian Ambang                                                                                                         | Fitur        |
| PSDJAVA-483 | Dukungan untuk Lapisan Penyesuaian Warna Selektif                                                                                                | Fitur        |
| PSDJAVA-484 | Kemampuan untuk mengekspor TimeLine PSD ke file Animated Gif                                                                                      | Fitur        |
| PSDJAVA-485 | Menambahkan dukungan untuk TextLayer tanpa batas persegi                                                                                        | Fitur        |
| PSDJAVA-486 | Dukungan untuk ShapeLayer                                                                                                                        | Fitur        |
| PSDJAVA-487 | Mengganti gambar dalam objek Cerdas tidak memperbarui                                                                                            | Bug          |
| PSDJAVA-488 | File PSD tidak dapat disimpan sebagai PSD dengan pengecualian berikut: Mode Rgb dan Lab tidak dapat berisi kurang dari 3 channel dan lebih dari 4 channel | Bug          |
| PSDJAVA-489 | Penjusitikan Teks hilang jika membuka TextLayer dengan mode edit Photoshop                                                                           | Bug          |
| PSDJAVA-490 | Pengecualian referensi nol saat menyimpan file PSD                                                                                               | Bug          |
| PSDJAVA-491 | Pengecualian pada pengambilan ShapeLayer: Titik untuk batas asal vektor tidak didukung belum                                                   | Bug          |
| PSDJAVA-492 | Pengecualian pada pengambilan VogkResource: Titik disimpan sebagai DoubleStructures, kami membaca sebagai UnitStructures                      | Bug          |
| PSDJAVA-493 | JenisLayer ShapeLayer kosong                                                                                                                    | Bug          |
...
**PSDJAVA-482. Dukungan untuk Lapisan Penyesuaian Ambang**
...
**PSDJAVA-483. Dukungan untuk Lapisan Penyesuaian Warna Selektif**
