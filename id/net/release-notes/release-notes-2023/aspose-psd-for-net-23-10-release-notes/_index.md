---
title: Catatan Rilis Aspose.PSD untuk .NET 23.10
type: docs
weight: 30
url: /id/net/aspose-psd-for-net-23-10-release-notes/
---

{{% alert color="primary" %}}

Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk .NET 23.10](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Kunci**   | **Ringkasan** | **Kategori** |
|:------------|:--------------|:------------|
| PSDNET-692  | Dukungan arah teks vertikal | Fitur |
| PSDNET-1402 | Gunakan pengaturan Stroke dari sumber vstk dalam penggambaran Stroke Bentuk | Fitur |
| PSDNET-1607 | Implementasikan penggambaran area internal dari Bentuk-garis Stroke | Fitur |
| PSDNET-1644 | Jangan menggambar ulang lapisan Bentuk jika tidak ada yang berubah | Fitur |
| PSDNET-1696 | [Format AI] Tambahkan dukungan untuk membaca Header dari File AI berbasis PDF | Fitur |
| PSDNET-1560 | Berbagai cara untuk mengatur Resolusi File Psd tidak berfungsi | Bug |
| PSDNET-1728 | FontSettings.SetFontsFolders tidak berfungsi atau Aspose.PSD menggunakan font yang salah | Bug |
| PSDNET-1739 | Regresi. Perbaiki pengecualian referensi Null yang muncul saat PsdImage.Save memiliki lapisan Bentuk | Bug |
...
**PSDNET-692. Dukungan arah teks vertikal**
...
**PSDNET-1402. Gunakan pengaturan Stroke dari sumber vstk dalam penggambaran Stroke Bentuk**
...
**PSDNET-1607. Implementasikan penggambaran area internal dari Bentuk-garis Stroke**
...
**PSDNET-1644. Jangan menggambar ulang lapisan Bentuk jika tidak ada yang berubah**
...
using (PsdImage image = (PsdImage)Image.Load(sourceFile))
{
    ...
    // Jangan gunakan update lapisan Bentuk sebelum menyimpan

    image.Save(outputFile);

    // Periksa hasil penyimpanan file
}
...
**PSDNET-1696. [Format AI] Tambahkan dukungan untuk membaca Header dari File AI berbasis PDF**
...
void AssertIsNotNull(object expected)
{
    if (expected == null)
    {
        throw new Exception("Objek null.");
    }
}
...
**PSDNET-1560. Berbagai cara untuk mengatur Resolusi File Psd tidak berfungsi**
...
**PSDNET-1728. FontSettings.SetFontsFolders tidak berfungsi atau Aspose.PSD menggunakan font yang salah**
...
**PSDNET-1739. Regresi. Perbaiki pengecualian referensi Null yang muncul saat PsdImage.Save memiliki lapisan Bentuk**
...
{
    // Seharusnya dapat dimuat tanpa pengecualian

    ShapeLayer shapeLayer = (ShapeLayer)im.Layers[1];

    if (shapeLayer.RawDataSettings == null)
    {
        throw new Exception("RawDataSettings seharusnya tidak null.");
    }
}
{{< /highlight >}}