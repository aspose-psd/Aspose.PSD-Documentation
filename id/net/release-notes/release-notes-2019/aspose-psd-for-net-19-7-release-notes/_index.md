---
title: Catatan Rilis Aspose.PSD for .NET 19.7
type: docs
weight: 60
url: /id/net/aspose-psd-for-net-19-7-release-notes/
---

{{% alert color="primary" %}} 

Halaman ini berisi catatan rilis untuk [Aspose.PSD for .NET 19.7](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Kunci**|**Ringkasan**|**Kategori**|
| :- | :- | :- |
|PSDNET-126|Dukungan pemrosesan Masker Vektor Layer|Fitur|
|PSDNET-130|Melaksanakan metode Resize yang tepat untuk file PSD|Fitur|
|PSDNET-165|Menambahkan dukungan untuk mengekspor PSD ke PDF|Fitur|
|PSDNET-186|Menambahkan dukungan untuk mengekspor format AI (Versi 2 dan 3) ke format lain|Fitur|
...
## **Contoh Penggunaan:**
**PSDNET-126. Dukungan pemrosesan Masker Vektor Layer**
...
{{< highlight java >}}
...

            {
                ...
                // melakukan perubahan pada titik jalur vektor
...
**PSDNET-130. Melaksanakan metode Resize yang tepat untuk file PSD**

{{< highlight java >}}

              // Melaksanakan metode Resize yang tepat untuk file PSD.
...
**PSDNET-165. Menambahkan dukungan untuk mengekspor PSD ke PDF**

{{< highlight java >}}

   // Menambahkan dukungan untuk mengekspor PSD ke PDF
...
**PSDNET-186. Menambahkan dukungan untuk mengekspor format AI (Versi 2 dan 3) ke format lain**

{{< highlight java >}}

 // Menambahkan dukungan untuk mengekspor format AI (Versi 2 dan 3) ke format lain
