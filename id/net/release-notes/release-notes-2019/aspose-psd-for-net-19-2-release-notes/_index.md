---
title: Catatan Rilis Aspose.PSD untuk .NET 19.2
type: docs
weight: 110
url: /id/net/aspose-psd-for-net-19-2-release-notes/
---

{{% alert color="primary" %}} 

Halaman ini berisi catatan rilis Aspose.PSD untuk .NET 19.2

{{% /alert %}} 

|**Kunci**|**Ringkasan**|**Kategori**|
| :- | :- | :- |
|PSDNET-97|Menambahkan dukungan untuk lapisan Isi: Isian warna|Fitur|
|PSDNET-98|Menambahkan dukungan untuk lapisan Isi: Isian gradasi|Fitur|
|PSDNET-105|Dukungan GdFlResource|Fitur|
|PSDNET-106|Dukungan VmskResource|Fitur|
|PSDNET-109|Mengimpor sumber Aspose.Imaging sesungguhnya ke Aspose.PSD|Peningkatan|
|PSDNET-92|Menambahkan dukungan pemuatan parsial untuk beberapa metode|Peningkatan|
|PSDNET-110|Kinerja PSD menurun beberapa kali|Bug|
