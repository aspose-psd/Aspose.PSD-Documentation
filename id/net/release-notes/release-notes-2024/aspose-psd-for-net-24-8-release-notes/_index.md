---
title: Catatan Rilis Aspose.PSD untuk .NET 24.8
type: docs
weight: 50
url: /id/net/aspose-psd-for-net-24-8-release-notes/
---

{{% alert color="primary" %}}

Halaman ini berisi catatan rilis untuk [Aspose.PSD untuk .NET 24.8](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Kunci**   | **Ringkasan**                                                                                     | **Kategori** |
|:------------|:--------------------------------------------------------------------------------------------------|:-------------|
| PSDNET-2091 | [AI Format] Menambah penanganan untuk Kelompok XObject                                             | Peningkatan  |
| PSDNET-1754 | Tingkatkan kemampuan transformasi Warp dengan menambahkan WarpSettings untuk TextLayer dan SmartObjectLayer | Fitur        |
| PSDNET-1836 | [AI Format] Menangani lapisan dalam operator aliran konten                                          | Fitur        |
| PSDNET-2015 | Hasil rendering dari file AI sangat berbeda dibandingkan dengan hasil Illustrator                     | Bug          |
| PSDNET-2093 | Merelink Smart Object tidak berlaku untuk semua Smart Object dalam file PSD                         | Bug          |
...
**PSDNET-1754. Tingkatkan kemampuan transformasi Warp dengan menambahkan WarpSettings untuk TextLayer dan SmartObjectLayer**
...
**PSDNET-1836. [AI Format] Tangani lapisan dalam operator aliran konten**
...
//// Kurva dari lapisan bernama "Pen" harus disembunyikan
{{< /highlight >}}

**PSDNET-2015. Hasil rendering dari file AI sangat berbeda dibandingkan dengan hasil Illustrator**
...
**PSDNET-2093. Merelink Smart Object tidak berlaku untuk semua Smart Object dalam file PSD**
    ...
    using (var image = (PsdImage)Image.Load(sourceFile[i]))
    {
        foreach (Layer layer in image.Layers)
        {
            if (layer is SmartObjectLayer)
            {
                ...
                // Untuk lapisan pintar kedua di sini terjadi kesalahan
