---
title: Aspose.PSD dla .NET 22.4 - Notatki dotyczące wydania
type: docs
weight: 90
url: /pl/net/aspose-psd-for-net-22-4-release-notes/
---

{{% alert color="primary" %}}

Ta strona zawiera notatki dotyczące wydania [Aspose.PSD dla .NET 22.4](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

|**Klucz**|**Podsumowanie**|**Kategoria**|
| :- | :- | :- |
|PSDNET-261|Renderowanie efektu warstwy Outer Glow|Funkcja|
|PSDNET-1123|Dodanie obsługi licencji Sha256|Udoskonalenie|
|PSDNET-1107|Pozycjonowanie wielowierszowego tekstu nie odpowiada rezultatowi w Photoshopie|Błąd|
|PSDNET-1113|Problem z ładowaniem pliku PSD podczas analizy danych zasobów tekstowych|Błąd|
|PSDNET-1129|Nieprawidłowa pozycja niestandardowego wzoru po zapisaniu jako PSD|Błąd|
...
**PSDNET-261. Renderowanie efektu warstwy Outer Glow**
{{< highlight csharp >}}
...
**PSDNET-1107. Pozycjonowanie wielowierszowego tekstu nie odpowiada rezultatowi w Photoshopie**
...
**PSDNET-1113. Problem z ładowaniem pliku PSD podczas analizy danych zasobów tekstowych**
...
**PSDNET-1129. Nieprawidłowa pozycja niestandardowego wzoru po zapisaniu jako PSD**
