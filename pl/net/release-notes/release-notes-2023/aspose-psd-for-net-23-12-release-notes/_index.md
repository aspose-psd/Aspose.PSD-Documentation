---
title: Notatki dotyczące wydania Aspose.PSD dla .NET 23.12
type: docs
weight: 10
url: /pl/net/aspose-psd-dla-net-23-12-release-notes/
---

{{% alert color="primary" %}}

Ta strona zawiera notatki dotyczące wydania [Aspose.PSD dla .NET 23.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Klucz**    | **Podsumowanie**                                                                                          | **Kategoria** |
|:------------|:-----------------------------------------------------------------------------------------------------------|:------------|
| PSDNET-1679 | [Format AI] Dodanie obsługi renderowania obrazu rastrowego w nowej wersji AI                                | Funkcja   |
| PSDNET-1454 | Obsługa typu gradientowego Noise w GdflResrource                                                          | Funkcja   |
| PSDNET-1827 | Błąd „Odwołanie do obiektu nie zostało ustawione na wystąpienie obiektu.” podczas zapisywania warstwy tekstowej po aktualizacji | Błąd |
| PSDNET-1776 | Naprawa ręcznego wczytywania czcionek w systemie MacOS za pomocą System.Drawing.Common i Aspose.Drawing. | Błąd |
| PSDNET-1536 | AllowWarpRepaint w PsdLoadOptions prowadzi do wyjątku                                                    | Błąd |
| PSDNET-1714 | [Format AI] Wprowadzenie przetwarzania strumieni wzajemnych.                                              | Ulepszenie |
| PSDNET-1834 | Kontrola licencji dla VectorPathDataResource działa nieprawidłowo                                       | Ulepszenie |
| PSDNET-770  | Otwórz dowolny plik obrazu jako osadzony inteligentny obiekt w obrazie PSD.                             | Ulepszenie |
| PSDNET-1864 | System licencjonowania wtyczek Aspose.PSD                                                               | Ulepszenie |
...
**PSDNET-1679. [Format AI] Dodanie obsługi renderowania obrazu rastrowego w nowej wersji AI**
...
**PSDNET-1454. Obsługa typu gradientowego Noise w GdflResrource**
...
**PSDNET-1827. Błąd „Odwołanie do obiektu nie zostało ustawione na wystąpienie obiektu.” podczas zapisywania warstwy tekstowej po aktualizacji**
...
**PSDNET-1536. AllowWarpRepaint w PsdLoadOptions prowadzi do wyjątku**
...
**PSDNET-1834. Kontrola licencji dla VectorPathDataResource działa nieprawidłowo**
...
**PSDNET-770. Otwórz dowolny plik obrazu jako osadzony inteligentny obiekt w obrazie PSD**
...
**PSDNET-1864. System licencjonowania wtyczek Aspose.PSD**

{{< highlight csharp >}}            
    var metered = new Metered();
    metered.SetMeteredKey(pluginPublic, pluginPrivate);
			
	// Specyficzna manipulacja wtyczką
{{< /highlight >}}