---
title: Notatki wydania Aspose.PSD dla Python via .NET 24.8
type: docs
weight: 10
url: /pl/python-net/aspose-psd-dla-python-za-posrednictwem-net-24-8-notatki-wydania/
---

{{% alert color="primary" %}}

Ta strona zawiera notatki wydania dla [Aspose.PSD dla Python via .NET 24.8](https://pypi.org/project/aspose-psd/)

{{% /alert %}}

| **Klucz**     | **Podsumowanie**                                                                                               | **Kategoria** |
|:------------- |:--------------------------------------------------------------------------------------------------------------- |:-------------|
| PSDPYTHON-81  | [Format AI] Dodanie obsługi grup XObject                                                                   | Ulepszenie   |
| PSDPYTHON-82  | Rozszerzenie możliwości transformacji zniekształcenia poprzez dodanie WarpSettings dla Warstwy Tekstu i Warstwy Smart Object   | Funkcja |
| PSDPYTHON-83  | [Format AI] Obsługa warstw w operatorach strumieni zawartości                                                | Funkcja      |
| PSDPYTHON-84  | Wynik renderowania pliku AI jest bardzo różny w porównaniu z wynikami Illustratora                          | Błąd         |
| PSDPYTHON-85  | Ponowne powiązanie Smart Object nie stosuje się do wszystkich Smart Object w pliku PSD                    | Błąd         |

## **Zmiany w API publicznym**
# **Dodane interfejsy programowania aplikacji (API):**
...
# **Usunięte interfejsy programowania aplikacji (API):**
- Brak

## **Przykłady użycia:**

**PSDPYTHON-81. [Format AI] Dodanie obsługi grup XObject**
{{< highlight python >}}
#Brak przykładu. To ulepszenie wewnętrzne
{{< /highlight >}}

**PSDPYTHON-82. Rozszerzenie możliwości transformacji zniekształcenia poprzez dodanie WarpSettings dla Warstwy Tekstu i Warstwy Smart Object**
{{< highlight python >}}
...
**PSDPYTHON-83. [Format AI] Obsługa warstw w operatorach strumieni zawartości**
{{< highlight python >}}
...
**PSDPYTHON-84. Wynik renderowania pliku AI jest bardzo różny w porównaniu z wynikami Illustratora**
{{< highlight python >}}
        sourceFile = "4.ai"
...
**PSDPYTHON-85. Ponowne powiązanie Smart Object nie stosuje się do wszystkich Smart Object w pliku PSD**
{{< highlight python >}}
