---
title: Aspose.PSD for Java 24.8 - リリースノート
type: docs
weight: 40
url: /ja/java/aspose-psd-for-java-24-8-release-notes/
---

{{% alert color="primary" %}} このページには、[Aspose.PSD for Java 24.8](https://downloads.aspose.com/psd/java/new-releases/aspose.psd-for-java-24.8/) のリリースノートが含まれています。 {{% /alert %}}

| **キー**     | **概要**                                                                                        | **カテゴリ** |
|:------------|:---------------------------------------------------------------------------------------------------|:-------------|
| PSDJAVA-642 | [AI フォーマット] XObject グループの処理を追加                                                  | 強化  |
| PSDJAVA-645 | テキストレイヤーとスマートオブジェクトレイヤーの Warp 変換機能を強化するための WarpSettings の追加 | 機能  |
| PSDJAVA-646 | [AI フォーマット] コンテンツストリームオペレータ内のレイヤーの処理                                      | 機能  |
| PSDJAVA-647 | AI ファイルのレンダリング結果が Illustrator の結果と非常に異なる                                   | バグ  |
| PSDJAVA-648 | PSD ファイル内のすべてのスマートオブジェクトに対して再リンクすると適用されない                     | バグ  |
...
**PSDJAVA-645. テキストレイヤーおよびスマートオブジェクトレイヤー用の WarpSettings を追加して Warp 変換機能を強化**
...
**PSDJAVA-646. [AI フォーマット] コンテンツストリームオペレータ内のレイヤーの処理**
...
**PSDJAVA-647. AI ファイルのレンダリング結果が Illustrator の結果と非常に異なる**
...
**PSDJAVA-648. PSD ファイル内のすべてのスマートオブジェクトに対して再リンクすると適用されない**
