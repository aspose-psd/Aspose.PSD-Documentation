---
title: Aspose.PSD for .NET 21.11 - リリースノート
type: docs
weight: 20
url: /ja/net/aspose-psd-for-net-21-11-release-notes/
---

{{% alert color="primary" %}}

このページには、[Aspose.PSD for .NET 21.11](https://www.nuget.org/packages/Aspose.PSD/) のリリースノートが含まれています。
