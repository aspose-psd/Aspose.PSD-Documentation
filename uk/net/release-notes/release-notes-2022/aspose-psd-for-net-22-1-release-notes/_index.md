---
title: Оновлення Aspose.PSD для .NET 22.1
type: docs
weight: 120
url: /uk/net/aspose-psd-for-net-22-1-release-notes/
---

{{% alert color="primary" %}} 

Ця сторінка містить оновлення для [Aspose.PSD для .NET 22.1](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Ключ**|**Опис**|**Категорія**|
| :- | :- | :- |
|PSDNET-1017|Паттерн Overlay може бути застосований лише один раз|Помилка|
|PSDNET-1056|Переповнення тимчасових файлів при відкритті файлу з потоку|Помилка|
|PSDNET-991|Оптимізація рендерингу для умовного розмиття за допомогою "smart filter"|Функціонал|
|PSDNET-1044|Підтримка багатьох даних шаблонів в PattResource|Функціонал|
...
**PSDNET-1017. Паттерн Overlay може бути застосований лише один раз**
{{< highlight csharp >}}
...
**PSDNET-1056. Переповнення тимчасових файлів при відкритті файлу з потоку**
{{< highlight csharp >}}
...
**PSDNET-991. Оптимізація рендерингу для умовного розмиття за допомогою "smart filter"**
{{< highlight csharp >}}
...
**PSDNET-1044. Підтримка багатьох даних шаблонів в PattResource**
{{< highlight csharp >}}
            ...
            using (var image = (PsdImage)Image.Load(src, new PsdLoadOptions() { LoadEffectsResource = true }))
            {
                ...
                {
                    Console.WriteLine("Вірне зчитування елементів даних PattResourceData.");
                }
