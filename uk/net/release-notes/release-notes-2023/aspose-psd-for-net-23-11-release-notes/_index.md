---
title: Aspose.PSD для .NET 23.11 - Примітки до версії
type: docs
weight: 20
url: /uk/net/aspose-psd-for-net-23-11-release-notes/
---

{{% alert color="primary" %}}

Ця сторінка містить примітки до версії [Aspose.PSD для .NET 23.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Ключ**     | **Опис**                                                                                               | **Категорія** |
|:------------|:----------------------------------------------------------------------------------------------------------|:--------|
| PSDNET-412  | Підтримка LMskResource                                                                                   | Функціонал |
| PSDNET-1669 | [Формат AI] Додана можливість відтворення PDF-базового файлу AI за допомогою Aspose.PSD               | Функціонал |
| PSDNET-1702 | [Формат AI] Додана підтримка оператора PostScript "cm"                                                      | Функціонал |
| PSDNET-1752 | Додано нові типи деформації: Хвиля, оболонка зверху, оболонка знизу                                       | Функціонал |
| PSDNET-1797 | Додано підтримку вертикальної деформації                                                                  | Функціонал |
| PSDNET-1756 | System.ArgumentNullException: 'Значення не може бути порожнім. (Параметр 'ключ')' під час виклику TextLayer.GetFonts() | Помилка |
...
**PSDNET-412. Підтримка LMskResource**
...
// Завантаження зображення з 16-бітною глибиною.
...
**PSDNET-1669. [Формат AI] Додана можливість відтворення PDF-базового файлу AI за допомогою Aspose.PSD**

{{< highlight csharp >}}
string sourceFile = Path.Combine(baseFolder, "ai_one.ai");
string outputPng = Path.Combine(outputFolder, "ai_one_output.png");

// Завантаження зображення AI, що базується на PDF.
using (AiImage image = (AiImage)Image.Load(sourceFile))
{
    // Збереження зображення AI у форматі PNG.
    image.Save(outputPng, new PngOptions());
}
{{< /highlight >}}

**PSDNET-1702. [Формат AI] Додана підтримка оператора PostScript "cm"**
...
**PSDNET-1752. Додано нові типи деформації: Хвиля, оболонка зверху, оболонка знизу**
...
**PSDNET-1756. System.ArgumentNullException: 'Значення не може бути порожнім. (Параметр 'ключ')' під час виклику TextLayer.GetFonts()**
...
**PSDNET-1797. Додано підтримку вертикальної деформації**
