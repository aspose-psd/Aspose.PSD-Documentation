---
title: Примітки до версії Aspose.PSD для .NET 23.12
type: docs
weight: 10
url: /uk/net/aspose-psd-for-net-23-12-release-notes/
---

{{% alert color="primary" %}}

Ця сторінка містить примітки до версії [Aspose.PSD для .NET 23.12](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}}

| **Ключ**    | **Зміст**                                                                                          | **Категорія** |
|:------------|:---------------------------------------------------------------------------------------------------|:--------------|
| PSDNET-1679 | [Формат AI] Додано підтримку відтворення растрового зображення у новій версії AI                 | Особливість   |
| PSDNET-1454 | Обробка шуму типу градієнту в ресурсі GdflResrource                                                 | Особливість   |
| PSDNET-1827 | Помилка "Посилання на об'єкт не вказує на екземпляр об'єкта" під час збереження текстового шару | Помилка       |
| PSDNET-1776 | Виправлення вручного завантаження шрифтів на MacOS за допомогою System.Drawing.Common та Aspose.Drawing | Помилка |
| PSDNET-1536 | AllowWarpRepaint в параметрах завантаження PsdLoadOptions приводить до винятку                   | Помилка       |
| PSDNET-1714 | [Формат AI] Впровадження обробки крос-посилання потоків                                             | Покращення   |
| PSDNET-1834 | Ліцензійний контроль для ресурсу VectorPathDataResource працює невірно                          | Покращення   |
| PSDNET-770  | Відкривайте будь-який файл зображення як вбудований розумний об'єкт в зображенні PSD            | Покращення   |
| PSDNET-1864 | Система ліцензування плагіна Aspose.PSD                                                             | Покращення   |
...
**PSDNET-1679. [Формат AI] Додано підтримку відтворення растрового зображення в новій версії AI**
...
**PSDNET-1454. Обробка шуму типу градієнту в ресурсі GdflResrource**
...
**PSDNET-1827. Помилка "Посилання на об'єкт не вказує на екземпляр об'єкта" під час збереження текстового шару після оновлення**
...
using (var psdImage = (PsdImage)Image.Load(sourceFile))
{
    ...
    // Тут не повинно виникати помилок
    psdImage.Save(outputFile);
}
{{< /highlight >}}

**PSDNET-1536. Параметр AllowWarpRepaint в PsdLoadOptions призводить до винятку**
...
**PSDNET-1834. Ліцензійний контроль для ресурсу VectorPathDataResource працює невірно**
...
**PSDNET-770. Відкривайте будь-який файл зображення як вбудований розумний об'єкт у зображенні PSD**
...
**PSDNET-1864. Система ліцензування плагіна Aspose.PSD**

{{< highlight csharp >}}            
    var metered = new Metered();
    metered.SetMeteredKey(pluginPublic, pluginPrivate);
			
	// Специфічні для плагіна маніпуляції
{{< /highlight >}}