---
title: Освіження Aspose.PSD для .NET 19.11
type: docs
weight: 20
url: /uk/net/aspose-psd-for-net-19-11-release-notes/
---

{{% alert color="primary" %}} 

Ця сторінка містить оновлення для [Aspose.PSD для .NET 19.11](https://www.nuget.org/packages/Aspose.PSD/)

{{% /alert %}} 

|**Ключ**|**Зміст**|**Категорія**|
| :- | :- | :- |
|PSDNET-151|[Підтримка ефекту внутрішньої тіні на шарі](/psd/uk/net/shadow-effects-in-photoshop/#shadoweffectsinphotoshop-innershadoweffect)|Функція|
|PSDNET-135|[Реалізація заповнення шару: Паттерн](/psd/uk/net/support-of-fill-layers/#supportoffilllayers-filllayerswithpatternfill)|Функція|
|PSDNET-187|[Підтримка растрових зображень у файлах формату AI](/psd/uk/net/manipulating-adobe-illustrator-formats/#manipulatingadobeillustratorformats-rasterimagesinillustrator)|Функція|
|PSDNET-225|[Отримання властивостей вбудованого форматування текстового шару](/psd/uk/net/working-with-text-layers/#workingwithtextlayers-gettextpropertiesfromatextlayer)|Функція|
|PSDNET-214|Некоректний експорт PSD у інші формати, якщо він містить ефекти шару та коригуючі шари|Помилка|
...
**PSDNET-151. Підтримка ефекту внутрішньої тіні на шарі**
...
**PSDNET-135. Реалізація заповнення шару: Паттерн**
...
**PSDNET-187. Підтримка растрових зображень у файлах формату AI**
...
**PSDNET-225. Отримання властивостей вбудованого форматування текстового шару**
...
**PSDNET-214. Некоректний експорт PSD у інші формати, якщо він містить ефекти шару та коригуючі шари**
