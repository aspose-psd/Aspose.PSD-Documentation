---
title: Примітки до випуску Aspose.PSD для .NET 19.4
type: docs
weight: 90
url: /uk/net/aspose-psd-for-net-19-4-release-notes/
---

{{% alert color="primary" %}} 

Ця сторінка містить примітки до випуску Aspose.PSD для .NET 19.4

{{% /alert %}} 

|**Ключ**|**Опис**|**Категорія**|
| :- | :- | :- |
|PSDNET-87|Забезпечення можливості завантажувати файли зображень у форматі JPEG/PNG/тощо до PsdImage без прямого завантаження (що не підтримується в Aspose.PSD)|Функція|
|PSDNET-120|Підтримка режиму кольору RGB з 16 бітами на канал (64 біти на колір)|Функція|
|PSDNET-108|Підтримка векторних масок шарів та настроюваного обертання/перевертання текстового шару|Функція|
|PSDNET-99|Усі азійські символи не відображаються належним чином|Помилка|
|PSDNET-116|Символи \r\n інтерпретуються як подвійний розрив рядка, що є некоректним|Помилка|
|PSDNET-117|Якщо TextLayer оновлюється рядком, який містить розриви рядків, то файл PSD стає незчитуваним|Помилка|
|PSDNET-118|Якщо TextLayer оновлюється рядком, що містить символи табуляції, обробка завершується з винятком|Помилка|
...
**PSDNET-87. Забезпечення можливості завантажувати файли зображень у форматі JPEG/PNG/тощо до PsdImage без прямого завантаження (що не підтримується в Aspose.PSD)**
...
**PSDNET-120. Підтримка режиму кольору RGB з 16 бітами на канал (64 біти на колір)**

{{< highlight java >}}

  // Підтримка режиму кольору RGB з 16 бітами на канал (64 біти на колір)
...
// Файли повинні бути відкриті без винятків і читабельні для Photoshop    

using(Image image = Image.Load(outputFilePathPsd)) {}  

{{< /highlight >}}

**PSDNET-108. Підтримка векторних масок шарів та настроюваного обертання/перевертання текстового шару**

{{< highlight java >}}

 // Операція обертання/перевертання не працює так, як очікувалося з PSD
...
**PSDNET-99. Усі азійські символи не відображаються належним чином**

[**Будь ласка, перевірте доданий приклад**](attachments/86278147/86343681.cs)

**PSDNET-116. Символи \r\n інтерпретуються як подвійний розрив рядка, що є некоректним**
...
// Файл повинен бути відкритий без винятків і читабельним для Photoshop. Повинен містити 3 рядкові розриви, один між кожним рядком
...
**PSDNET-117. Якщо TextLayer оновлюється рядком, який містить розриви рядків, то файл PSD стає незчитуваним** 

{{< highlight java >}}

 // Якщо TextLayer оновлюється рядком, яки